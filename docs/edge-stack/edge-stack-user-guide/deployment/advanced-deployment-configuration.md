---
description: Configuration guide for Advanced Deployment Configuration.
noIndex: true
---
...
| `endpoint_grpc_count`                 | int    | count of endpoints to which Ambassador Edge Stack will originate GRPC                     |
