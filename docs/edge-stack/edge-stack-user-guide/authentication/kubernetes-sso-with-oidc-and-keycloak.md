---
description: Overview of Kubernetes SSO.
noIndex: true
---
...
hostname: "\*" prefix: / allow\_upgrade: - spdy/3.1 service: https://kubernetes.default.svc timeout\_ms: 0 tls: aes-kubeapi-context \`\`\`
