...
| `circuit_breakers`           | the value set in the `ambassador` `Module`                                          | See [circuit-breakers.md](docs/edge-stack/technical-reference/ingress-and-load-balancing/circuit-breakers.md "mention").                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
