...
Telepresence can import the environment variables from the pod that is being intercepted, see [this doc](docs/telepresence/technical-reference/environment-variables.md) for more details.
