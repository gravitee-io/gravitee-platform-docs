...
<!-- TODO: Screenshot of The Proxied Traffic page -->
<figure><img src="../.gitbook/assets/PLACEHOLDER-edge-analytics-proxied-traffic.png" alt="The Proxied Traffic page with the time range selector, the Total requests, Active devices, and Top provider cards, and the traffic table with token counts"><figcaption><p>The Proxied Traffic page.</p></figcaption></figure>
