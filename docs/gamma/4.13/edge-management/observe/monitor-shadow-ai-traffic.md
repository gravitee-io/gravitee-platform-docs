...
<!-- TODO: Screenshot of The Detected Shadow AI page -->
<figure><img src="../.gitbook/assets/PLACEHOLDER-edge-analytics-shadow-ai.png" alt="The Detected Shadow AI page with the time range selector, the Total detections, Affected devices, and Top provider cards, and the detections table"><figcaption><p>The Detected Shadow AI page.</p></figcaption></figure>
