...
<figure><img src=".gitbook/assets/gamma-platform-cors.png" alt="The CORS settings: allowed origins, methods, request headers, exposed headers, and max age."><figcaption><p>The CORS page of the <strong>Organization</strong> section</p></figcaption></figure>
