...
<figure><img src=".gitbook/assets/gamma-platform-metadata-list.png" alt="Each entry has a key, a name, a format such as URL, Date, or Boolean, and a value."><figcaption><p>The Metadata page lists the key-value entries that APIs in the selected environment inherit.</p></figcaption></figure>
