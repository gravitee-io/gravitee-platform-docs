...
<figure><img src=".gitbook/assets/gamma-platform-entrypoints-sharding-tags.png" alt="Each sharding tag carries a key, a name, a description, and the groups allowed to use it."><figcaption><p>The Entrypoints &#x26; Sharding Tags page with per-environment default values, the sharding tags list, and the entrypoint mappings list.</p></figcaption></figure>
