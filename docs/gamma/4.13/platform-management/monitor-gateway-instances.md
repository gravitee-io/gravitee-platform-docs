...
<figure><img src=".gitbook/assets/gamma-platform-gateways-list.png" alt="Each row gives a gateway's version, status, last heartbeat, OS, address, tenant, and tags."><figcaption><p>The Gateways page lists the instances registered with the selected environment.</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/gamma-platform-gateway-instance-environment.png" alt="Information lists the host, state, and heartbeat, and Plugins lists each plugin with its version."><figcaption><p>The Environment tab of a gateway instance, with the Information and Plugins sections.</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/gamma-platform-gateway-instance-monitoring.png" alt="The cards report CPU, heap use, garbage collections, and file descriptors, then JVM memory pools."><figcaption><p>The Monitoring tab of a running instance, with the four headline cards preceding the JVM section.</p></figcaption></figure>
