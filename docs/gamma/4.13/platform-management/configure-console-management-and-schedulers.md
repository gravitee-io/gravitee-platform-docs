...
<figure><img src=".gitbook/assets/gamma-platform-management-and-schedulers.png" alt="The Management section with its title, URL, and three toggles, and the two scheduler intervals."><figcaption><p>The Management &#x26; Schedulers page of the <strong>Organization</strong> section</p></figcaption></figure>
