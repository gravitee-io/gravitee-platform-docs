...
<!-- TODO: Screenshot of the New provider card of the Models step, with the Provider, Provider URL, Models, and Authentication fields filled for an Anthropic provider -->
