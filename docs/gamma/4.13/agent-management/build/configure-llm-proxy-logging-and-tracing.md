...
hidden: false
noIndex: false
description: Control which request and response data an LLM Proxy reports to logs and analytics, and turn on OpenTelemetry tracing. Follow the steps to configure it.
---
