...
hidden: false
noIndex: false
description: Choose which API Gateway instances load an MCP proxy by assigning sharding tags. Follow the steps on the Deployment Configuration page.
---
...
<figure><img src="../../../.gitbook/assets/gamma-aim-mcp-proxy-deployment-configuration.png" alt="The Deployment Configuration page for an MCP proxy, with one sharding tag selected as a chip in the tag field and the Discard and Save changes buttons showing"><figcaption><p>The Deployment Configuration page</p></figcaption></figure>
...
{% hint style="info" %}
When the MCP proxy is managed by the Kubernetes operator, the page shows **This API is managed by the Kubernetes operator. Sharding tags can only be changed from its source definition.**
{% endhint %}

Saving the selection marks the MCP proxy out of sync. Deploy it to push the change to the gateway.
