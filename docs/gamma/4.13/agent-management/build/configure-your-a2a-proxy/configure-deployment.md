...
<figure><img src="../../../.gitbook/assets/gamma-aim-a2a-proxy-deployment-configuration.png" alt="The Deployment Configuration page for an A2A Proxy, with one sharding tag selected as a chip in the tag field and the Discard and Save changes buttons showing"><figcaption><p>The Deployment Configuration page</p></figcaption></figure>
