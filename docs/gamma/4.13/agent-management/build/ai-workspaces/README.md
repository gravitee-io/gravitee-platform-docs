...
* [**Configure AI workspace routing**](../configure-ai-workspace-routing.md). Route each request to a model chosen by how much of the member's budget is spent, and chain the policies every call runs.
