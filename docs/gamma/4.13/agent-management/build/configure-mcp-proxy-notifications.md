...
hidden: false
noIndex: false
description: Choose which API events send notifications for an MCP Proxy and where they are delivered. Follow the steps to add, edit, or delete a notification.
---
