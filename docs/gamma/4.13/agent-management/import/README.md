...
* [**Create an agent identity**](../build/create-an-agent-identity.md) — Register an agent as an OAuth client so the AI Gateway and your policies can authenticate, attribute, and audit it.
