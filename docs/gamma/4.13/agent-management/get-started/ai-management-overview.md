...
* [Create your first LLM Proxy](create-your-llm-proxy.md). Configure an LLM Proxy, connect it to an upstream model provider, and then send a test prompt.
