...
hidden: false
noIndex: false
description: Read the dashboards that report AI traffic, cost, and tool usage across proxies and employee devices. Pick the dashboard you want to read.
---

# Dashboards

The dashboards report what your AI traffic costs, which models and tools it reaches, and how much of it runs outside the governance layer.
