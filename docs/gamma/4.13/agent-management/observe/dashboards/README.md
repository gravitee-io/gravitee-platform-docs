...
hidden: false
noIndex: false
description: Read the dashboards that report AI traffic, cost, and tool usage across proxies and employee devices, or build your own. Pick the dashboard you want to read.
---

# Dashboards

The dashboards report what your AI traffic costs, which models and tools it reaches, and how much of it runs outside the governance layer. Alongside the templates below, your team builds and saves its own dashboards in the environment.
