...
* [**Audit agent actions with receipts**](audit-agent-actions-with-receipts.md): read the single record that joins the decision chain, the result, and the cost for one consequential action.
