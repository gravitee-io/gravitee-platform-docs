...
Select the persona card that matches how the agent runs — **Desktop Productivity Agent**, **Hosted Agent**, or **Workload Agent** (see [Agent personas](#agent-personas)). Select **Next**.
