...
{% hint style="info" %}
For a quick introduction on how to create an API in APIM, see [Create APIs](/apim/guides/create-apis).
{% endhint %}
...
To request a promotion, you need to have API `DEFINITION` [permissions](/apim/guides/administration/user-management-and-permissions#api-permissions). Promotion requests are logged in the [Audit trail](/apim/guides/api-measurement-tracking-and-analytics#the-audit-trail).
...
To accept or reject a promotion, you need to have environment `API` [permissions](/apim/guides/administration/user-management-and-permissions#environment-permissions).
