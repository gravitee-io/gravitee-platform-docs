...
<figure><img src="../.gitbook/assets/self-hosted-getting-started-with-se-21.png" alt="The account set-up page with a company name entered and Self-hosted Deployment selected instead of the Enterprise Cloud trial."><figcaption><p>Gravitee Cloud account set up page with Self-hosted deployment option chosen.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/self-hosted-getting-started-with-se-22.png" alt="A vertical flow diagram of the self-hosted hierarchy: Account, then Organization, then Environment, then Installation for APIM or AM, then Node."><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/self-hosted-getting-started-with-se-23.png" alt="A topology view of two installations, each shown as a card with its identifier and connected by dotted lines to its Gateway and REST API nodes."><figcaption></figcaption></figure>
