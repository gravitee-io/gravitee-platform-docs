...
The decision to use asynchronous APIs is context-dependent and it is quite common for a single system to leverage both synchronous and asynchronous APIs. However, asynchronous APIs effectuate significant benefits when applied in suitable contexts.
