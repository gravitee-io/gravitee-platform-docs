...
Multitasking, or rapid task-switching, is not equivalent to [parallelism](https://en.wikipedia.org/wiki/Parallel\_computing), which in computer science, is the simultaneous execution of two or more tasks.
