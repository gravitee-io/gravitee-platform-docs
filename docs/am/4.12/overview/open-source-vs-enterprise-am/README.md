---
description: What the Enterprise Edition adds to open source Access Management 4.12, from plugin packs to advanced monitoring. Compare the two distributions.
metaLinks:
  alternates:
    - >-
