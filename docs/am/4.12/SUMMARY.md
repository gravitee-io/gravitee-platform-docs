...
* [Auth Protocols](guides/auth-protocols/README.md)
  * [OAuth 2.0](guides/auth-protocols/oauth-2.0/README.md)
    * [Configuring SPIFFE Settings in the AM Console](guides/auth-protocols/oauth-2.0/configuring-spiffe-settings-in-the-am-console.md)
    * [Creating and Managing Trust Domains](guides/auth-protocols/oauth-2.0/creating-and-managing-trust-domains.md)
    * [SPIFFE Workload Identity & Agent Applications: Concepts and Architecture](guides/auth-protocols/oauth-2.0/spiffe-workload-identity-agent-applications-concepts-and-architecture.md)
...
* [Applications](guides/applications/README.md)
  ...
  * [Creating and Managing Agent Applications](guides/applications/creating-and-managing-agent-applications.md)
