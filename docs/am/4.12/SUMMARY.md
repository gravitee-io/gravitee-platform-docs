...
* [Auth Protocols](guides/auth-protocols/README.md)
  * [CIMD Authentication Flow and Restrictions](guides/auth-protocols/cimd-authentication-flow-and-restrictions.md)
  * [Client ID Metadata Document (CIMD) Overview](guides/auth-protocols/client-id-metadata-document-cimd-overview.md)
  * [Enable and Configure CIMD in the Console](guides/auth-protocols/enable-and-configure-cimd-in-the-console.md)
