...
* [Auth Protocols](guides/auth-protocols/README.md)
  * [Integrate with CIMD Clients](guides/auth-protocols/integrate-with-cimd-clients.md)
...
* [Applications](guides/applications/README.md)
  ...
  * [Configure CIMD in Access Management](guides/applications/configure-cimd-in-access-management.md)
...
* [MCP Servers](guides/mcp-servers/README.md)
  ...
  * [Client ID Metadata Document (CIMD) Overview](guides/mcp-servers/client-id-metadata-document-cimd-overview.md)
