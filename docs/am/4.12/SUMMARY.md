...
* [Auth Protocols](guides/auth-protocols/README.md)
  * [OAuth 2.0](guides/auth-protocols/oauth-2.0/README.md)
    * [SPIFFE Workload Identity & Agent Applications: Concepts](guides/auth-protocols/oauth-2.0/spiffe-workload-identity-agent-applications-gateway-configuration.md)
    * [SPIFFE Workload Identity & Agent Applications: Management API Reference](guides/auth-protocols/oauth-2.0/spiffe-workload-identity-agent-applications-management-api-reference.md)
...
* [Applications](guides/applications/README.md)
  ...
  * [SPIFFE Workload Identity & Agent Applications](guides/applications/spiffe-workload-identity-agent-applications-prerequisites-restrictions-and-related-changes.md)
  * [SPIFFE Workload Identity & Agent Applications: Creating Agent Applications](guides/applications/spiffe-workload-identity-agent-applications-creating-agent-applications.md)
...
* [SPIFFE Workload Identity & Agent Applications: Managing Trust Domains](guides/spiffe-workload-identity-agent-applications-managing-trust-domains.md)
