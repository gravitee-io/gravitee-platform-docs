...
* [Configuration](getting-started/configuration/README.md)
  * [AM Gateway](getting-started/configuration/configure-am-gateway/README.md)
    ...
    * [Configure SPIFFE and CIMD Gateway Settings](getting-started/configuration/configure-am-gateway/configure-spiffe-and-cimd-gateway-settings.md)
...
* [Auth Protocols](guides/auth-protocols/README.md)
  * [OAuth 2.0](guides/auth-protocols/oauth-2.0/README.md)
    * [Create and Configure Agent Applications](guides/auth-protocols/oauth-2.0/create-and-configure-agent-applications.md)
    ...
    * [Trust Domains and CIMD Management API Reference](guides/auth-protocols/oauth-2.0/trust-domains-and-cimd-management-api-reference.md)
...
* [Security Domains](guides/security-domains/README.md)
  ...
  * [Manage Trust Domains](guides/security-domains/manage-trust-domains.md)
...
* [Applications](guides/applications/README.md)
  ...
  * [SPIFFE and CIMD Restrictions and Validation Rules](guides/applications/spiffe-and-cimd-restrictions-and-validation-rules.md)
