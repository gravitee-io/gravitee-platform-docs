...
* [Configuration](getting-started/configuration/README.md)
  * [AM Gateway](getting-started/configuration/configure-am-gateway/README.md)
    ...
    * [Configuring CIMD Gateway Settings](getting-started/configuration/configure-am-gateway/configuring-cimd-gateway-settings.md)
...
* [Security Domains](guides/security-domains/README.md)
  ...
  * [Enabling CIMD in the Domain Console](guides/security-domains/enabling-cimd-in-the-domain-console.md)
