...
* [Auth Protocols](guides/auth-protocols/README.md)
  * [OAuth 2.0](guides/auth-protocols/oauth-2.0/README.md)
    ...
    * [SPIFFE Workload Identity and CIMD Management API Reference](guides/auth-protocols/oauth-2.0/spiffe-workload-identity-and-cimd-management-api-reference.md)
    * [SPIFFE Workload Identity Prerequisites and Gateway Configuration](guides/auth-protocols/oauth-2.0/spiffe-workload-identity-prerequisites-and-gateway-configuration.md)
...
* [Applications](guides/applications/README.md)
  ...
  * [SPIFFE Workload Identity Restrictions and Related Changes](guides/applications/spiffe-workload-identity-restrictions-and-related-changes.md)
