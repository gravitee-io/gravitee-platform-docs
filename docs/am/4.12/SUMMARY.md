...
* [Auth Protocols](guides/auth-protocols/README.md)
  * [CIMD Logo Endpoint API Reference](guides/auth-protocols/cimd-logo-endpoint-api-reference.md)
  * [Configure CIMD in Access Management Console](guides/auth-protocols/configure-cimd-in-access-management-console.md)
...
* [Applications](guides/applications/README.md)
  * [Client ID Metadata Document (CIMD) Overview](guides/applications/client-id-metadata-document-cimd-overview.md)
