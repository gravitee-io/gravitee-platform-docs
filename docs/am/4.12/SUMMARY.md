...
* [Configuration](getting-started/configuration/README.md)
  * [AM Gateway](getting-started/configuration/configure-am-gateway/README.md)
    ...
    * [Configuring SPIFFE and CIMD Gateway Settings](getting-started/configuration/configure-am-gateway/configuring-spiffe-and-cimd-gateway-settings.md)
...
* [Auth Protocols](guides/auth-protocols/README.md)
  * [Managing SPIFFE Trust Domains](guides/auth-protocols/managing-spiffe-trust-domains.md)
...
* [Applications](guides/applications/README.md)
  * [Agent Application Restrictions and Validation Rules](guides/applications/agent-application-restrictions-and-validation-rules.md)
