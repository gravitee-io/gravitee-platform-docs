...
description: The Access Management 4.12 REST API for scripting administration, covering authorization and the token and authorization endpoints. Browse the reference.
---
