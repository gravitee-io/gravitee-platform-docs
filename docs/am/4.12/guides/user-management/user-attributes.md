...
description: An Access Management 4.12 user profile holds general details and additional information. Learn the attributes and how to make email optional.
---
