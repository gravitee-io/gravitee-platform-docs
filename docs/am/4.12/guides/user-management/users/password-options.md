...
description: Control how Access Management 4.12 users set a first password, by forcing a reset or sending a registration email. Follow the steps to choose.
---
