...
description: Silent reauthentication uses the OpenID Connect ID token for third parties that cannot hold an Access Management 4.12 session. Learn how it works.
---
