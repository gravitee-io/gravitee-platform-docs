---
description: Create an Access Management 4.12 agent application manually or through CIMD. Follow the steps and see the agent application settings reference.
---
