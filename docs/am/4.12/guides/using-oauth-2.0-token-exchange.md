---
description: In an impersonation exchange the issued Access Management 4.12 token represents the subject directly. Learn scope resolution and requesting an ID token.
---
