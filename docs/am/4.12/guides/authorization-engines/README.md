...
description: Access Management 4.12 delegates fine-grained authorization to an external engine. Compare the supported engines and the permissions each needs.
---
