...
description: Authenticate Access Management 4.12 users with Twitter. Follow the steps to register a Twitter application and set up the connection.
---
...
<figure><img src="../../../.gitbook/assets/guide-identity-providers-social-ide-74.png" alt="The Twitter/X identity provider Settings tab, with a client ID, masked client secret, and HTTP client timeout settings, beside the redirect URI to configure."><figcaption><p>Create Twitter/X Identity Provider</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/guide-identity-providers-social-ide-75.png" alt="The Identity Providers tab of an application, with the Mongo DB and JDBC providers switched off and Twitter/X, Github, Facebook, and Azure AD social providers switched on."><figcaption><p>Select Twitter/X Identity Provider within your Application</p></figcaption></figure>
