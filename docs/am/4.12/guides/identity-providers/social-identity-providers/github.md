...
description: Authenticate Access Management 4.12 users with GitHub. Follow the steps to register a GitHub application and set up the connection.
---
...
<figure><img src="../../../.gitbook/assets/guide-identity-providers-social-ide-72.png" alt="The Github identity provider Settings tab, with a client ID, masked client secret, and a list of selectable repository scopes, beside the redirect URI to configure."><figcaption><p>Create Github Identity Provider</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/guide-identity-providers-social-ide-73.png" alt="The Identity Providers tab of an application, with the Mongo DB and JDBC providers switched off and Github, Facebook, and Azure AD social providers switched on."><figcaption></figcaption></figure>
