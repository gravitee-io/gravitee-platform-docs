...
description: Authenticate Access Management 4.12 users against a SQL database over JDBC. Follow the steps to create the provider and test the connection.
---
