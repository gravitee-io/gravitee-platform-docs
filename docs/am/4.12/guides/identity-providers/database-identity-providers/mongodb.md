...
description: Authenticate Access Management 4.12 users against your own MongoDB database. Follow the steps to create the provider and set connection precedence.
---
