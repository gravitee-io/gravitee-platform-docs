...
description: Access Management 4.12 authenticates users against MongoDB, PostgreSQL, MySQL, SQL Server, and MariaDB. Compare the database providers available.
---
