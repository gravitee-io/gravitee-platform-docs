...
description: Access Management 4.12 connects to corporate identity servers to authenticate your users. Compare the enterprise providers available to you.
---
