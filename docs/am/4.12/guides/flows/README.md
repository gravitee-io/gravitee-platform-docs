...
description: Flows extend Access Management 4.12 by running policies at selected stages of a request. Learn the execution context and how to configure one.
---
