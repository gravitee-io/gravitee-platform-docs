---
description: Client ID Metadata Document lets Access Management 4.12 clients present a URL as their client identifier and fetch configuration from it. Learn how.
---
