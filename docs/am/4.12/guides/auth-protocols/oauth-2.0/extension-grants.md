...
description: Extension grants add custom token endpoint grant types to Access Management 4.12, such as JWT Bearer. Follow the steps to create and use one.
---
