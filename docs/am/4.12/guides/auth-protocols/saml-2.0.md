...
description: Enable SAML 2.0 identity provider support in Access Management 4.12 by installing the IdP protocol plugin. Follow the steps for your installation.
---
...
2. Click **SAML 2.0**.
3. Verify and update the [SAML 2.0 application settings](#saml-20-application-settings).
