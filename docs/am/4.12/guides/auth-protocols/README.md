---
description: The authorization, authentication, and identity protocols Access Management 4.12 uses to let applications interact with it. Compare the protocols.
metaLinks:
  alternates:
