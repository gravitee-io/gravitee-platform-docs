---
description: SPIFFE and CIMD are configured per Access Management 4.12 security domain rather than in a configuration file. Learn both groups of settings.
---
