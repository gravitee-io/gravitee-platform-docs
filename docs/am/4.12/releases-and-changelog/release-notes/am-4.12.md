...
* Supports automatic token revocation when remote metadata changes are detected, with configurable in-memory caching (default 3600 seconds TTL, 500 entry maximum).
