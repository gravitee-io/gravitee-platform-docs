...
description: The Gravitee platform ships Access Management 4.12 as a single distribution bundle. Browse the guides, and note that downgrades are not supported.
---
