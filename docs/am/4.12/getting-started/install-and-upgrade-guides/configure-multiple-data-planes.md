...
description: Split Access Management 4.12 load across data planes by scoping databases per use case. Follow the steps for the Management API and Gateways.
---
