---
description: Which Access Management 4.12 plugins support secrets, their minimum version, and the fields that accept secret values. Find the plugin you need.
metaLinks:
  alternates:
    - >-
