...
description: Reporters send Access Management 4.12 Gateway and API events to MongoDB, a file, or Kafka. Follow the steps to configure the reporter you need.
---
