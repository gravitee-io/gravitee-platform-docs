...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/H4VhZJXn1S232OEmh8Wv/getting-started/tutorial-getting-started-with-am/add-custom-claims-to-tokens
description: Add custom claims to Access Management 4.12 access tokens and ID tokens. Follow the steps to configure a claim for your application.
---
...
<figure><img src="../../.gitbook/assets/gs-tutorial-getting-started-with-am-42.png" alt="The Tokens tab with the access, refresh, and ID token expiry values, and custom claims added to the access token and the ID token."><figcaption><p>Define custom claims</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/gs-tutorial-getting-started-with-am-45.png" alt="The Create Claims information dialog, explaining token claims and listing the execution context attributes available for claim values."><figcaption></figcaption></figure>
