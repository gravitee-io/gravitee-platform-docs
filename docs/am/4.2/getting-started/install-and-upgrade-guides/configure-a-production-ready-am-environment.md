...
{% hint style="info" %}
You can also read the [OAuth 2.0 best practices](docs/am/4.2/guides/auth-protocols/oauth-2.0/best-practices.md) for more details about configuring your AM environment.
{% endhint %}
...
* [Configure the AM API internal API](docs/am/4.2/getting-started/configuration/configure-am-api/internal-api.md)
* [Configure the AM Gateway internal API](docs/am/4.2/getting-started/configuration/configure-am-gateway/internal-api.md)
