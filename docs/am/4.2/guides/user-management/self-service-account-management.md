...
You can access the online API reference [here](https://raw.githubusercontent.com/gravitee-io/gravitee-access-management/4.2.x/docs/self-service-account-api-descriptor.yml).
