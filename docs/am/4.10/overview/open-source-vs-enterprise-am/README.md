---
description: What the Enterprise Edition adds to open source Access Management 4.10, from plugin packs to advanced monitoring. Compare the two distributions.
---
