...
<figure><img src="../../../4.10/.gitbook/assets/guide-branding-readme-90.png" alt="The theme builder in the newer console, with logo, favicon, and theme colour settings beside a live preview of the login page."><figcaption><p>Login Form Theme Editor</p></figcaption></figure>
...
<figure><img src="../../../4.10/.gitbook/assets/guide-branding-readme-91.png" alt="The theme builder Custom CSS panel with a root variable setting the body background colour, and the preview showing the indigo background."><figcaption><p>Using CSS to customize the theme</p></figcaption></figure>
...
<figure><img src="../../../4.10/.gitbook/assets/guide-branding-readme-93.png" alt="The Registration form template editor with custom registration enabled and the Thymeleaf HTML source open beside the form template guidance."><figcaption></figcaption></figure>
...
<figure><img src="../../../4.10/.gitbook/assets/guide-branding-readme-94.png" alt="The Registration confirmation email template with the custom template enabled and the required From and Subject fields still empty, above the HTML source."><figcaption></figcaption></figure>
