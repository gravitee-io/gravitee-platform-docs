...
<figure><img src="../../../4.10/.gitbook/assets/guide-multi-factor-authentication-m-128.png" alt="The flow designer with a Latency policy added to the Reset Password flow, beside the flow list and the policy list."><figcaption></figcaption></figure>
...
<figure><img src="../../../4.10/.gitbook/assets/guide-multi-factor-authentication-m-129.png" alt="The flow designer with an Enroll MFA policy added to the post-login stage of the Login flow, its settings panel open below."><figcaption></figcaption></figure>
