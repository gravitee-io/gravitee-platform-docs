...
<figure><img src="../../../4.10/.gitbook/assets/guide-multi-factor-authentication-m-125.png" alt="The User Accounts settings with login brute force detection off and MFA Brute Force Detection on, allowing three challenge attempts with a one-minute reset."><figcaption></figcaption></figure>
...
<figure><img src="../../../4.10/.gitbook/assets/guide-multi-factor-authentication-m-124.png" alt="The SMS verification page showing an mfa_request_limit_exceed error explaining that too many codes were requested."><figcaption></figcaption></figure>

Once the number of maximum attempts is reached, the user will be notified with an error message.

<figure><img src="../../../4.10/.gitbook/assets/guide-multi-factor-authentication-m-126.png" alt="The SMS verification page showing a maximum_verify_limit error stating that the maximum number of attempts has been reached."><figcaption></figcaption></figure>
