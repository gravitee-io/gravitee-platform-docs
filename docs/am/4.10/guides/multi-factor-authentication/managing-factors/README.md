...
<figure><img src="../../../../4.10/.gitbook/assets/guide-multi-factor-authentication-m-108.png" alt="The New factor wizard on the Platform step with the SMS Factor selected among the available factor types."><figcaption><p>Setting up Multifactor Auth from you Security Domain settings.</p></figcaption></figure>
