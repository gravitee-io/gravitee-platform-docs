...
<figure><img src="../../../../4.10/.gitbook/assets/guide-auth-protocols-oauth-20-dynam-51.png" alt="The Client Registration Settings with Dynamic Client Registration and expression-language redirect URIs enabled and the remaining options switched off."><figcaption></figcaption></figure>
...
<figure><img src="../../../../4.10/.gitbook/assets/guide-auth-protocols-oauth-20-dynam-52.png" alt="The application General settings with a redirect URI containing an expression-language dynamic parameter entered, above the existing redirect URIs list."><figcaption></figcaption></figure>
