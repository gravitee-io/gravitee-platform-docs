...
<figure><img src="../../4.10/.gitbook/assets/guide-device-identifier-96.png" alt="The New Device Identifier wizard on the Platform step, offering a cookie mechanism and FingerprintJS v3 community and Pro, with the cookie option selected."><figcaption></figcaption></figure>
...
<figure><img src="../../4.10/.gitbook/assets/guide-device-identifier-98.png" alt="The Settings step of the New Device Identifier wizard for a FingerprintJS v3 community plugin, with an empty name field and an option to keep track of the device ID in a cookie."><figcaption></figcaption></figure>
...
<figure><img src="../../4.10/.gitbook/assets/guide-device-identifier-99.png" alt="The Settings step of the New Device Identifier wizard for a FingerprintJS v3 Pro plugin, with the required name and browser token fields flagged as empty and an optional registration region."><figcaption></figcaption></figure>
