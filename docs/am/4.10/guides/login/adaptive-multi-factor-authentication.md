...
<figure><img src="../../../4.10/.gitbook/assets/guide-login-adaptive-multi-factor-a-101.png" alt="The Multifactor Auth settings with two TOTP factors, the challenge set to Conditional, and a rule using geoip country code and login attempts."><figcaption></figcaption></figure>
