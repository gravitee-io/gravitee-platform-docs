...
<figure><img src="../../../4.10/.gitbook/assets/guide-login-identifier-first-login--105.png" alt="The application Login settings in the newer console, with Identifier-first login switched on and Hide login form disabled."><figcaption></figcaption></figure>
...
<figure><img src="../../../4.10/.gitbook/assets/guide-login-identifier-first-login--106.png" alt="The Facebook identity provider Settings tab with a domain whitelist entry highlighted, which drives identifier-first redirection to this provider."><figcaption></figcaption></figure>
