---
description: Hide the default Access Management 4.10 login form and show only the upstream identity providers. Follow the steps to enable it for an application.
---
...
<figure><img src="../../../4.10/.gitbook/assets/guide-login-hide-login-form-107.png" alt="The application Login settings in the newer console, with Hide login form switched on above the Passwordless and Certificate Based Authentication sections."><figcaption></figcaption></figure>
