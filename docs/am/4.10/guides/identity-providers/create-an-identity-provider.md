...
<figure><img src="../../../4.10/.gitbook/assets/guide-identity-providers-create-an--62.png" alt="The Settings step of the New provider wizard, with an empty name field above empty user fields for first name, last name, username, and email."><figcaption></figcaption></figure>
