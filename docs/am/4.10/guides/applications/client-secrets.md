...
<figure><img src="../../../4.10/.gitbook/assets/guide-applications-client-secrets-87.png" alt="The Secrets and Certificates tab of an application, showing the client ID and one running secret above the certificate section."><figcaption><p>Create new client secret</p></figcaption></figure>

2. Provide description of new secret.

<div align="left"><figure><img src="../../../4.10/.gitbook/assets/Screenshot 2025-06-02 at 11.57.31 (1).png" alt="Step 1 of the New Client Secret dialog, asking for a description to identify the secret." width="308"><figcaption><p>New client secret description</p></figcaption></figure></div>

3. Copy generated secret.

<div align="left"><figure><img src="../../../4.10/.gitbook/assets/Screenshot 2025-06-02 at 11.57.49.png" alt="Step 2 of the New Client Secret dialog, showing the generated client secret partly redacted, with a warning that it cannot be retrieved later." width="305"><figcaption><p>New client secret - copy</p></figcaption></figure></div>
...
2.  Click **renew button** next to the corresponding secret.
    ...
    <figure><img src="../../../4.10/.gitbook/assets/Screenshot 2025-06-02 at 12.32.24.png" alt="The client secrets table with two running secrets, and the renew icon highlighted on the second row, which has an expiry date."><figcaption><p>Renew Client Secret</p></figcaption></figure>
3. Copy generated secret.\
...
2.  Click the **delete button** next to the corresponding secret.\
    ...
    <figure><img src="../../../4.10/.gitbook/assets/Screenshot 2025-06-02 at 12.32.45.png" alt="The client secrets table with two running secrets, and the delete icon highlighted on the second row."><figcaption><p>Delete Client Secret</p></figcaption></figure>
...
2.  **Configuration Steps:**
    ...
    <figure><img src="../../../4.10/.gitbook/assets/guide-applications-client-secrets-89.png" alt="The Client Secrets Policies page with client secret expiry enabled and the expiry set to three months."><figcaption></figcaption></figure>
...
* **Configuration Steps:**
  ...
  4.  Click **Settings**.<br>
      ...
      <figure><img src="../../../4.10/.gitbook/assets/Screenshot 2025-06-02 at 12.28.04 (1).png" alt="The Client Secrets section with the Settings button highlighted, beside New client secret and above the secrets table."><figcaption><p>Application Secret Settings</p></figcaption></figure>
  5. Toggle **Use Domain Rules**, and then and select **Expiry Time Unit** and **Expiry Time Duration**.\
     ![](<../../../4.10/.gitbook/assets/guide-applications-client-secrets-9.png>)
  6. Save the changes.
