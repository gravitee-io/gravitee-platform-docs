...
<figure><img src="../../../../4.10/.gitbook/assets/gs-config-configure-am-api-readme-165.png" alt="The Certificates page listing one default system PKCS#12 certificate with its expiry date and the number of applications using it."><figcaption></figcaption></figure>
