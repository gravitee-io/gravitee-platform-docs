---
description: OpenID Connect lets Access Management 4.9 clients request information about authenticated sessions. Compare the authorization code and implicit flows.
---
