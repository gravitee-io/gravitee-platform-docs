---
description: The authorization, authentication, and identity protocols Access Management 4.9 uses to let applications interact with it. Compare the protocols.
---
