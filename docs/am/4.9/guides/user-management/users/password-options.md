...
<figure><img src="../../../.gitbook/assets/guide-user-management-users-passwor-8.png" alt="The New User form with Enable pre-registration switched on, which replaces the password field with an activation email."><figcaption><p>A user profile where Enable pre-registration is enabled. This means that the user will receive an email with a link that will allow the user to set their first password.</p></figcaption></figure>
