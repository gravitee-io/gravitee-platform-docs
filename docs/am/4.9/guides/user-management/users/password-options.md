...
<figure><img src="../../../.gitbook/assets/guides-user-management-users-password-op-4-1.png" alt=""><figcaption><p>A user profile where Force Password Reset is set to true. This means that the user will be asked to update their password on the next login.</p></figcaption></figure>
