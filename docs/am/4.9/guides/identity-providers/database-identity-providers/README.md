---
description: Access Management 4.9 authenticates users against MongoDB, PostgreSQL, MySQL, SQL Server, and MariaDB. Compare the database providers available.
---
