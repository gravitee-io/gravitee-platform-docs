---
description: Authenticate Access Management 4.9 users with any provider implementing the OpenID Connect specification. Follow the steps to set up the connection.
---
