---
description: Authenticate Access Management 4.9 users with Azure Active Directory. Follow the steps to register an application and set up the connection.
---
...
9.  Click **Create**.
    ...
    <figure><img src="../../../.gitbook/assets/graviteeio-am-userguide-social-idp-azure-ad.png" alt="The Azure AD identity provider Settings tab, with masked tenant ID, client ID, and client secret fields, beside the redirect URI to configure."><figcaption><p>Create Azure AD IdP</p></figcaption></figure>
