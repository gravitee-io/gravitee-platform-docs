---
description: Authenticate Access Management 4.9 users with Facebook. Follow the steps to register a Facebook application and set up the connection.
---
...
7.  Click **Create**.
    ...
    <figure><img src="../../../.gitbook/assets/graviteeio-am-userguide-social-idp-facebook.png" alt="The Facebook identity provider Settings tab, with placeholder client ID and secret and a list of selectable scopes, beside the redirect URI to configure."><figcaption><p>Create Facebook IdP</p></figcaption></figure>
