---
description: Authenticate Access Management 4.9 users with Twitter. Follow the steps to register a Twitter application and set up the connection.
---
...
3.  Click **Create**.
    ...
    <figure><img src="../../../.gitbook/assets/graviteeio-am-userguide-social-idp-twitter.png" alt="The Twitter identity provider Settings tab, with placeholder client ID and secret and HTTP client timeout and pool settings, beside the redirect URI to configure."><figcaption><p>Create Twitter IdP</p></figcaption></figure>
