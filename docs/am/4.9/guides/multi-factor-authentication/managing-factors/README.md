...
\
Some factors also require a [**Resource**](docs/am/4.9/guides/resources.md).
...
3.  Select the factor type and click **Next.**
    ...
    <figure><img src="../../../../4.7/.gitbook/assets/john cr 1.png" alt=""><figcaption><p>Setting up Multifactor Auth from you Security Domain settings.</p></figcaption></figure>
