---
description: MFA rate limiting and brute force detection harden Access Management 4.9 against repeated attempts. Learn how each protection works.
---
...
<figure><img src="../../.gitbook/assets/graviteeio-am-userguide-mfa-ratelimit-exceed.png" alt="The SMS verification page showing an mfa_request_limit_exceed error explaining that too many codes were requested."><figcaption><p>Rate limit exceeded UI</p></figcaption></figure>
...
4.  Define your **Brute Force Detection** preferences.
    ...
    <figure><img src="../../.gitbook/assets/graviteeio-am-userguide-mfa-security.png" alt="The User Accounts security settings with MFA Brute Force Detection enabled, three maximum challenge attempts, and a one-minute reset time."><figcaption><p>Brute force detection preferences</p></figcaption></figure>

Once the number of maximum attempts is reached, the user will be notified with an error message.

<figure><img src="../../.gitbook/assets/graviteeio-am-userguide-mfa-brute-max.png" alt="The SMS verification page showing a maximum_verify_limit error stating that the maximum number of attempts has been reached."><figcaption><p>Brute force error message</p></figcaption></figure>
