---
description: Configure Access Management 4.9 MFA per application, covering enrollment and challenge. Follow the steps to enable factors and set selection rules.
---
