...
3.  Copy generated secret.
    ...
    <div align="left"><figure><img src="../../../4.8/.gitbook/assets/Screenshot%202025-06-02%20at%2011.57.49%20(1).png" alt="" width="305"><figcaption><p>New client secret - copy</p></figcaption></figure></div>
4. Click OK.
...
2.  Click **renew button** next to the corresponding secret.
    ...
    <figure><img src="../../../4.8/.gitbook/assets/Screenshot%202025-06-02%20at%2012.32.24%20(1).png" alt=""><figcaption><p>Renew Client Secret</p></figcaption></figure>
3. Copy generated secret.\
...
2.  Click the **delete button** next to the corresponding secret.\\
    ...
    <figure><img src="../../../4.8/.gitbook/assets/Screenshot%202025-06-02%20at%2012.32.45%20(1).png" alt=""><figcaption><p>Delete Client Secret</p></figcaption></figure>
...
* **Configuration Steps:**
  ...
  2.  Go to **Settings**, and then **Client Secrets.**
      ...
      <figure><img src="../../../4.8/.gitbook/assets/Screenshot%202025-06-02%20at%2012.06.56%20(1).png" alt=""><figcaption><p>Domain Secret Settings</p></figcaption></figure>
...
* **Configuration Steps:**
  ...
  5. Toggle **Use Domain Rules**, and then and select **Expiry Time Unit** and **Expiry Time Duration**.\
     ![](../../../4.8/.gitbook/assets/image%20\(10\)%20\(1\).png)
  6. Save the changes.
