---
description: Access Management 4.9 supports multiple client secrets per application with configurable expiration. Learn the use cases and how to manage them.
---
