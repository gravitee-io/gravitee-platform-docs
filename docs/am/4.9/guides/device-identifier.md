...
<figure><img src="../.gitbook/assets/guide-device-identifier-17.png" alt="The Settings step of the New Device Identifier wizard for a cookie device identifier, with a name entered and a note that no configuration is required."><figcaption><p>Cookie Device Identifier</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/guide-device-identifier-16.png" alt="The Settings step of the New Device Identifier wizard for a FingerprintJS v3 community plugin, with a name entered and an option to keep track of the device ID in a cookie."><figcaption><p>FingerprintJS v3 Community</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/guide-device-identifier-15.png" alt="Fingerprint JS v3 Pro"><figcaption><p>FingerprintJS v3 Pro</p></figcaption></figure>
