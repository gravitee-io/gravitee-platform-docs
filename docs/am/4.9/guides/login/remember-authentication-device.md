...
1. Configure a [device identifier](docs/am/4.9/guides/device-identifier.md).
...
<figure><img src="../../../4.7/.gitbook/assets/skip remember device.png" alt=""><figcaption><p>AM authentication device</p></figcaption></figure>
