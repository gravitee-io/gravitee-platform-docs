---
description: Hide the default Access Management 4.9 login form and show only the upstream identity providers. Follow the steps to enable it for an application.
---
...
<figure><img src="../../.gitbook/assets/graviteeio-am-userguide-hide-login-form-settings.png" alt="The application Login settings with Hide login form switched on and user registration, forgot password, passwordless, and identifier-first login switched off."><figcaption><p>Settings page for an application with Hide Login Form enabled</p></figcaption></figure>
