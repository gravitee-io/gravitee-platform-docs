---
description: Split Access Management 4.9 load across data planes by scoping databases per use case. Follow the steps for the Management API and Gateways.
---
...
<figure><img src="../../.gitbook/assets/am-multi-dataplane.svg" alt="A multi data plane deployment diagram, with a control plane holding the Management API and its database, linked by a sync process to two data planes that each have their own gateways, data cluster, and identity providers."><figcaption><p>Multi Data Plane deployment</p></figcaption></figure>
