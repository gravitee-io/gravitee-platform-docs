---
description: Upgrading Access Management 4.9 is deployment-specific, with MongoDB index changes at 4.5. Follow the steps that match your deployment.
---
...
Upgrading to AM 4.5 is deployment-specific. The [4.0 breaking changes](https://documentation.gravitee.io/am/4.0/releases-and-changelog/changelog/am-4.0.x#gravitee-access-management-4.0.0-july-20-2023) must be noted and/or adopted for a successful upgrade.
