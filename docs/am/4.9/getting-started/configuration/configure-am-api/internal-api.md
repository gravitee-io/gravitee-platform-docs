---
description: The Access Management 4.9 API exposes an internal API for monitoring and technical information about the component. Follow the steps to configure it.
---
