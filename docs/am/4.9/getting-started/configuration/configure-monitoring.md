---
description: Monitor the status and availability of an Access Management 4.9 installation with Prometheus. Follow the steps to enable the metrics service.
---
