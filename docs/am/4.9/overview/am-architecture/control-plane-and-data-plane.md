...
{% tab title="RDBMS" %}
{% hint style="warning" %}
As for [reporitory](docs/am/4.9/guides/identity-providers/database-identity-providers/jdbc.md) plugin, place the drivers in `$GRAVITEE_HOME/plugins/ext/dataplane-am-jdbc`
{% endhint %}
...
For more details on how to configure AM with multiple DataBase or multiple Data Planes, please refer to the [Configure Multiple Data Planes](docs/am/4.9/getting-started/install-and-upgrade-guides/configure-multiple-data-planes.md) page.

<figure><img src="../../../4.7/.gitbook/assets/am-multi-dataplane (1) (1).svg" alt=""><figcaption><p>Multiple DataPlane deployment</p></figcaption></figure>
