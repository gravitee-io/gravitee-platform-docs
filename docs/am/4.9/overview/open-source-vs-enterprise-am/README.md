---
description: What the Enterprise Edition adds to open source Access Management 4.9, including plugin packs and advanced environment management. Compare the two.
---
