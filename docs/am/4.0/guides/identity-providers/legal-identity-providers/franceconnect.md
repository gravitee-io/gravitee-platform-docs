---
description: Overview of National Insurance Number.
---
...
8.  Click **Create**.
    ...
    <figure><img src="../../../.gitbook/assets/graviteeio-am-userguide-legal-idp-franceconnect.png" alt="The FranceConnect identity provider Settings tab, with the environment set to Production, placeholder client ID and secret, and a list of selectable scopes, beside the redirect URI to configure."><figcaption><p>Create FranceConnect IdP</p></figcaption></figure>
