---
description: Which Access Management 4.13 plugins support secrets, their minimum version, and the fields that accept secret values. Find the plugin you need.
metaLinks:
  alternates:
    - >-
...
| OCI KMS         | 1.0.0 +        | <ul><li>API private key</li><li>API private key passphrase</li></ul> |
