---
description: Use a secret manager with Access Management 4.13 domains to keep credentials out of your configuration files. See how the integration works.
metaLinks:
  alternates:
    - >-
