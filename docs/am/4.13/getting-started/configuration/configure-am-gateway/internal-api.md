...
description: The Access Management 4.13 Gateway exposes an internal API for monitoring and technical information. Follow the steps to configure the endpoints.
---
