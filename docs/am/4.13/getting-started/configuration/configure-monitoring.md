...
description: Monitor the status and availability of an Access Management 4.13 installation with Prometheus. Follow the steps to enable the metrics service.
---
