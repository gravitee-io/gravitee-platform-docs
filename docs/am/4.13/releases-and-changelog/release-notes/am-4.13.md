...
* Self-hosted installations keep local entrypoint management, and keep building URLs from the data plane's `gateway.url` or the Management API's global `gateway.url`. See [Entrypoints](../../guides/configure-entrypoints.md).
