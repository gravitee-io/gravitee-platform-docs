...
description: Force an Access Management 4.13 user to reset an expired password at next login. Follow the steps to configure it and see the resulting behaviour.
---
