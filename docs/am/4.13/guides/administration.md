...
description: Organizations and environments structure an Access Management 4.13 installation, with roles and permissions on each. Learn how the two fit together.
---
