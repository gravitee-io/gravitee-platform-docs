...
description: Cross-origin resource sharing restricts which pages can call an Access Management 4.13 domain. Follow the steps to configure CORS parameters.
---
