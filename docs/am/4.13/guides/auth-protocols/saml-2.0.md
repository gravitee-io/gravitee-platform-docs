...
description: Enable SAML 2.0 identity provider support in Access Management 4.13 by installing the IdP protocol plugin. Follow the steps for your installation.
---
