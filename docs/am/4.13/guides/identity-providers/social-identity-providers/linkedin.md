...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/H4VhZJXn1S232OEmh8Wv/guides/identity-providers/social-identity-providers/linkedin
description: Authenticate Access Management 4.13 users with LinkedIn. Follow the steps to register a LinkedIn application and set up the connection.
---
...
<figure><img src="../../../.gitbook/assets/guide-identity-providers-social-ide-76.png" alt="The LinkedIn identity provider Settings tab, with a client ID, masked client secret, and the r_emailaddress and r_liteprofile scopes selected, beside the redirect URI to configure."><figcaption><p>Create LinkedIn Identity Provider</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/guide-identity-providers-social-ide-77.png" alt="The Identity Providers tab of an application, with the Mongo DB and JDBC providers switched off and Twitter/X, LinkedIn, Github, Facebook, and Azure AD social providers switched on."><figcaption><p>Select the LinkedIn Identity Provider in your Application</p></figcaption></figure>
