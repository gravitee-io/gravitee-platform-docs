...
description: Connect Access Management 4.13 to a Kerberos server, the ticket-based network authentication protocol. Follow the steps to create the connector.
---
