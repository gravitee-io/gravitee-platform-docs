...
description: Access Management 4.13 supports multiple client secrets per application with configurable expiration. Learn the use cases and how to manage them.
---
...
<figure><img src="../../.gitbook/assets/guide-applications-client-secrets-87.png" alt="The Secrets and Certificates tab of an application, showing the client ID and one running secret above the certificate section."><figcaption><p>Create new client secret</p></figcaption></figure>
...
2.  **Configuration Steps:**
    ...
    <figure><img src="../../.gitbook/assets/guide-applications-client-secrets-89.png" alt="The Client Secrets Policies page with client secret expiry enabled and the expiry set to three months."><figcaption></figcaption></figure>
