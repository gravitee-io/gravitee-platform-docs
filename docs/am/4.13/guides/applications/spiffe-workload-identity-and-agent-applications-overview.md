---
description: SPIFFE Workload Identity makes AI agents first-class OAuth identities in Access Management 4.13. Learn the key concepts and agent application types.
---
