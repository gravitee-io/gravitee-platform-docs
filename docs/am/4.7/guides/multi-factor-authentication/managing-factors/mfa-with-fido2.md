...
{% hint style="info" %}
Please configure **WebAuthn** under the **Security** section so that the plugin works as expected. Check the [Passwordless (W3C WebAuthn)](docs/am/4.7/guides/login/passwordless-w3c-webauthn.md) section for details.
{% endhint %}
