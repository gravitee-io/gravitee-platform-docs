...
{% hint style="info" %}
If you are running AM with [Docker Compose](docs/am/4.7/getting-started/install-and-upgrade-guides/run-in-docker/docker-compose-install.md), the `GRAVITEEIO-AM-UI-HOST` URL is `https://localhost/am/ui`.
{% endhint %}
...
* [Administrative roles](docs/am/4.7/guides/administration.md#roles-and-permissions-overview): Register new administrative users and manage their roles.
