...
You can use roles to supplement an access token’s claims, for example, to limit the scope of operation of your protected services and APIs. See [custom claims](docs/am/4.6/getting-started/tutorial-getting-started-with-am/get-user-profile-information.md#custom-claims) for more information.
