...
7. Configure the CONNECT flow with the following options:
   ...
   2. **Condition:** Execute the flow step if this condition is met (supports [Expression Language](docs/am/4.6/guides/am-expression-language.md)).
...
<figure><img src="../../../4.1/.gitbook/assets/account linking at app level.png" alt=""><figcaption><p>Apply account linking at the application level</p></figcaption></figure>
...
<figure><img src="../../../4.1/.gitbook/assets/account linking_flows.png" alt=""><figcaption><p>Apply account linking at the security domain level</p></figcaption></figure>
