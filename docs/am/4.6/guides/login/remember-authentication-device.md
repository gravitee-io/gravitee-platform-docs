...
1. Configure a [device identifier](docs/am/4.6/guides/device-identifier.md).
...
<figure><img src="../../../4.2/.gitbook/assets/skip remember device (1).png" alt=""><figcaption><p>AM authentication device</p></figcaption></figure>
