...
{% hint style="info" %}
We advise you to read [get user profile information](docs/am/4.6/getting-started/tutorial-getting-started-with-am/get-user-profile-information.md) first.
{% endhint %}
...
<figure><img src="../../../4.5/.gitbook/assets/image (2).png" alt=""><figcaption><p>Assign ADMIN group to all user profile with memberOf equals administrators</p></figcaption></figure>
