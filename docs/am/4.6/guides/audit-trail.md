...
{% hint style="info" %}
All of this information can also be retrieved with the [AM API.](docs/am/4.6/reference/am-api-reference.md)
{% endhint %}
...
Audit events are managed (store and fetch) by plugins called [Reporters](docs/am/4.6/getting-started/configuration/configure-reporters.md).
