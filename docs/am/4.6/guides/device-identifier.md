...
<figure><img src="../.gitbook/assets/graviteeio-am-userguide-device-identifier-fpjsv3community.png" alt="A FingerprintJS v3 community device identifier plugin, with a name field, a note that no configuration is required, and a delete section."><figcaption><p>FpJS v3 community</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/graviteeio-am-userguide-device-identifier-fpjsv3pro.png" alt="A FingerprintJS v3 Pro device identifier plugin, with a name, a browser subscription token placeholder, and an optional registration region."><figcaption><p>FpJS v3 pro</p></figcaption></figure>
