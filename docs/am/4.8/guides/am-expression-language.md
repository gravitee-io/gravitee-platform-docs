---
description: The Access Management 4.8 Expression Language configures domain behaviour from request and application data. Learn the syntax and what it exposes.
---
