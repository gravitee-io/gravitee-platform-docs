---
description: MFA policies apply challenge and enrollment inside an Access Management 4.8 flow, beyond application settings. Compare the two policies.
---
...
<figure><img src="../../.gitbook/assets/john 1.png" alt="The flow designer with an Enroll MFA policy added to the Login flow, its settings panel open beside the policy documentation."><figcaption><p>Login flow with MFA enrollment policy</p></figcaption></figure>
