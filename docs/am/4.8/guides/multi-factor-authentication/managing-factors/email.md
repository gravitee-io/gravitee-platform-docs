...
{% hint style="info" %}
Email MFA requires a compatible [resource](docs/am/4.8/guides/resources.md).
{% endhint %}

Using the `email-am-factor` plugin configuration form, you can define the number of digits used to generate the verification code. The configured resource must be an [SMTP Resource](docs/am/4.8/guides/resources.md#resource-types). The email template used by this plugin is defined in the design section of the domain or application.
