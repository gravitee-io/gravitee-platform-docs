---
description: Cross-origin resource sharing restricts which pages can call an Access Management 4.8 domain. Follow the steps to configure CORS parameters.
hidden: true
noIndex: true
---
