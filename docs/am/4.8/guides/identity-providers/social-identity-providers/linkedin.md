---
description: Authenticate Access Management 4.8 users with LinkedIn. Follow the steps to register a LinkedIn application and set up the connection.
---
...
7.  Click **Create**.
    ...
    <figure><img src="../../../.gitbook/assets/graviteeio-am-userguide-social-idp-linkedin.png" alt="The LinkedIn identity provider Settings tab, with a client ID and secret and the r_emailaddress and r_liteprofile scopes selected, beside the redirect URI to configure."><figcaption><p>Create LinkedIn IdP</p></figcaption></figure>
