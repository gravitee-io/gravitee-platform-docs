---
description: Authenticate Access Management 4.8 users with Salesforce. Follow the steps to register an application and test the connection.
---
...
8.  Click **Create**.
    ...
    <figure><img src="../../../.gitbook/assets/graviteeio-am-userguide-social-idp-salesforce.png" alt="The Salesforce identity provider Settings tab, with placeholder client ID and secret and a list of selectable scopes, beside the redirect URI to configure."><figcaption><p>Create Salesforce IdP</p></figcaption></figure>
