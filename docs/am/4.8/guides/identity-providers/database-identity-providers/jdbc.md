---
description: Authenticate Access Management 4.8 users against a SQL database over JDBC. Follow the steps to create the provider and test the connection.
---
...
1.  In AM Console, click **Applications** and select your JDBC identity provider.
    ...
    <figure><img src="../../../.gitbook/assets/graviteeio-am-userguide-social-idp-list.png" alt=""><figcaption><p>Select JDBC IdP</p></figcaption></figure>
