---
description: Inline identity providers give Access Management 4.8 an in-memory user directory for testing or default accounts. Follow the steps to create one.
---
