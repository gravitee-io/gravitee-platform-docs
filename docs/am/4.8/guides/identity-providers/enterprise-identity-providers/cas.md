---
description: Connect Access Management 4.8 to a Central Authentication Service server using the ticket-based CAS protocol. Follow the steps to create the connector.
---
