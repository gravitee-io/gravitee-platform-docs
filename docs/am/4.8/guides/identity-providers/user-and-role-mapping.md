...
{% hint style="info" %}
We advise you to read [get user profile information](docs/am/4.8/getting-started/tutorial-getting-started-with-am/get-user-profile-information.md) first.
{% endhint %}
