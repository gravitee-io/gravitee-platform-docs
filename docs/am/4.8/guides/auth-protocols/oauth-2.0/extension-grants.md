---
description: Extension grants add custom token endpoint grant types to Access Management 4.8, such as JWT Bearer. Follow the steps to create and use one.
---
...
3.  Click the plus icon ![plus icon](../../../.gitbook/assets/plus-icon.png).
    ...
    <figure><img src="../../../.gitbook/assets/graviteeio-am-userguide-extension-grants-jwt-bearer-create1.png" alt="The Extension Grants page with none configured, showing an Extension Grants will appear here empty state and an add button."><figcaption><p>Extension grants screen</p></figcaption></figure>
4.  Select **Extension Grant JWT Bearer** and click **Next**.

    <figure><img src="../../../.gitbook/assets/graviteeio-am-userguide-extension-grants-jwt-bearer-create2.png" alt="The New extension grant wizard on the Platform step, with Extension Grant JWT Bearer selected as the grant type."><figcaption><p>Add JWT bearer</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/graviteeio-am-userguide-extension-grants-jwt-bearer-create3.png" alt="The Settings step of the New extension grant wizard, with the grant name, the JWT bearer grant type, an SSH public key, and a claims mapper, beside the RFC 7523 example."><figcaption><p>Public key</p></figcaption></figure>
...
3.  In the **Grant flows** section, select your extension grant.
    ...
    <figure><img src="../../../.gitbook/assets/graviteeio-am-userguide-extension-grants-jwt-bearer-associate.png" alt="The application OAuth 2.0 grant flows with Authorization Code, Implicit, and the custom extension grant selected, beside guidance on grant types and ID tokens."><figcaption><p>Associate extension grant with application</p></figcaption></figure>
4.  Click **SAVE**.
