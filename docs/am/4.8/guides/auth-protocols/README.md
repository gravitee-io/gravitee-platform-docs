---
description: The authorization, authentication, and identity protocols Access Management 4.8 uses to let applications interact with it. Compare the protocols.
---
