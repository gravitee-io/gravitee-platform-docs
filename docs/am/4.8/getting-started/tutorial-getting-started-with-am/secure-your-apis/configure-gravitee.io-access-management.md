---
description: Configure Access Management 4.8 as the authorization server resource for an API secured with the OAuth 2.0 policy. Follow the steps and example.
---
