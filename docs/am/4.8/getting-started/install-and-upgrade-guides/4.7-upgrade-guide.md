...
**NOTE**: When defining repository settings using environment variables, ensure that the Data Plane settings are aligned with the settings configured for the "gateway" [repository](docs/am/4.8/getting-started/configuration/configure-repositories.md#scopes) scope.
