---
description: Access Management 4.8 lets you choose a database scope per use case, splitting load between the control plane and the data plane. Learn when to isolate them.
---
...
<figure><img src="../../.gitbook/assets/am-multi-dataplane.svg" alt="A multi data plane deployment diagram, with a control plane holding the Management API and its database, linked by a sync process to two data planes that each have their own gateways, data cluster, and identity providers."><figcaption><p>Multiple DataPlane deployment</p></figcaption></figure>
