...
To fully tend to your application branding and user experience, AM enables you to customize forms either on [security domain level](docs/am/4.1/guides/security-domains.md) or on the [application level](docs/am/4.1/guides/applications.md). This addresses cases where some applications can be fine with relying on your overall company branding but others may be in need of a more custom branding touch.
