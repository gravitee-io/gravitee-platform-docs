...
<figure><img src="../../.gitbook/assets/guide-identity-providers-user-and-r-0.png" alt="The Group mappings dialog on the Group mappers tab, mapping a memberOf user condition to the ADMIN group."><figcaption><p>Assign ADMIN group to all user profile with memberOf equals administrators</p></figcaption></figure>
