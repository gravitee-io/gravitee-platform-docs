...
SMS MFA requires a compatible [resource](docs/am/4.5/guides/resources.md). Some providers allow you to define the duration of the code sent by SMS. If possible, we advise setting a duration of 2 minutes.
