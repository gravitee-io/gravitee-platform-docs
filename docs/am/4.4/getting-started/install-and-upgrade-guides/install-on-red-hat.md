...
{% hint style="info" %}
Since AM 4.4.25, RPM packages are signed with GPG. To verify the packages, use the `gpgcheck=1` configuration.
{% endhint %}

1.  Before continuing, you may need to refresh your local cache:
...
{% hint style="warning" %}
Refer to the [changelog](docs/am/4.4/releases-and-changelog/changelog/am-4.3.x.md) to follow potential breaking changes.
{% endhint %}
