...
<figure><img src="../.gitbook/assets/guide-certificates-0.png" alt="The certificate Signing algorithm set to RS256, with the Usage options showing mTLS selected and Signature and Encryption unselected."><figcaption><p>Enable mTLS usage to be able to use a certificate to secure backend connections</p></figcaption></figure>
