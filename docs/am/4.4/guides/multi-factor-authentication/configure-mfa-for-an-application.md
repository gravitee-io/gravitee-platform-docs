...
1.  Click on **Select Factors**
    ...
    <figure><img src="../../.gitbook/assets/conf mfa 2.png" alt="The Multifactor Auth tab with no factors selected yet and a Select Factors button."><figcaption></figcaption></figure>
2.  Select one to many factors, then click **Add Selected**

    <figure><img src="../../.gitbook/assets/conf mfa 3.png" alt="The Add Factors dialog listing two email factors and a TOTP factor, all selected, above an Add Selected button."><figcaption></figcaption></figure>
3.  You should now have the selected factors enabled for the application

    <figure><img src="../../.gitbook/assets/conf mfa 4.png" alt="The Factors list after adding three factors, with the first email factor set as the default."><figcaption></figcaption></figure>
...
1.  Click on Selection Rule icon for one factor
    ...
    <figure><img src="../../.gitbook/assets/conf mfa 5.png" alt="The Factors list showing the three added factors with the first email factor set as the default."><figcaption></figcaption></figure>
2.  Add a Selection Rule and click on **Save**

    <figure><img src="../../.gitbook/assets/conf mfa 6.png" alt="The Selection rule dialog with a Gravitee Expression Language condition example matching a user&#x27;s country attribute."><figcaption></figcaption></figure>
3.  Only users matching the Selection Rule will be able to enroll using the factor

    <figure><img src="../../.gitbook/assets/conf mfa 7.png" alt="The Multifactor Auth tab of an application, listing three factors and their selection rules above the MFA Enrollment and MFA Challenge sections."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/conf mfa 7 (1).png" alt="The Multifactor Auth tab of an application, listing three factors and their selection rules above the MFA Enrollment and MFA Challenge sections."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/conf mfa 10.png" alt="The MFA Enrollment section enabled with Optional selected and a ten-hour period during which users can skip enrollment."><figcaption></figcaption></figure>

### Required enrollment

With required enrollment, all users will be required to enroll with MFA during sign in.

<figure><img src="../../.gitbook/assets/conf mfa 11.png" alt="The MFA Enrollment section with Required selected, explaining that all users must enrol with MFA during sign-in."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/conf mfa 12.png" alt="The MFA Enrollment section with Conditional selected, showing an Expression Language rule and a toggle for letting users skip conditional enrollment."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/conf mfa 13.png" alt="Conditional enrollment configured with a rule, skipping allowed under a second rule, and a ten-hour delay before users are asked to enrol."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/conf mfa 15.png" alt="The MFA Challenge section with Risk-based selected, showing the Associated Devices, IP Reputation Score, and Geolocation Velocity settings, all disabled."><figcaption></figcaption></figure>

### Required challenge

With required enrollment, all users will be required to enroll with MFA during sign in.

<figure><img src="../../.gitbook/assets/conf mfa 16.png" alt="The MFA Challenge section set to Required, above a Remember Device section warning that a Device Identifier plugin must be created first."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/conf mfa 17.png" alt="The MFA Challenge section set to Conditional, with an empty Conditional Rules field for a Gravitee Expression Language rule."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/conf mfa 18.png" alt="The Remember Device section enabled, with a device identifier provider selected and a ten-hour trust duration."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/conf mfa 19.png" alt="The Step-Up Authentication section enabled with an empty Step-Up rules field, below the Remember Device settings."><figcaption></figcaption></figure>
