...
{% tab title="SMTP" %}
SMTP is a resource you can use to send email over SMTP. Once you have created your SMTP resource, you can reference it in the [Email factor configuration.](multi-factor-authentication/factors.md#email)
