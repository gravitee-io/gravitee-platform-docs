...
{% hint style="info" %}
To add an alternative verification method, your applications can use the [Self-service account management API.](docs/am/4.3/guides/user-management/self-service-account-management.md)
{% endhint %}
