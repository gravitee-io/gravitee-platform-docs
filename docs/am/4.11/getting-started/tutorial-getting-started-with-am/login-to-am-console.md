...
| Settings → Certificates         | Register certificates for your applications. Certificates are used to sign applications access tokens. Centralized certificates manager provides rotate signing keys mechanism. Master domains can access certificates from any domain for fallback purposes, enabling cross-domain introspection and centralized certificate management. |
