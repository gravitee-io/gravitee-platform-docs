...
| Settings → Certificates         | Register certificates for your applications and Protected Resources. Certificates are used to sign applications access tokens and verify Protected Resource signatures. Centralized certificates manager provides rotate signing keys mechanism. |
