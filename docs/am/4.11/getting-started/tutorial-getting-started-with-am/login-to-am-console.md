...
| Settings → Certificates         | Register certificates for your applications. Certificates are used to sign applications access tokens. Centralized certificates manager provides rotate signing keys mechanism. Configure fallback certificates to improve JWT signing resilience. |
