...
description: Use API Management to protect an API with OAuth 2.0 and Access Management 4.11 as the authorization server. Follow the steps to configure it.
---
