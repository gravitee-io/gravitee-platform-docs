...
description: Monitor the status and availability of an Access Management 4.11 installation with Prometheus. Follow the steps to enable the metrics service.
---
