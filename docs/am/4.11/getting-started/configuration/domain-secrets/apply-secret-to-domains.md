---
description: Reference secrets in Access Management 4.11 domain fields using Expression Language. Follow the steps for the general and secret URI syntax.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/H4VhZJXn1S232OEmh8Wv/getting-started/configuration/domain-secrets/apply-secret-to-domains
---
