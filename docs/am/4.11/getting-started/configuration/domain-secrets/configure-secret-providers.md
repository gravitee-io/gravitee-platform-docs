...
description: Configure Kubernetes or HashiCorp Vault as a secret provider for Access Management 4.11 domains. Follow the steps and check the known limits.
---
