...
description: The Access Management 4.11 API exposes an internal API for monitoring and technical information about the component. Follow the steps to configure it.
---
