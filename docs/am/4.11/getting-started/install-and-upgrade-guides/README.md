...
description: The Gravitee platform ships Access Management 4.11 as a single distribution bundle. Browse the install and upgrade guides for your deployment.
---
