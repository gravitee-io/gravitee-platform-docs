...
description: Split Access Management 4.11 load across data planes by scoping databases per use case. Follow the steps for the Management API and Gateways.
---
