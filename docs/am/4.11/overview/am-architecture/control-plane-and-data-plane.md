...
description: Access Management 4.11 lets you choose a database scope per use case, splitting load between the control plane and the data plane. Learn when to isolate them.
---
