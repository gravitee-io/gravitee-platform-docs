...
* [Auth Protocols](guides/auth-protocols/README.md)
  ...
  * [UMA 2.0](guides/auth-protocols/uma-2.0.md)
    * [Managing Protected Resource Secrets](guides/auth-protocols/uma-2.0/managing-protected-resource-secrets.md)
...
* [MCP Servers](guides/mcp-servers/README.md)
  ...
  * [Protected Resource Secrets and Token Introspection Overview](guides/mcp-servers/protected-resource-constraints.md)
...
* [Community](community-and-support/community/README.md)
  ...
  * [Protected Resource Restrictions and Constraints](guides/mcp-servers/protected-resource-secrets.md)
  * [Token Introspection Configuration](guides/mcp-servers/token-introspection-reference.md)
