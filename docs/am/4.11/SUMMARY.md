...
* [Token Exchange Request and Response](guides/token-exchange-request-and-response-reference.md)
* [Token Exchange Restrictions and Related Changes](guides/token-exchange-restrictions-and-related-changes.md)
