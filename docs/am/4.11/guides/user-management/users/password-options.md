...
description: Control how Access Management 4.11 users set a first password, by forcing a reset or sending a registration email. Follow the steps to choose.
---
...
<figure><img src="../../../.gitbook/assets/guide-user-management-users-passwor-8.png" alt="The New User form completed with name, email, username, password, application, and identity provider, above a Force Password Reset section with the toggle switched on."><figcaption><p>A user profile where Force Password Reset is set to true. This means that the user will be asked to update their password on the next login.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/guide-user-management-users-passwor-7.png" alt="The New User form with Enable pre-registration switched on, which replaces the password field with an activation email."><figcaption><p>A user profile where Enable pre-registration is enabled. This means that the user will receive an email with a link that will allow the user to set their first password.</p></figcaption></figure>
