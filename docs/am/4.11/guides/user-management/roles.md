...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/H4VhZJXn1S232OEmh8Wv/guides/user-management/roles
description: Roles give Access Management 4.11 users a set of permissions for the operations they can perform. Follow the steps to create and use one.
---
