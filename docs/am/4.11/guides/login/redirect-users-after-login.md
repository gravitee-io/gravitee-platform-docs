...
description: Control where Access Management 4.11 sends a user after login, from an OAuth 2.0, OpenID Connect, or SAML flow. Learn how redirection is decided.
---
