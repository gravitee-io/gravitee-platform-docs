...
description: Certificate-based authentication verifies Access Management 4.11 users with a client certificate. Follow the steps to install the plugin and enable it.
---
