...
description: Hide the default Access Management 4.11 login form and show only the upstream identity providers. Follow the steps to enable it for an application.
---
