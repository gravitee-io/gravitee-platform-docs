---
description: Magic link authentication signs Access Management 4.11 users in through a time-limited email link. Learn the token, templates, and audit events.
---
