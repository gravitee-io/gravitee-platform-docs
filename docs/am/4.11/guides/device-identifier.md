...
description: Device identifiers let Access Management 4.11 remember the devices used to set up MFA. Follow the steps to create one and compare the plugins.
---
