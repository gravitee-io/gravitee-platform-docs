...
description: The OpenFGA plugin brings fine-grained authorization to Access Management 4.11. Follow the steps to create a plugin instance and configure it.
---
