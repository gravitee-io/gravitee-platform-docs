...
description: MCP Servers give Access Management 4.11 a standard way to expose operations to AI clients. Learn the capabilities and how they are implemented.
---
