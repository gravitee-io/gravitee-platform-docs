...
<figure><img src="../../../.gitbook/assets/guide-multi-factor-authentication-m-108 (1).png" alt=""><figcaption><p>Setting up Multifactor Auth from you Security Domain settings.</p></figcaption></figure>
