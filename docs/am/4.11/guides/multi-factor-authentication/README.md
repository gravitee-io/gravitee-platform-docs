...
description: Multi-factor authentication adds steps to the Access Management 4.11 login flow to enforce access control. Learn how MFA works before you configure it.
---
