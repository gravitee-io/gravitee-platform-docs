...
description: Access Management 4.11 supports multiple client secrets per application with configurable expiration. Learn the use cases and how to manage them.
---
