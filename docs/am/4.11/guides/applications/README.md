...
description: Applications act on behalf of a user to request Access Management 4.11 tokens and reach protected resources. Follow the steps to create one.
---
