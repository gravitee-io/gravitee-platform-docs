...
description: A security domain groups Access Management 4.11 applications, users, and identity providers with its own endpoints. Follow the steps to create one.
---
