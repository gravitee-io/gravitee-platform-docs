...
| PROTECTED\_RESOURCE\_SETTINGS   | Manage protected resource configuration settings                                  |
| PROTECTED\_RESOURCE\_OAUTH      | Manage OAuth 2.0 client secrets and credentials for protected resources           |
| PROTECTED\_RESOURCE\_CERTIFICATE| Manage certificates associated with protected resources                           |
...
Three permission types have been added to support granular access control for protected resources:

* `PROTECTED_RESOURCE_SETTINGS` — Manage protected resource configuration settings
* `PROTECTED_RESOURCE_OAUTH` — Manage OAuth 2.0 client secrets and credentials for protected resources
* `PROTECTED_RESOURCE_CERTIFICATE` — Manage certificates associated with protected resources

#### Updated permission requirements

The following operations now require refined permission scopes:

* **Secret management operations** — Require `PROTECTED_RESOURCE_OAUTH[*]` permissions instead of generic `PROTECTED_RESOURCE[*]` permissions
* **Member permission listing** — Requires `PROTECTED_RESOURCE_MEMBER[READ]` permission

These changes provide more precise control over protected resource administration and align permission scopes with specific operational contexts.
