...
The `protected_resources` table includes a `certificate` column in both JDBC and MongoDB schemas. This column stores the reference to the X.509 certificate used for JWT signature verification during token introspection.
