...
Both JDBC and MongoDB database schemas include a `protected_resources` table/collection with the following fields:

| Field | Data Type | Nullability | Description |
|:------|:----------|:------------|:------------|
| `certificate` | string/varchar | nullable | Certificate ID for mutual TLS authentication |
