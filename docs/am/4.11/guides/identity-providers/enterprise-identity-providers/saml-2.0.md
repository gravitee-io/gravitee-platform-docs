...
4. Select **SAML 2.0** as your identity provider type, and then click **Next**.
...
6. Select **IdP Metadata Provider**.
   ...
   For `MANUAL`, configure the required settings: **Entity ID (SP)**, **Sign In URL**, and **Signing Certificate**.
7. Click **Create**.
