...
description: An identity provider authenticates users and passes their information to Access Management 4.11. Compare the social, database, and enterprise types.
---
