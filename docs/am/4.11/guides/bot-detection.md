...
description: Bot detection protects Access Management 4.11 sign-in pages from automated requests. Follow the steps to enable it at domain or application level.
---
