---
description: The authorization, authentication, and identity protocols Access Management 4.11 uses to let applications interact with it. Compare the protocols.
metaLinks:
  alternates:
