...
:page-description: Gravitee Cloud - Identity Provider - Generic OAuth2
...
By default, the plugin will use the `userinfo` endpoint to fetch the required information to create a Gravitee Cloud user.
