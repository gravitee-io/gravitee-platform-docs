...
<figure><img src="../../../4.6/.gitbook/assets/1 global 1 (1).png" alt=""><figcaption></figcaption></figure>
...
{% hint style="info" %}
Only users with the required permissions can manage application members. See [User Management](docs/apim/4.7/administration/user-management.md).
{% endhint %}
