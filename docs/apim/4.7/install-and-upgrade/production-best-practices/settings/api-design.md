...
* Enable and configure CORS at the API level. This ensures the best level of security when APIs are consumed by browser-based applications. For more information, see [CORS](docs/apim/4.7/configure-v4-apis/cors.md).
...
More information on how to manage API subscriptions is detailed in the [Subscriptions](docs/apim/4.7/expose-apis/subscriptions.md) documentation.
