...
<figure><img src="../../../.gitbook/assets/governance-federation-3rd-party-provider-1-1.png" alt="The Overview page of an AWS API Gateway integration, with an arrow pointing to a partly masked integration identifier beside the disconnected agent."><figcaption></figcaption></figure>
