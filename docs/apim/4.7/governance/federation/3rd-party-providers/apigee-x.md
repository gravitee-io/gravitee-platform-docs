...
<figure><img src="../../../.gitbook/assets/governance-federation-apigee-x-121.png" alt="The Overview page of an Apigee integration, with an arrow pointing to a partly masked integration identifier beside the disconnected agent."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/governance-federation-apigee-x-122.png" alt="The Select a resource dialog in a cloud console, with an arrow pointing to a partly masked project identifier beside the project name."><figcaption></figcaption></figure>
