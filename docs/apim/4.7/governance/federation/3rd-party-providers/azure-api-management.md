...
<figure><img src="../../../.gitbook/assets/governance-federation-azure-api-man-119.png" alt="The Overview page of an Azure API Management integration, with an arrow pointing to a partly masked integration identifier beside the disconnected agent."><figcaption></figcaption></figure>
...
<img src="../../../.gitbook/assets/governance-federation-azure-api-man-116.png" alt="The Overview page of an API Management service in a cloud console, with an arrow pointing to a masked subscription identifier beside the masked resource group." data-size="original">
{% endhint %}
...
<figure><img src="../../../.gitbook/assets/governance-federation-azure-api-man-120.png" alt="The Overview page of an Azure API Management integration after the agent connects, with Connected shown in both the menu and the agent connection field."><figcaption></figcaption></figure>
