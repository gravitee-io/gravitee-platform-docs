...
<figure><img src="../../../.gitbook/assets/governance-federation-3rd-party-provider-3-1.png" alt="The Overview page of a Confluent Platform integration, with an arrow pointing to a partly masked integration identifier beside the disconnected agent."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/governance-federation-3rd-party-provider-4-1.png" alt="The Overview page of a Confluent Platform integration after the agent connects, with Connected shown in both the menu and the agent connection field."><figcaption></figcaption></figure>
