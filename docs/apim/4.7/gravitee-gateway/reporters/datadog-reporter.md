...
{% hint style="info" %}
You can obscure the value of this API key by using [configuration-level secrets](docs/apim/4.7/configure-apim/sensitive-data-management/configuration-level-secrets.md) in `gravitee.yml`.
{% endhint %}
...
| tenant         | ID of the tenant evaluated for the API (see [tenants](docs/apim/4.7/gravitee-gateway/tenants.md))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |                                                                                              |
...
You can use the [Assign Metrics](docs/apim/4.7/policies/assign-metrics.md) policy to add custom metrics to the output of the Datadog Reporter. They appear in Datadog with the name `gravitee.apim.{metricName}`, where `metricName` is configured in the policy.
