...
<figure><img src="../.gitbook/assets/kafka-gateway-create-kafka-apis-139-1.png" alt="The Choose API creation method dialog, offering Create Classic API with V2 options and Create New API with V4 options."><figcaption></figcaption></figure>
