...
All policies will also support the new reactive execution engine, but not all policies can being applied at the message level. Whether a policy can be applied to v4 proxy APIs and/or v4 message APIs is detailed per policy in the [https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.7/create-apis/overview/broken-reference/README.md](https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.7/create-apis/overview/broken-reference/README.md "mention") section.
