...
4.  Configure the **API permissions** to allow Gravitee to read the user **email**, **openid**, and **profile** details.
    ...
    <figure><img src="../../.gitbook/assets/administration-authentication-azure-entr-2-1 (1).png" alt="The API permissions page of an app registration in an external identity provider, listing four delegated Microsoft Graph permissions for email, openid, profile, and user profile."><figcaption></figcaption></figure>
