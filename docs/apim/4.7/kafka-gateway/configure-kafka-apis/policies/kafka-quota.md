...
<figure><img src="../../../.gitbook/assets/kafka-gateway-configure-kafka-apis-polic-160-1.png" alt="The Kafka quota policy configuration, with an empty key, use key only switched off, and a static limit of five bytes, beside the policy documentation."><figcaption><p>Kafka Quota Policy UI</p></figcaption></figure>
