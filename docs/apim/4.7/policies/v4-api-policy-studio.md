...
6.  Configure the flow using the **Create a new flow** module with the options shown below
    ...
    * **Condition:** Use [Gravitee's Expression Language (EL)](docs/apim/4.7/getting-started/gravitee-expression-language.md) to define specific conditions that will trigger flow execution.
