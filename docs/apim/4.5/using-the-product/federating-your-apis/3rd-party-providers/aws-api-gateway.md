...
<figure><img src="../../../.gitbook/assets/using-the-product-federating-your-apis-3-1-1.png" alt="The Overview page of an AWS API Gateway integration, with an arrow pointing to a partly masked integration identifier beside the disconnected agent."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/using-the-product-federating-your-apis-3-2-1.png" alt="The Overview page of an AWS API Gateway integration after the agent connects, with Connected shown in both the menu and the agent connection field."><figcaption></figcaption></figure>
