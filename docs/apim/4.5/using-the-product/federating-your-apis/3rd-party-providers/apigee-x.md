...
<figure><img src="../../../.gitbook/assets/using-the-product-federating-your-a-121.png" alt="The Overview page of an Apigee integration, with an arrow pointing to a partly masked integration identifier beside the disconnected agent."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/using-the-product-federating-your-a-122.png" alt="The Select a resource dialog in a cloud console, with an arrow pointing to a partly masked project identifier beside the project name."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Screenshot 2024-10-09 at 17.52.53.png" alt="The Create private key dialog for a federation service account in a cloud console, with JSON selected over P12 and a warning that the key cannot be recovered if lost."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Screenshot 2024-10-09 at 17.41.58.png" alt="The Overview page of an Apigee integration after the agent connects, with Connected shown in both the menu and the agent connection field."><figcaption></figcaption></figure>
