...
1. [API](docs/apim/4.5/using-the-product/managing-your-apis/api-configuration/v2-api-configuration/general-proxy-settings.md#configure-cors)
2. Environment
3. Organization
