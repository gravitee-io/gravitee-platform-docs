...
To learn more about how to deploy APIs to specific Gateways based on sharding tags, refer to [Configure Deployments](../../managing-your-apis/api-configuration/v2-api-configuration/general-proxy-settings.md#configure-deployments).
...
7.  You can view your entrypoint mapping in the **Entrypoint mappings** section:
    ...
    <figure><img src="../../../.gitbook/assets/using-the-product-using-the-gravitee-api-48-1.png" alt=""><figcaption></figcaption></figure>

{% hint style="success" %}
You've just learned how to configure sharding tags for your Gravitee API Gateways. To apply sharding tags to APIs in order to control where those APIs are deployed, refer to [this documentation](../../managing-your-apis/api-configuration/v2-api-configuration/general-proxy-settings.md#configure-deployments).
{% endhint %}
