...
Configuration details for the Elasticsearch reporter are available in the [Elasticsearch Repository](../../../../installation-and-upgrades/repositories/#elasticsearch) documentation.
