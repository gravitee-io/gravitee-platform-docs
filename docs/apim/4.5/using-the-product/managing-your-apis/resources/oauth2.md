...
<figure><img src="../../../.gitbook/assets/resource_oauth2 generic.png" alt="The Create resource form for a generic OAuth2 authorization server, with an empty required resource name, an authorization server URL, a token introspection endpoint, and the GET introspection method."><figcaption><p>Create an OAuth2 Generic Authorization Server resource</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/resource_oauth2 am.png" alt="The Create resource form for an Access Management authorization server, with empty required resource name, server URL, and security domain fields and the version set to V3_X."><figcaption><p>Create an OAuth2 Gravitee AM Authorization Server resource</p></figcaption></figure>
