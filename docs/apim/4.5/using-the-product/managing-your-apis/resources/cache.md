...
{% tabs %}
{% tab title="Cache" %}
<figure><img src="../../../.gitbook/assets/resource_cache.png" alt="The Create resource form for a cache, with a cache name entered and time to idle, time to live, and max heap entry fields."><figcaption><p>Create a Cache resource</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/resource_cache redis.png" alt="The Create resource form for a Redis cache, with a name entered, the release-on-stop toggle off, a max total of eight connections, and an empty password field."><figcaption><p>Create a Cache Redis resource</p></figcaption></figure>
