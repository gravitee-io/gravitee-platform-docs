...
5.  Click the **+** icon for a plan or **Common flows** to create a flow
    ...
    <figure><img src="../../../.gitbook/assets/flow_add flow.png" alt="The Policies page of a message API, listing a default keyless plan, a default push plan, and a Common flows group, with no flows defined yet."><figcaption><p>Create a flow</p></figcaption></figure>
6.  Configure the flow using the **Create a new flow** module with the options shown below

    <figure><img src="../../../.gitbook/assets/flow_configure flow.png" alt="The Create a new flow dialog for a message API, with an empty flow name, the Equals channel operator, and empty channel, entrypoints, operations, and condition fields."><figcaption><p>Configure a new flow</p></figcaption></figure>
...
8.  To add a policy, click the **+** icon to the phase where the policy should be enforced
    ...
    <figure><img src="../../../.gitbook/assets/flow_add policy.png" alt="The Policies page with a sample flow selected, showing its entrypoints and operations above empty request and response phases for the initial connection."><figcaption><p>Add a policy</p></figcaption></figure>
...
11. Click **Add policy**. The policy will appear in the flow diagram of the phase it was added to.
    ...
    <figure><img src="../../../.gitbook/assets/flow_policy in flow.png" alt="The Policies page with an Assign metrics policy added to the request phase of the selected flow."><figcaption><p>Policy added to flow</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/flow_execution.png" alt="The Flow execution dialog, explaining default and best match flow selection, with the mode set to Default and Fail on flow mismatch switched off."><figcaption><p>Configure flow mode</p></figcaption></figure>
...
5.  Select the **Properties** tab
    ...
    <figure><img src="../../../.gitbook/assets/api properties_tab.png" alt="The Properties tab of an API&#x27;s Configuration page, empty, with Import, Manage dynamically, and Add property buttons."><figcaption><p>Add API properties</p></figcaption></figure>
...
2. Configure a dynamic routing policy that builds new URLs dynamically through property matching via the `#api.properties` statement:
   ...
   <figure><img src="../../../.gitbook/assets/example1_properties rule.png" alt="The Policies for Request phase dialog configuring dynamic routing, with a wildcard match expression and a redirect target built from an API property and a request header."><figcaption></figcaption></figure>
...
2. Apply a latency policy to the Default Keyless Plan
   ...
   <figure><img src="../../../.gitbook/assets/example2_latency.png" alt="The Policies for Publish phase dialog configuring a latency policy, with a description and a time duration of 1800 seconds."><figcaption></figcaption></figure>
