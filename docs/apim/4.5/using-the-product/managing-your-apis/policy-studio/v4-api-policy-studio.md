...
6.  Configure the flow using the **Create a new flow** module with the options shown below&#x20;
    ...
    * **Condition:** Use [Gravitee's Expression Language (EL)](docs/apim/4.5/using-the-product/managing-your-apis/gravitee-expression-language.md) to define specific conditions that will trigger flow execution.
