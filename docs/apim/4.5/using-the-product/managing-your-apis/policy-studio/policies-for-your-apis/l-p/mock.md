...
When defining the response body content, you can use [Gravitee Expression Language (EL)](docs/apim/4.5/using-the-product/managing-your-apis/gravitee-expression-language.md) to provide a dynamic mock response.
