...
3. **Quality of service:** Use the drop-down menu to choose between the available options. QoS compatibility is detailed [here](docs/apim/4.5/using-the-product/managing-your-apis/api-configuration/v4-api-configuration/quality-of-service.md).
