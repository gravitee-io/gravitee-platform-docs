...
{% hint style="info" %}
CORS can also be configured at the API level. For more information, see the [v2 API](docs/apim/4.5/using-the-product/managing-your-apis/api-configuration/v2-api-configuration/general-proxy-settings.md#configure-cors) and [v4 API ](docs/apim/4.5/using-the-product/managing-your-apis/api-configuration/v4-api-configuration/entrypoints/cors.md)CORS documentation.
{% endhint %}
{% endtab %}
...
{% hint style="info" %}
To learn more about notifications, refer to the [Notifications](docs/apim/4.5/using-the-product/using-the-gravitee-api-management-components/general-configuration/notifications.md) documentation.
{% endhint %}
{% endtab %}
{% endtabs %}
