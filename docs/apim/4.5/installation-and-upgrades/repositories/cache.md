...
* Cache upstream of a response with the [Cache policy](docs/apim/4.5/using-the-product/managing-your-apis/policy-studio/policies-for-your-apis/a-c/cache.md)
...
The default distribution includes the [Cache resource](docs/apim/4.5/using-the-product/managing-your-apis/resources/cache.md#cache) plugin, which stores content in-memory and is locally managed on each Gateway node of the installation.
...
APIM also supports the Gravitee [Redis Cache resource](docs/apim/4.5/using-the-product/managing-your-apis/resources/cache.md#cache-redis) plugin, based on [Redis](https://redis.io/documentation). This plugin is not in the default distribution, but can be [downloaded](https://download.gravitee.io/#graviteeio-apim/plugins/resources/gravitee-resource-cache-redis/) and deployed with these [instructions](docs/apim/4.5/overview/plugins-and-api-definitions/plugins/deploying-plugins.md#deployment).
