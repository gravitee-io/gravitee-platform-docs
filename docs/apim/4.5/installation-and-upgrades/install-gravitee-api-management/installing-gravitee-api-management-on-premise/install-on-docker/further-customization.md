...
For more information about plugin deployment, see [Deployment](../../../../overview/plugins-and-api-definitions-for-gravitee-api-management/plugins/plugins.md#deployment).
