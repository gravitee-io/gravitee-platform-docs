...
<figure><img src="../../.gitbook/assets/overview-release-notes-apim-45-131.png" alt="The Shared Policy Groups settings, listing the first eight of 41 groups with their API type, phase, and last updated and deployed times."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/overview-release-notes-apim-45-132.png" alt="The Choose Provider step of the Create Integration wizard, offering AWS API Gateway, Solace, Apigee, Azure API Management, IBM API Connect, and Confluent Platform, with Kong, Mulesoft, and Boomi marked coming soon."><figcaption></figcaption></figure>
