...
* [**Datadog reporter**](../../using-the-product/using-the-gravitee-api-management-components/apim-gateway/reporters/#datadog-reporter): Push API metrics to your Datadog instance and dashboards.
* [**TCP reporter**](../../using-the-product/using-the-gravitee-api-management-components/apim-gateway/reporters/#tcp-reporter): Report Gateway events to a TCP listening server.
