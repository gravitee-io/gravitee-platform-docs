...
{% hint style="danger" %}
Message proxies require an enterprise license. If you don't have one, you can [start a free trial](../../free-trial.md) or [schedule a demo](https://www.gravitee.io/demo).
{% endhint %}
