...
For more information, about plugin deployment, see [Deployment](docs/apim/4.2/overview/plugins.md#deployment).
...
For more information on the JDBC plugin and drivers, see [JDBC](docs/apim/4.2/getting-started/configuration/repositories/jdbc.md#jdbc).
