...
<figure><img src="../../.gitbook/assets/ET_start.png" alt="Step 2 of the sign-up flow, asking how to set up the company and trial, with the recommended Quick setup selected and the accounts it creates listed alongside."><figcaption><p>Starting an enterprise trial</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/ET_access apim.png" alt="A Cockpit dashboard showing the remaining trial days, counts for organizations, environments, installations, and nodes, with the trial panels highlighted."><figcaption><p>Cockpit homescreen</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/ET_apim homescreen.png" alt="The Home board of a trial environment, showing widget tiles for three APIs and two applications with the remaining panels reporting no data."><figcaption><p>APIM homescreen</p></figcaption></figure>
