---
description: An overview about 4.2 Upgrade Guide.
---
...
* Starting with APIM 4.0, particular plugins are only available to enterprise customers. [See Gravitee APIM Enterprise Edition](../../overview/gravitee-apim-enterprise-edition/README.md) for additional information.
...
Starting with version 4.2.20, there is a new permission called USER\_TOKEN. This permission controls which users have the ability to read, create, update, and delete user tokens.
