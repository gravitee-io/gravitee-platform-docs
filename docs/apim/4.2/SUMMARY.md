...
* [Install & Upgrade Guides](getting-started/install-guides/README.md)
  ...
  * [Multi-tenancy](getting-started/install-guides/multi-tenancy.md)
...
* [Configuration](getting-started/configuration/README.md)
  ...
  * [APIM Management API](getting-started/configuration/configure-apim-management-api/README.md)
  ...
  * [Repositories](getting-started/configuration/configure-repositories/README.md)
  ...
  * [Reporters](getting-started/configuration/configure-reporters/README.md)
    * [Formats](getting-started/configuration/configure-reporters/formats.md)
  * [Cache](getting-started/configuration/configure-cache.md)
  * [HTTP Reverse Proxy](getting-started/configuration/configure-http-reverse-proxy.md)
  * [Authentication](getting-started/configuration/authentication-and-sso.md)
  * [Notifications](getting-started/configuration/configure-alerts-and-notifications.md)
  * [Production-ready APIM Environment](getting-started/configuration/configure-a-production-ready-apim-environment.md)
...
* [API Configuration](guides/api-configuration/README.md)
  * [v4 API Configuration](guides/api-configuration/v4-api-configuration/README.md)
    * [Entrypoints](guides/api-configuration/v4-api-configuration/entrypoint-configuration/README.md)
      * [v4 Proxy API Entrypoints](guides/api-configuration/v4-api-configuration/entrypoint-configuration/v4-proxy-api-entrypoints.md)
      * [v4 Message API Entrypoints](guides/api-configuration/v4-api-configuration/entrypoint-configuration/v4-message-api-entrypoints/README.md)
        * [HTTP GET](guides/api-configuration/v4-api-configuration/entrypoint-configuration/v4-message-api-entrypoints/http-get.md)
        * [HTTP POST](guides/api-configuration/v4-api-configuration/entrypoint-configuration/v4-message-api-entrypoints/http-post.md)
        * [WebSocket](guides/api-configuration/v4-api-configuration/entrypoint-configuration/v4-message-api-entrypoints/websocket.md)
        * [Webhook](guides/api-configuration/v4-api-configuration/entrypoint-configuration/v4-message-api-entrypoints/webhook.md)
        * [Server-sent Events](guides/api-configuration/v4-api-configuration/entrypoint-configuration/v4-message-api-entrypoints/server-sent-events.md)
    * [Endpoints](guides/api-configuration/v4-api-configuration/endpoint-configuration/README.md)
      * [v4 Proxy API Endpoints](guides/api-configuration/v4-api-configuration/endpoint-configuration/v4-proxy-api-endpoints.md)
      * [v4 Message API Endpoints](guides/api-configuration/v4-api-configuration/endpoint-configuration/v4-message-api-endpoints/README.md)
        * [Kafka](guides/api-configuration/v4-api-configuration/endpoint-configuration/v4-message-api-endpoints/kafka.md)
        * [MQTT5](guides/api-configuration/v4-api-configuration/endpoint-configuration/v4-message-api-endpoints/mqtt5.md)
        * [Solace](guides/api-configuration/v4-api-configuration/endpoint-configuration/v4-message-api-endpoints/solace.md)
        * [RabbitMQ](guides/api-configuration/v4-api-configuration/endpoint-configuration/v4-message-api-endpoints/rabbitmq.md)
    ...
    * [User and Group Access](guides/api-configuration/v4-api-configuration/configure-user-and-group-access.md)
  ...
  * [v2 API Configuration](guides/api-configuration/v2-api-configuration/README.md)
    ...
    * [General Info Settings](guides/api-configuration/v2-api-configuration/api-general-settings-1.md)
...
* [Developer Portal](guides/developer-portal/README.md)
  * [Configuration](guides/developer-portal/advanced-developer-portal-configuration/README.md)
    * [General Settings](guides/developer-portal/advanced-developer-portal-configuration/general-settings.md)
    * [User Management](guides/developer-portal/advanced-developer-portal-configuration/user-management.md)
    * [Layout and Theme Customization](guides/developer-portal/advanced-developer-portal-configuration/layout-and-theme-customization.md)
    * [Documentation](guides/developer-portal/advanced-developer-portal-configuration/documentation.md)
...
* [Gravitee Kubernetes Operator](guides/gravitee-kubernetes-operator/README.md)
  ...
  * [Custom Resource Definitions](guides/gravitee-kubernetes-operator/custom-resource-definitions/README.md)
    ...
    * [ApiDefinition](guides/gravitee-kubernetes-operator/custom-resource-definitions/apidefinition-crd.md)
    * [ApiResource](guides/gravitee-kubernetes-operator/custom-resource-definitions/apiresource-crd.md)
    * [Application](guides/gravitee-kubernetes-operator/custom-resource-definitions/application-crd.md)
    * [Sync CRDs with API Management API](guides/gravitee-kubernetes-operator/custom-resource-definitions/sync-crds-with-apim-management-api.md)
