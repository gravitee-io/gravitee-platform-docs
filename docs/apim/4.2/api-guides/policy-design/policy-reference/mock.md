...
When defining the response body content, you can use [Gravitee Expression Language (EL)](../../../gravitee-api-management/gravitee-expression-language.md) to provide a dynamic mock response.
