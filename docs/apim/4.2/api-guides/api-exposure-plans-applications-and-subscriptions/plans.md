...
{% hint style="warning" %}
This workflow only applies to [v4 APIs and v2 APIs in emulation mode.](../../gravitee-api-management/gravitee-api-definitions-and-execution-engines/#plan-selection)
{% endhint %}
