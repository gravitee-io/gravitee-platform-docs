...
The **Deployment** section allows you to selectively deploy the plan to particular APIs using sharding tags which you can learn more about [here](broken-reference).
...
You can configure basic authentication for keyless plans by associating a basic authentication policy with either an LDAP or inline resource. For more details, see the [Basic Authentication policy](broken-reference).
{% endhint %}
...
{% hint style="warning" %}
This workflow only applies to [v4 APIs and v2 APIs in emulation mode.](../../gravitee-api-management-apim/gravitee-api-definitions-and-execution-engines/#plan-selection)
{% endhint %}
