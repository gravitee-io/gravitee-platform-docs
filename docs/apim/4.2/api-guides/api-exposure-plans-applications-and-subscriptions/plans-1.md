...
{% hint style="info" %}
Only users with the required permissions can manage application members. For more details, see the [User Management and Permissions](broken-reference) section of the Administration Guide.
{% endhint %}
