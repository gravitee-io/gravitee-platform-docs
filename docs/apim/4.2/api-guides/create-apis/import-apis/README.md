...
Once you've imported your API, it will be created as a private API, and you will be brought to that APIs menu and details page. From here, you can further [configure your API](broken-reference), [design policies for that API](broken-reference), [expose that API](broken-reference), etc.
{% endhint %}
