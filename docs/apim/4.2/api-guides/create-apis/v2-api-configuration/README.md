...
This section covers v2 API configuration. If you are looking for documentation that covers configuration for Gravitee v4 APIs, please refer to the [v4 API configuration section.](broken-reference)
{% endhint %}
...
* [API General Settings](broken-reference)
* [Load-balancing, failover, and health checks](broken-reference)
* [Configure service discovery](broken-reference)
* [Configure general proxy settings](broken-reference)
* [Configure user and group access](broken-reference)
...
If using sharding tags, you could tag these Gateways with specific keywords. Once the Gateways are tagged, you can [select that tag in an APIs Deployments proxy settings](broken-reference). Whatever tag you select for that API will end up being the Gateway where that API is deployed.
