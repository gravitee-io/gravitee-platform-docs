...
What you choose will dictate the kinds of entrypoints and endpoints that you can select later on. For more in-depth information what each method supports,  refer to [this documentation](broken-reference).
...
* **Quality of service:** Use the drop-down menu to choose between the available options. QoS compatibility is detailed [here](broken-reference).
...
{% hint style="info" %}
To learn more about how plans function in Gravitee, refer to the [plans documentation](broken-reference).&#x20;
{% endhint %}
...
* **Access control:** select any Groups within APIM that you do not want to have access to this API. For more information on Groups, refer to the [Groups documentation](broken-reference).
...
{% hint style="success" %}
Once you create or deploy your API, you are done with the API creation process! We recommend learning how to further [configure](broken-reference) your API, and how to design and enforce [policies](broken-reference) to make your API more secure, reliable, efficient, etc.
{% endhint %}
