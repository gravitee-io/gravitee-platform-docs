...
<img src="../../../.gitbook/assets/guide-create-apis-the-api-creation--92.png" alt="The General step of plan creation, with an OAuth2 plan named and described, both subscription toggles switched on, a custom subscriber message, and an access control field." data-size="original">
...
<img src="../../../.gitbook/assets/guide-create-apis-the-api-creation--97.png" alt="The OAuth2 authentication configuration step, with a resource named, an empty cache resource, payload extraction and scope checking off, and strict mode and header propagation on." data-size="original">
