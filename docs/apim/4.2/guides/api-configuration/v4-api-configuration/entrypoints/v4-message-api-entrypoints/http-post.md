...
2. **Quality of service:** Use the drop-down menu to choose between the available options. QoS compatibility is detailed [here](docs/apim/4.2/guides/api-configuration/v4-api-configuration/quality-of-service.md).
