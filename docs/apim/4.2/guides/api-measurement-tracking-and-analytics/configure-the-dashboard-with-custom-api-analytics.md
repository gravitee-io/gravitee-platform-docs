...
{% @arcade/embed url="https://app.arcade.software/share/nnYHELNaqBTNKvxqrQIL" flowId="nnYHELNaqBTNKvxqrQIL" %}
...
<img src="../../.gitbook/assets/guide-api-measurement-tracking-and--95.png" alt="The Platform Overview dashboard in the portal, with a sample dashboard selected and a sample widget listing two APIs by hit count." data-size="original">
{% endhint %}
