...
<img src="../.gitbook/assets/file.excalidraw (18).svg" alt="Self-hosted architecture" class="gitbook-drawing">
...
<img src="../.gitbook/assets/file.excalidraw (17).svg" alt="Self-hosted architecture LAN + DMZ" class="gitbook-drawing">
...
<img src="../.gitbook/assets/file.excalidraw (13).svg" alt="Hybrid: SaaS to self-hosted connections" class="gitbook-drawing">
