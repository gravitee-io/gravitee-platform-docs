...
{% hint style="warning" %}
Currently, the RBAC policy can be applied to v2 APIs and v4 proxy APIs. It cannot be applied to v4 message APIs. If you’re unsure of the differences, check out [these docs](../overview/gravitee-api-definitions-and-execution-engines/README.md).
{% endhint %}
