...
2.  Create a new API using the [v4 API creation wizard](docs/apim/4.3/guides/create-apis/the-api-creation-wizard/v4-api-creation-wizard.md)&#x20;
...
10. Using an existing application, click **Create a subscription** using the API Key plan (this example uses a **Default application** , but you can [create your own](docs/apim/4.3/guides/api-exposure-plans-applications-and-subscriptions/applications.md))&#x20;
