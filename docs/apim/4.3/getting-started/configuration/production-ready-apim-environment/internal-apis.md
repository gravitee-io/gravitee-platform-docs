...
* [Configure the APIM Management API internal API](docs/apim/4.3/getting-started/configuration/apim-management-api/internal-api.md)
* [Configure the APIM Gateway internal API](docs/apim/4.3/getting-started/configuration/apim-gateway/internal-api.md)
{% endhint %}
