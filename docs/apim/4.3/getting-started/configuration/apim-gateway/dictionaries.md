...
<figure><img src="../../../.gitbook/assets/getting-started-configuration-apim-gatew-46.png" alt="The Dictionaries page listing a dynamic and a manual dictionary, with the Last deployment at column highlighted."><figcaption></figcaption></figure>
