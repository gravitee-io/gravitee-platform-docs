...
{% hint style="info" %}
If you are new to both web APIs and message brokers, we recommend taking a look at the [Gravitee Essentials guide](https://documentation.gravitee.io/apim/readme/core-concepts) before continuing.
{% endhint %}
...
<figure><img src="../../.gitbook/assets/apim_login.png" alt="The sign-in page for the API Management console, with empty username and password fields, a Sign In button, and a sign-up link."><figcaption><p>APIM Console login screen</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/apim_dashboard.png" alt="The Home board of the console, showing widget tiles for API and application counts and lifecycle and state pie charts, each with a close icon."><figcaption><p>APIM Console Dashboard</p></figcaption></figure>
