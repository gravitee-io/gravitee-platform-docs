...
Alternatively, follow the [quick install guide](../../installing-a-self-hosted-gravitee-api-management-platform/install-on-amazon/quick-install.md) to install all prerequisites and the full APIM stack at the same time.
