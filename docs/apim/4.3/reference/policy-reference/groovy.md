...
The number of scripts used for the `groovy` policy and their execution depend on which [execution engine](../../overview/gravitee-api-definitions-and-execution-engines/README.md) is running.
