...
<figure><img src="../../../.gitbook/assets/plan_api key.png" alt="The API Key authentication configuration step of plan editing, with API key propagation switched off and an empty additional selection rule."><figcaption><p>API Key configuration</p></figcaption></figure>
