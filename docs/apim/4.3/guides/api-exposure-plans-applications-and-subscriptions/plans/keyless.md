...
You can configure basic authentication for Keyless plans by associating a [Basic Authentication policy](docs/apim/4.3/reference/policy-reference/basic-authentication.md) that uses either an LDAP or inline resource.
