...
The **Deployment** section allows you to selectively deploy the plan to particular APIs using sharding tags which you can learn more about [here](docs/apim/4.3/getting-started/configuration/apim-gateway/sharding-tags.md).
...
You can configure basic authentication for keyless plans by associating a basic authentication policy with either an LDAP or inline resource. For more details, see the [Basic Authentication policy](docs/apim/4.3/reference/policy-reference/basic-authentication.md).
{% endhint %}
