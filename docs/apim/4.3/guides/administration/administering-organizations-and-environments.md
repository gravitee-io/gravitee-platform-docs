---
description: Configuration guide for Administering organizations and environments.
---
...
As a part of Organization administration, Gravitee offers multiple ways to manage and control access to the Gravitee platform via identity provider configuration and login/registration settings. See the [Authentication](../../getting-started/configuration/authentication/README.md) documentation for details.
