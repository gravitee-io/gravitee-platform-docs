...
* **Quality of service:** Use the drop-down menu to choose between the available options. QoS compatibility is detailed [here](docs/apim/4.3/guides/api-configuration/v4-api-configuration/quality-of-service.md).
...
* **Access control:** select any Groups within APIM that you do not want to have access to this API. For more information on Groups, refer to the [Groups documentation](docs/apim/4.3/guides/administration/user-management-and-permissions.md#users-and-user-groups).
...
The Documentation step is supported for v4 APIs. See [this page](docs/apim/4.3/guides/api-configuration/v4-api-configuration/documentation.md) to learn how to create documentation for a v4 API.
