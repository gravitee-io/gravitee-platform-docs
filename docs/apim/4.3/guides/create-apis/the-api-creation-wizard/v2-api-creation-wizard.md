...
{% hint style="info" %}
Refer to [Tenants](docs/apim/4.3/getting-started/configuration/apim-gateway/tenants.md) and/or [Sharding tags](docs/apim/4.3/getting-started/configuration/apim-gateway/sharding-tags.md) for more information.
{% endhint %}
