...
<figure><img src="../../../.gitbook/assets/dev_portal_settings.png" alt="The portal settings menu highlighted in the console, beside an Analytics page listing nine platform dashboards with reorder and delete actions."><figcaption><p>Developer portal settings</p></figcaption></figure>
