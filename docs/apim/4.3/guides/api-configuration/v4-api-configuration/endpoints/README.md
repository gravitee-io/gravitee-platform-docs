...
<figure><img src="../../../../.gitbook/assets/default endpoint group (1) (1).png" alt="The Backend services page of a message API, showing a Kafka group with two endpoints and an MQTT 5.x group with one, each with edit and delete actions."><figcaption><p>Default endpoint group</p></figcaption></figure>
