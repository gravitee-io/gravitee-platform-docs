...
* **Add:** To add a new endpoint, click **Add endpoint**. Configure the endpoint per the instructions in the [API creation documentation](docs/apim/4.3/guides/create-apis/the-api-creation-wizard/v4-api-creation-wizard.md).
