...
To configure user and group access for an API, go to **APIs** in the left nav and select your API. Then, go to **Configuration** in the inner left nav and select the **User Permissions** tab.
