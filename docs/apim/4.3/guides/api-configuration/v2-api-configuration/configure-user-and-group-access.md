...
{% hint style="info" %}
See [User Management and Permissions](docs/apim/4.3/guides/administration/user-management-and-permissions.md) to learn more about user and group creation and administration.
{% endhint %}
...
Click **+ Add members** to add members to your API or alter member roles, which grant specific permissions. For more information on roles, please refer to the [roles documentation.](docs/apim/4.3/guides/administration/user-management-and-permissions.md#roles)
