...
4. Deploy the API. Gateways automatically select the first endpoint matching their configured tenant. If a Gateway has no tenant configured, it matches the first endpoint in the group regardless of tenant assignments.
