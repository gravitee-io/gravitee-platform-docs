---
description: API Management 4.10 natively supports several authentication types for the Console. Compare the options before you configure one.
metaLinks:
  alternates:
    - ./
---
