---
description: OpenID Connect is an authentication protocol built on OAuth 2.0, supported by API Management 4.10. Follow the steps to configure it.
metaLinks:
  alternates:
    - openid-connect.md
---
...
<figure><img src="../../../.gitbook/assets/configure-and-manage-the-platform-manage-319-1-1 (1).png" alt="An identity provider configuration form, with a placeholder client ID, a masked client secret, placeholder token, introspection, authorize, userinfo, and logout endpoints, and openid and email scopes."><figcaption></figcaption></figure>
