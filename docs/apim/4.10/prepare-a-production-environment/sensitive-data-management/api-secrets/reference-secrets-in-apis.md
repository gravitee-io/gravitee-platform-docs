---
description: Reference secret manager values from within an API Management 4.10 API to hide sensitive data. Follow the steps to use them.
metaLinks:
  alternates:
...
<figure><img src="../../../.gitbook/assets/prod-env-secrets-reference-secrets--142 (1).png" alt="The Configure Cache Redis resource dialog, with the password read from a secrets expression, SSL enabled, and the host read from a dictionary lookup."><figcaption></figcaption></figure>
