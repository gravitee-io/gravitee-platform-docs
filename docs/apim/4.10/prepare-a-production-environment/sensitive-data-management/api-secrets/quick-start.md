...
9.  Click **Validate my entrypoints**.
    ...
    <figure><img src="../../../.gitbook/assets/prepare-a-production-environment-sensiti-16-1 (1).png" alt=""><figcaption></figcaption></figure>
10. In the **Configure your API endpoints access**, complete the following sub-steps:
    1.  In the **Target url** field, set the target URL to `https://api.gravitee.io/echo` .
        ...
        <figure><img src="../../../.gitbook/assets/prepare-a-production-environment-sensiti-17-1 (1).png" alt=""><figcaption></figcaption></figure>
...
13. Click **Save & Deploy API**.
    ...
    <figure><img src="../../../.gitbook/assets/prepare-a-production-environment-sensiti-14-1-1-1 (1).png" alt=""><figcaption></figcaption></figure>
