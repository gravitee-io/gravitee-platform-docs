---
description: Apply JSON Web Token security to your API Management 4.10 APIs. Follow the steps to configure the gateway APIs and the plan.
metaLinks:
  alternates:
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-co-192 (1).png" alt="The Info page of an API, showing its name, version, owner, creation and last connection times, and a Danger Zone below."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-co-189 (1).png" alt="The Plans tab of an API with the Add new plan menu open, offering OAuth2, JWT, API Key, and Keyless plan types."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-4-2-1 (1).png" alt="The General step of plan creation, with a plan name entered and the auto-validate subscription toggle switched on."><figcaption></figcaption></figure>

On the security page, select the **Signature** that your IdP uses to encrypt your access tokens.

<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-5-1-1-1-1 (1).png" alt="The JWT authentication configuration step of plan creation, with the signature set to RSA_RS256 above the JWKS resolver options."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-6-1-1-1 (1).png" alt="The JWT authentication configuration step, with the resolver set to JWKS_URL and a resolver parameter built from an expression-language variable."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-7-2-1 (1).png" alt="The Restriction step of plan creation, with rate limiting, quota, and resource filtering all switched off and a Create button."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-8-2-1 (1).png" alt="A diagram of the plan lifecycle, with staging leading to published, and published leading either straight to closed or through deprecated."><figcaption></figcaption></figure>

Publish your plan by selecting the publish icon on your plan as shown below.

<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-9-3-1 (1).png" alt="The Plans tab with the STAGING filter selected, showing a JWT plan and the Publish the plan tooltip over the upload icon."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-18-1-1-1 (1).png" alt="The Close plan confirmation dialog, warning that the operation is irreversible and requiring the plan name to be typed to confirm."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-19-1-1-1 (1).png" alt="The Deploy your API dialog open over the Plans tab, asking for a label to identify the deployment."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-20-1-1-1 (1).png" alt="The Info page of an API scrolled to the Danger Zone, offering to stop, publish, make private, deprecate, or delete the API."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-21-1-1-1 (1).png" alt="The developer portal dashboard, listing the signed-in user&#x27;s applications as cards above a table of their subscriptions."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-co-190 (1).png" alt="The My applications tab of the developer portal, showing two application cards with their descriptions and subscriber counts."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-co-191 (1).png" alt="An application&#x27;s settings page in an external identity provider, showing its name, single page application type, and a masked client ID."><figcaption></figcaption></figure>

After providing the `client_id`, select **Next**.

<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-co-188 (1).png" alt="The Security step of the developer portal application wizard, with the Simple type selected, an empty Type field, and a placeholder client ID."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-63-1 (1).png" alt="The Subscription step of the developer portal application wizard, with an API searched, a JWT plan selected, and the subscription request listed with a comment."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-64-1 (1).png" alt="The Validation step of the developer portal application wizard, summarising the application name, description, type, and client ID beside the subscription request."><figcaption></figcaption></figure>
