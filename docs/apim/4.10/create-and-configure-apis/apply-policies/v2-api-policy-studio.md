---
description: The v2 Policy Studio designs flows for APIs using the v2 API Management 4.10 definition. Follow the steps to design and configure flow mode.
metaLinks:
  alternates:
