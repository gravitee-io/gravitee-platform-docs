...
The AI Model Text Embedding resource transforms text prompts into high-dimensional vector embeddings for semantic similarity matching. It is used by the AI Semantic Caching policy to enable cache lookups based on prompt meaning rather than exact string matches. The resource supports three provider types: ONNX BERT (local pre-trained models), OpenAI (cloud-based models), and Custom HTTP (user-hosted embedding services).

<table><thead><tr><th width="167">Config param</th><th width="384.3046875">Description</th><th>Default</th></tr></thead><tbody><tr><td>Provider Type</td><td>The embedding provider: <code>ONNX_BERT</code>, <code>OPENAI</code>, or <code>HTTP</code></td><td>-</td></tr><tr><td>Model (ONNX BERT)</td><td>Pre-trained model: <code>XENOVA_ALL_MINILM_L6_V2</code>, <code>XENOVA_BGE_SMALL_EN_V1_5</code>, or <code>XENOVA_MULTILINGUAL_E5_SMALL</code></td><td>-</td></tr><tr><td>Pooling Mode (ONNX BERT)</td><td>Pooling strategy: <code>MEAN</code>, <code>CLS</code>, or <code>MAX</code></td><td>MEAN</td></tr><tr><td>Padding (ONNX BERT)</td><td>Whether to pad input sequences</td><td>false</td></tr><tr><td>URI (OpenAI)</td><td>OpenAI API endpoint URL</td><td>https://api.openai.com/v1/embeddings</td></tr><tr><td>API Key (OpenAI)</td><td>OpenAI API key</td><td>-</td></tr><tr><td>Model Name (OpenAI)</td><td>Model name (e.g., <code>text-embedding-3-small</code>)</td><td>-</td></tr><tr><td>Dimensions (OpenAI)</td><td>Output embedding dimensions (optional)</td><td>-</td></tr><tr><td>URI (HTTP)</td><td>HTTP endpoint URL</td><td>-</td></tr><tr><td>Method (HTTP)</td><td>HTTP method</td><td>POST</td></tr><tr><td>Request Body Template (HTTP)</td><td>Template for request body</td><td>-</td></tr><tr><td>Input Location (HTTP)</td><td>JSONPath to input field in request</td><td>-</td></tr><tr><td>Output Embedding Location (HTTP)</td><td>JSONPath to embedding field in response</td><td>-</td></tr></tbody></table>

#### AI Vector Store

The AI Vector Store resource persists vector embeddings and their associated cached responses for semantic similarity matching. It is used by the AI Semantic Caching policy to store and retrieve cached LLM responses based on prompt embeddings. The resource supports two backend types: Redis (for low-latency in-memory caching) and AWS S3 (for persistent storage).

<table><thead><tr><th width="167">Config param</th><th width="384.3046875">Description</th><th>Default</th></tr></thead><tbody><tr><td>Backend Type</td><td>The vector store backend: <code>REDIS</code> or <code>AWS_S3</code></td><td>-</td></tr><tr><td>URL (Redis)</td><td>Redis connection URL</td><td>-</td></tr><tr><td>Index (Redis)</td><td>Redis index name</td><td>-</td></tr><tr><td>Embedding Size (Redis)</td><td>Dimension of embedding vectors</td><td>-</td></tr><tr><td>Similarity (Redis)</td><td>Similarity metric: <code>COSINE</code>, <code>EUCLIDEAN</code>, or <code>DOT_PRODUCT</code></td><td>COSINE</td></tr><tr><td>Threshold (Redis)</td><td>Minimum similarity score threshold</td><td>0.85</td></tr><tr><td>Vector Bucket Name (AWS S3)</td><td>S3 bucket name for vector storage</td><td>-</td></tr><tr><td>Vector Index Name (AWS S3)</td><td>Vector index name</td><td>-</td></tr><tr><td>Region (AWS S3)</td><td>AWS region</td><td>-</td></tr><tr><td>Encryption Type (AWS S3)</td><td>Encryption type: <code>SSE_S3</code>, <code>SSE_KMS</code>, or <code>NONE</code></td><td>-</td></tr></tbody></table>
