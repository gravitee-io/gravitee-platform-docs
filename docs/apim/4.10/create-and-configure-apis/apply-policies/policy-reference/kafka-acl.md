---
description: The Kafka ACL policy defines access control lists on cluster resources proxied by API Management 4.10. Learn how to configure them.
metaLinks:
  alternates:
    - kafka-acl.md
---
...
<figure><img src="../../../.gitbook/assets/config-apis-apply-policies-policy-r-154 (1).png" alt=""><figcaption><p>Kafka ACL Policy UI</p></figcaption></figure>
