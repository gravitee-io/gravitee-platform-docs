...
<figure><img src="../../../.gitbook/assets/config-apis-apply-policies-policy-r-179 (1).png" alt=""><figcaption><p>Screenshot of the Resource Filtering policy - if the authenticated user doesn't have the required scope, then blacklist all endpoint paths</p></figcaption></figure>
