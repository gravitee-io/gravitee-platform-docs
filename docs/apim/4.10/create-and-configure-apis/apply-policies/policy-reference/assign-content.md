---
description: The Assign Content policy changes or transforms request and response bodies in API Management 4.10. Learn how to configure the transformation.
metaLinks:
  alternates:
    - assign-content.md
---
...
<figure><img src="../../../.gitbook/assets/config-apis-apply-policies-policy-r-177 (1).png" alt="The Assign content policy dialog, with a body content field beside documentation describing the policy and the phases it applies to." width="375"><figcaption><p>Assign Content policy configuration UI</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/config-apis-apply-policies-policy-r-177 (1).png" alt="The Assign content policy dialog, with a body content field beside documentation describing the policy and the phases it applies to."><figcaption><p>Assign Content policy configuration UI</p></figcaption></figure>
