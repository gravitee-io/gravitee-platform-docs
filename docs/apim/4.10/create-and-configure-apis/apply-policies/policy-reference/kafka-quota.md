---
description: The Kafka Quota policy enforces limits on the data Kafka clients exchange through API Management 4.10. Learn how to configure quotas.
metaLinks:
  alternates:
    - kafka-quota.md
---
...
<figure><img src="../../../.gitbook/assets/config-apis-apply-policies-policy-r-155 (1).png" alt="The Kafka quota policy configuration, with an empty key, use key only switched off, and a static limit of five bytes, beside the policy documentation."><figcaption><p>Kafka Quota Policy UI</p></figcaption></figure>
