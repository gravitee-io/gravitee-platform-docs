...
When defining the response body content, you can use [Gravitee Expression Language (EL)](../../../../4.9/gravitee-expression-language.md) to provide a dynamic mock response.
