---
description: The execution engine is the Gateway runtime that executes API Management 4.10 APIs and policy flows. Learn its improvements and policy support.
metaLinks:
  alternates:
    - execution-engine.md
---
