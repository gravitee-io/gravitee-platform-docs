...
* Use the AI Semantic Caching policy to reduce latency and costs by caching semantically similar LLM requests. For more information, see the [AI Semantic Caching policy reference](../../reference/policy-reference/ai-semantic-caching.md "mention").