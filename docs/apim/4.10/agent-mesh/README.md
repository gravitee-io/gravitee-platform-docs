...
* Semantic caching using Gravitee's AI Semantic Caching policy to reduce LLM token consumption and latency by reusing responses for similar requests. For more information about the AI Semantic Caching policy, see [ai-semantic-caching.md](../create-and-configure-apis/apply-policies/policy-reference/ai-semantic-caching.md "mention").
