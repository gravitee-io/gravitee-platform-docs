...
<!-- GAP: The source document references a "Required SSL Files" section but provides no content. Clarification needed on specific file formats, naming conventions, generation procedures for SSL certificates and keystores, or other file-related requirements. -->
## Configure Gateway for mTLS
