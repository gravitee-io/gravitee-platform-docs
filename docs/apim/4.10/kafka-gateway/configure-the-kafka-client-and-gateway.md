---
description: Configure the Kafka Gateway and a Kafka client so API Management 4.10 can proxy your Kafka cluster. Follow the steps for both sides.
metaLinks:
  alternates:
...
<figure><img src="../.gitbook/assets/kafka-gw-configure-the-kafka-client-151 (1).png" alt="" width="563"><figcaption><p>The proxy obtains the list of brokers from the upstream cluster.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/kafka-gateway-configure-the-kafka-client-153-1-1 (1).png" alt="" width="563"><figcaption><p>The gateway returns the list of brokers back to the client, rewritten to use the gateway hostname.</p></figcaption></figure>
