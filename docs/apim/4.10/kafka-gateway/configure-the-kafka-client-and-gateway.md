...
<figure><img src="../.gitbook/assets/kafka-gateway-configure-the-kafka-client-153-1-1.png" alt="" width="563"><figcaption><p>The gateway returns the list of brokers back to the client, rewritten to use the gateway hostname.</p></figcaption></figure>
