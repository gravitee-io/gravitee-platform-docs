...
Configure these elements in the Kafka client properties:
...
{% endhint %}
## Configuring mTLS for Native Kafka APIs
...
The Kafka client must be configured to use SSL with a client keystore in the `.properties` file:
