...
- **Certificate-based client identification**: Clients are identified using their certificates.
...
- **Strong authentication of Kafka clients**: Certificate-based verification ensures only authorized clients can connect.
- **Proper subscription resolution**: Metrics and analytics correctly attribute traffic to the resolved subscription, application, and plan. This eliminates ANONYMOUS metrics that occur with the Keyless workaround.
