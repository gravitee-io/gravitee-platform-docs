---
description: A hybrid Gateway architecture mixes self-hosted and cloud API Management 4.10 components. Browse the guides for your deployment stack.
metaLinks:
  alternates:
    - ./
---
...
<figure><img src="../.gitbook/assets/hybrid-installation-and-configuration-gu-23-1 (1).png" alt="A hybrid architecture diagram, with a customer-hosted data plane of load-balanced gateways, backend services, and Redis on the left, connected over HTTPS through Cloud Gate to a Gravitee-managed control plane of databases, the management API, consoles, and access management."><figcaption></figcaption></figure>
