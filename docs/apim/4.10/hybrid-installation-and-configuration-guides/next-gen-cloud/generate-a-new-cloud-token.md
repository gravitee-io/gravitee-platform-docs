---
description: Revoking a cloud token breaks the link between Gravitee Cloud and your hybrid API Management 4.10 Gateway. Follow the steps to replace it.
metaLinks:
  alternates:
...
1.  Sign in to [Gravitee Cloud](https://cloud.gravitee.io/).
    ...
    <figure><img src="../../.gitbook/assets/hybrid-installation-and-configuration-gu-4-1-1-1-1 (1).png" alt=""><figcaption></figcaption></figure>
