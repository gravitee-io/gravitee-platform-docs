---
description: A Next-Gen Cloud hybrid API Management 4.10 deployment needs the Gateway and Redis as a minimum. Browse the installation guides.
metaLinks:
  alternates:
    - ./
---
...
<figure><img src="../../.gitbook/assets/hybrid-installation-and-configuration-gu-29-1-1 (1).png" alt=""><figcaption><p>Overview of a Gravitee Cloud deployment in Azure with a hybrid gateway connecting to the Gravitee Cloud API Management Control Plane using the Cloud Gate and Cloud Tokens.</p></figcaption></figure>
