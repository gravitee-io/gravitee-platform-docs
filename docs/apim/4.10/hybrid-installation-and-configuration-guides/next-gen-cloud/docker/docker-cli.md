---
description: Install the API Management 4.10 Data Plane with Docker CLI commands for a Next-Gen Cloud hybrid. Follow the steps to run it.
metaLinks:
  alternates:
    - docker-cli.md
---
...
3.  Run the Gateway with Redis rate limiting enabled with the following command:
    ...
    *   Replace `<CONTROL_PLANE_VERSION>` with the version that matches your Gravitee Cloud Control Plane. For example. 4.8.2.
        ...
        <figure><img src="../../../.gitbook/assets/hybrid-cloud-docker-docker-cli-62 (1).png" alt="The Environments section of the Overview, with the product and version tag highlighted on each of the three environment cards."><figcaption></figcaption></figure>
