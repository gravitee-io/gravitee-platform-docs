...
* [AI Semantic Caching](https://download.gravitee.io/#graviteeio-ee/apim/plugins/policies/gravitee-policy-ai-semantic-caching/): Enables semantic caching for LLM Proxy APIs using vector embeddings to match similar requests and reuse cached responses. Available in APIM 4.11+.
