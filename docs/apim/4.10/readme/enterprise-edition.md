...
> For mTLS for Native Kafka APIs details, see [Configure The Kafka Client And Gateway](../kafka-gateway/configure-the-kafka-client-and-gateway.md).
...
Enable mutual TLS authentication for native Kafka APIs to strengthen security by verifying Kafka client identities using certificates. For configuration details, see [Configure the Kafka Client and Gateway](../kafka-gateway/configure-the-kafka-client-and-gateway.md).
