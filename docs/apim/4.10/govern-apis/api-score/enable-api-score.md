...
1.  From the home page, click **Settings**.
    ...
    <figure><img src="../../.gitbook/assets/govern-apis-api-score-enable-api-score-218-1-1 (1).png" alt=""><figcaption></figcaption></figure>
2.  In the **Portal** section, click **API Quality**.

    <figure><img src="../../.gitbook/assets/govern-api-score-enable-api-score-220 (1).png" alt=""><figcaption></figcaption></figure>
3.  In the **API Score** section, turn on **Enable API Score**.

    <figure><img src="../../.gitbook/assets/govern-api-score-enable-api-score-221 (1).png" alt=""><figcaption></figcaption></figure>
