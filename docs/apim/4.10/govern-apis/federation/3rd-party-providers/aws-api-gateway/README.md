---
description: Federate APIs from AWS API Gateway, the built-in AWS solution, into API Management 4.10. Learn how the integration works for you.
metaLinks:
  alternates:
    - ./
---
...
5.  (Optional) Type a **Description** for the integration.
    ...
    <figure><img src="../../../../.gitbook/assets/govern-apis-federation-3rd-party-provide-47-1 (1).png" alt="The Enter Information step of the Create Integration wizard, with a name and description filled in for an AWS API Gateway federation."><figcaption></figcaption></figure>
...
1.  In the Gravitee API Management console, after refreshing, you should now see the agent's status set to `Connected`.<br>
    ...
    <figure><img src="../../../../.gitbook/assets/govern-federation-aws-api-gateway-r-48 (1).png" alt="The Overview page of a connected federation integration, showing the provider, a connected agent, and a partly masked integration identifier."><figcaption></figcaption></figure>
