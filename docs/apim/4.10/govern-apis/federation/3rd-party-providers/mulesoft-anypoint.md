---
description: Federate APIs from the Mulesoft Anypoint Platform into API Management 4.10. Learn how the integration discovers and ingests them.
metaLinks:
  alternates:
...
4.  Type the **Integration Name.**
    ...
    <figure><img src="../../../.gitbook/assets/govern-apis-federation-3rd-party-provide-39-1-1 (1).png" alt="The Enter Information step of the Create Integration wizard for a Mulesoft integration, with the Create Integration button highlighted."><figcaption></figcaption></figure>
