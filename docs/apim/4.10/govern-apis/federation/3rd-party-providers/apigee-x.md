---
description: Federate APIs from Apigee X, Google Cloud's API management solution, into API Management 4.10. Learn how the integration works.
metaLinks:
  alternates:
    - apigee-x.md
---
...
4.  Enter the **Integration** **Name.**
    ...
    <figure><img src="../../../.gitbook/assets/govern-federation-apigee-x-53 (1).png" alt="The Enter Information step of the Create Integration wizard, with an Apigee federation name and description filled in."><figcaption></figcaption></figure>
...
2.  Return to the Gravitee API Management console, refresh the page, and verify that the agent's status is set to Connected:<br>
    ...
    <figure><img src="../../../.gitbook/assets/govern-federation-apigee-x-54 (1).png" alt="The Overview page of a connected Apigee integration, showing the provider, the connected agent, and a partly masked integration identifier."><figcaption></figcaption></figure>
