...
To use an mTLS plan, you need to [enable HTTPS on your Gateway(s)](../../../4.9/prepare-a-production-environment/configure-your-http-server.md#enable-https-support).
