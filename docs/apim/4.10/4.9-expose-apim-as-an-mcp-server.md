...
6.  In the **Users** screen, click the service account that you created.
    ...
    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-338-1-1 (1).png" alt=""><figcaption></figcaption></figure>
...
8.  In the **You have unsaved changes** pop-up window, click **Save**.
    ...
    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-340-1-1 (1).png" alt=""><figcaption></figcaption></figure>
9.  Navigate to the **Tokens** section, and then click **+ Generate a personal token**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-323-1-1 (1).png" alt=""><figcaption></figcaption></figure>
10. In the **Generate a token** pop-up window, enter a name for your token. For example, mcp-server-token.
11. Click **Generate**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-324-1-1 (1).png" alt=""><figcaption></figcaption></figure>
