---
description: Install the API Management 4.10 MCP Server so AI clients can call your platform. Follow the steps to install it and create a service account token.
metaLinks:
  alternates:
...
2.  From the **Dashboard**, click **Organization**.
    ...
    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-333-1-1 (1).png" alt="The console dashboard with Organization highlighted at the foot of the left navigation, showing empty summary and top API panels."><figcaption></figcaption></figure>
3.  From the **Organization** menu, click **Users**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-334-1-1 (1).png" alt="The organization Users page with Users highlighted in the left navigation, listing a single administrator."><figcaption></figcaption></figure>
4.  Click **Add user**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-335-1-1 (1).png" alt="The organization Users page with the Add user button highlighted above the user table."><figcaption></figcaption></figure>
5.  In the **Pre-register a user** screen, create the service account. To create a service account, complete the following sub-steps:
    ...
    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-336-1-1 (1).png" alt="The Pre-register a user page with Service Account selected and a service account name entered."><figcaption></figcaption></figure>
6.  In the **Users** screen, click the service account that you created.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-338-1-1 (1).png" alt="The organization Users page, listing an administrator and a service account, with the service account row highlighted."><figcaption></figcaption></figure>
7.  In the **User details** screen, assign the service account permissions. The AI assistant's capabilities are determined by the permissions you set for the service account.
    ...
    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-12-1-1 (1).png" alt="A Gravitee Cloud overview showing development, production, and test environment cards, with the product and version badge on each one highlighted."><figcaption></figcaption></figure>
8.  In the **You have unsaved changes** pop-up window, click **Save**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-340-1-1 (1).png" alt="The detail page of a service account, showing its source, organization role, and creation date, with the environment roles set and an unsaved changes bar offering Save."><figcaption></figcaption></figure>
9.  Navigate to the **Tokens** section, and then click **+ Generate a personal token**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-323-1-1 (1).png" alt="The detail page of a service account scrolled to the Tokens panel, with the Generate a personal token button highlighted above empty API, application, and token lists."><figcaption></figcaption></figure>
10. In the **Generate a token** pop-up window, enter a name for your token. For example, mcp-server-token.
11. Click **Generate**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-324-1-1 (1).png" alt="The Generate a token dialog, with a token name entered, over the empty token list."><figcaption></figcaption></figure>
