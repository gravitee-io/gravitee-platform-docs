...
2.  From the **Dashboard**, click **Organization**.
    ...
    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-333-1-1 (1).png" alt=""><figcaption></figcaption></figure>
3.  From the **Organization** menu, click **Users**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-334-1-1 (1).png" alt=""><figcaption></figcaption></figure>
4.  Click **Add user**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-335-1-1 (1).png" alt=""><figcaption></figcaption></figure>
5.  In the **Pre-register a user** screen, create the service account. To create a service account, complete the following sub-steps:
    ...
    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-336-1-1 (1).png" alt=""><figcaption></figcaption></figure>
