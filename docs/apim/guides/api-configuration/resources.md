...
| Property          | Required | Description                                                                                                                                                                                                                                                                           | Type    | Default        |
| ----------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | -------------- |
| name              | X        | Name of the cache                                                                                                                                                                                                                                                                     | string  | my-redis-cache |
| releaseCache      | X        | <p>Enabled: The resource will release the cache when the API is stopped </p><p>Disabled: The cache must be managed manually on the Redis server</p>                                                                                                                                   | boolean | false          |
| maxTotal          | X        | Maximum number of connections supported by the pool                                                                                                                                                                                                                                   | integer | 8              |
| password          |          | The password of the instance                                                                                                                                                                                                                                                          | string  |                |
| timeToLiveSeconds | X        | Maximum number of seconds an element can exist in the cache, regardless of usage. When this threshold is reached, the element expires and will no longer be returned from the cache. The default value is 0, i.e., means no timeToLive (TTL) eviction takes place (infinite lifetime) | integer | 0              |
| timeout           | X        | Specifies the connection timeout and the read/write timeout                                                                                                                                                                                                                           | integer | 2000           |
