...
**Default** flow selection is based on the operators defined in your flows, either when it **Equals** or **Starts with** a **Channel**. You can choose the **Best Match** option to select a flow from the **Channel** that's the closest match.
