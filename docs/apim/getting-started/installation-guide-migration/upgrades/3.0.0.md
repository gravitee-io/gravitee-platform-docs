...
* Memberhips, roles and groups have to be updated with migration scripts [here](3.0.0.md#mongodb)
* Role Mappings for Identity Providers stored in database will be updated with a specific upgrader. See [Upgrader](3.0.0.md#upgrader)
