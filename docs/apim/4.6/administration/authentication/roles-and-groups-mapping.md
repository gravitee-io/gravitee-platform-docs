...
<figure><img src="../../.gitbook/assets/admin-auth-roles-and-groups-mapping-4.png" alt="Empty Groups Mapping and Roles Mapping panels, each with a link to add a mapping."><figcaption><p>Identity Provider Groups and Roles Mapping configuration</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/admin-auth-roles-and-groups-mapping-152.png" alt="A Roles Mapping entry, with a JSON path condition on the profile roles, the organization role set to ADMIN, and the environment role dropdown open."><figcaption><p>Role Mapping configuration</p></figcaption></figure>
