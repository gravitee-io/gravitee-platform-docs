...
You can configure basic authentication for Keyless plans by associating a Basic Authentication policy (see the [policy reference](../../policies/policy-reference.md)) that uses either an LDAP or inline resource.
