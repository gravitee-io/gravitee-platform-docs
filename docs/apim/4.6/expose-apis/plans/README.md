...
6.  Configure the general plan settings:
    ...
    * **Sharding tags:** Selectively deploy the plan to particular APIs using available [sharding tags](docs/apim/4.6/gravitee-gateway/sharding-tags.md)
    * **Groups excluded:** Prevent specified [user groups](docs/apim/4.6/administration/user-management.md) from accessing your plan
7. Click **Next**
...
{% hint style="warning" %}
This workflow only applies to [v4 APIs and v2 APIs in emulation mode](docs/apim/4.6/overview/execution-engine.md#v2-gateway-api-emulation-mode).
{% endhint %}
