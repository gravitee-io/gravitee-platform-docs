...
<figure><img src="../../.gitbook/assets/overview-release-notes-apim-46-141.png" alt="The Rulesets and Functions page, listing a region code suffix ruleset and a proxy API ruleset with their asset formats, above two custom function files."><figcaption></figcaption></figure>
