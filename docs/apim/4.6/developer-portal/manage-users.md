...
<figure><img src="../.gitbook/assets/devportal-manage-users-93.png" alt="The organization Users page, listing two primary owners with their status, source, and a masked email address."><figcaption><p>Management Console user overview</p></figcaption></figure>
