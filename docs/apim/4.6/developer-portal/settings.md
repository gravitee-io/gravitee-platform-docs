...
3.  Select **Settings** from the inner left sidebar
    ...
    <figure><img src="../.gitbook/assets/dev portal_settings.png" alt="The portal Settings page, showing the company name and the security plan types available in the console, with keyless and API key plans enabled."><figcaption></figcaption></figure>
4.  Scroll down to the **Portal** header

    <figure><img src="../.gitbook/assets/dev portal_portal.png" alt="The portal General settings, showing the API key header, portal URL, an overridden homepage title, and options for tiles mode, support, and rating."><figcaption></figcaption></figure>
5. Configure the settings described below:

{% hint style="info" %}
The general settings of the Developer Portal can be overridden with the `gravitee.yaml` file. For more information about the `gravitee.yaml` file, see the [APIM Configuration documentation.](../configure-apim/apim-components/README.md)
{% endhint %}
...
*   **Portal URL:** Enter the URL of the Developer Portal. This will add a link to the Developer Portal on the top navigation bar of the Management Console. Additionally, the [theme editor](settings.md#theme-customization) will show a live preview of the Developer Portal.
    ...
    <figure><img src="../.gitbook/assets/dev_portal_link.png" alt="The portal General settings with the Developers Portal link in the top bar highlighted, above the API key header, portal URL, and options."><figcaption><p>Link to Developer Portal from Management Console</p></figcaption></figure>
