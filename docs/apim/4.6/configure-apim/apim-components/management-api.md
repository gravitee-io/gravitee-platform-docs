...
This guide will walk through how to configure your general Gravitee APIM Management API settings using the `gravitee.yaml` file. As detailed in [APIM Components](README.md#configuring-apim-components), you can override these settings by using system properties or environment variables.
...
<figure><img src="../../.gitbook/assets/Screenshot 2023-06-30 at 2.35.47 PM.png" alt="The organization CORS settings, with a wildcard allow-origin, six allowed methods, and a list of allowed headers."><figcaption><p>Organization CORS settings</p></figcaption></figure>

Or at the environment level in the **Settings > Settings** section of the APIM Console:

<figure><img src="../../.gitbook/assets/Screenshot 2023-07-20 at 3.20.53 PM.png" alt="The environment CORS settings, with two allowed origins, six allowed methods, allowed and exposed header lists, and a max age in seconds."><figcaption><p>Environment CORS settings</p></figcaption></figure>
