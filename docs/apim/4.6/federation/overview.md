...
* [enable Federation when installing with Helm on Kubernetes](docs/apim/4.6/install-and-upgrade/kubernetes.md#federation)
* [enable Federation when installing with Docker Compose](docs/apim/4.6/install-and-upgrade/docker/docker-compose.md#enable-federation)
* [enable Federation when installing with .zip](docs/apim/4.6/install-and-upgrade/.zip.md#federation)
{% endhint %}
