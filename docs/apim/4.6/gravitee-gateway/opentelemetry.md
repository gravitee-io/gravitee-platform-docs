...
<figure><img src="../.gitbook/assets/1 otel 1.png" alt="The OpenTelemetry settings of an API, with tracing switched off and the verbose option disabled beneath it."><figcaption></figcaption></figure>
