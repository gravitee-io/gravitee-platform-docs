...
{% hint style="info" %}
You can obscure the value of this API key by using [configuration-level secrets](docs/apim/4.6/configure-apim/sensitive-data-management/configuration-level-secrets.md) in `gravitee.yml`.
{% endhint %}
...
| Tenant         | ID of the tenant evaluated for the API (see [tenants](docs/apim/4.6/gravitee-gateway/tenants.md))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
