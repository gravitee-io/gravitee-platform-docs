...
7.  You can view your entrypoint mapping in the **Entrypoint mappings** section:
    ...
    <figure><img src="../.gitbook/assets/gravitee-gateway-sharding-tags-48-1.png" alt="The organization sharding tags page scrolled to Entrypoint mappings, with a masked default entrypoint and one mapping row highlighted."><figcaption></figcaption></figure>
