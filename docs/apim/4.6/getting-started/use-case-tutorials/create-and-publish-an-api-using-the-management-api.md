...
Your API must have at least one Security/Consumer plan associated with it before it can be deployed to a Gateway. For more information about Plans, see [https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.6/getting-started/use-case-tutorials/broken-reference/README.md](https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.6/getting-started/use-case-tutorials/broken-reference/README.md "mention"). The following procedure explains how to create a `KEYLESS` plan.
