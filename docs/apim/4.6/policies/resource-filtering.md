...
<figure><img src="../.gitbook/assets/policies-resource-filtering-179.png" alt="The resource filtering policy configuration open over the Policies page, with a trigger condition on a JWT scope claim and a blacklist rule covering all paths and every HTTP method."><figcaption><p>Screenshot of the Resource Filtering policy - if the authenticated user doesn't have the required scope, then blacklist all endpoint paths</p></figcaption></figure>
