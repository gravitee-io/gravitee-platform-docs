...
When defining the response body content, you can use [Gravitee Expression Language (EL)](docs/apim/4.6/getting-started/gravitee-expression-language.md) to provide a dynamic mock response.
