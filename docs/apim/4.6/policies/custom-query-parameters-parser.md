...
* Policies are executed after flow evaluation. For a condition on a flow using [EL](docs/apim/4.6/getting-started/gravitee-expression-language.md) to test query parameters, they will be extracted by the Gateway using `;` as a separator.
