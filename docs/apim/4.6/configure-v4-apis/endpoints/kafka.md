...
<figure><img src="../../.gitbook/assets/v4-config-endpoints-kafka-137 (1).png" alt="The Shared access policies page of an event hub namespace in a cloud console, listing one root policy with manage, send, and listen claims."><figcaption></figcaption></figure>
