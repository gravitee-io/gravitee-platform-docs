---
description: The Gravitee Markdown install component embeds one-click MCP installer actions on API Management 4.12 portal pages. Learn the supported AI clients.
---
