...
* **Members:** View and manage application members. See [Managing Application Members](../new-developer-portal/managing-application-members.md) for details.
* **Invitations:** View and manage pending application invitations. See [Managing Application Invitations](../../secure-and-expose-apis/applications/managing-application-invitations.md) for details.
* **Members (legacy):** View and edit member information:
