...
Gravitee V4 and Federated APIs are managed within the **v2** subcomponent of the management API. You can access the v2 subcomponent through the `/management/v2` subpath. For complete details, see the [Management API v2 documentation](https://gravitee-io-labs.github.io/mapi-v2-docs-openapi-apis/).
...
* [**/management/v2 subcomponent documentation**](https://gravitee-io-labs.github.io/mapi-v2-docs-openapi-apis/)**:** provides the specification for `management/v2` endpoints. Use this component to complete the following actions:
  ...
  * Import and update APIs using Gravitee API definitions or OpenAPI specifications
