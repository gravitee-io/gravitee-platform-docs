...
|:----------|:-----|:------------|
| `q` | String | Deprecated. Use `filters.query` in request body instead. |
...
{% hint style="warning" %}
The user search endpoint returns HTTP 400 when both the `q` query parameter and request body are provided.
{% endhint %}
