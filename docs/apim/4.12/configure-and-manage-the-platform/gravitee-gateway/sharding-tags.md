...
To learn more about how to deploy APIs to specific Gateways based on sharding tags, refer to [Configure Deployments](../../create-and-configure-apis/configure-v2-apis/proxy-settings.md). For API Product deployment configuration, refer to the [API Product deployment configuration guide](../../secure-and-expose-apis/api-products/api-product-deployment-configuration-overview.md#api-product-deployment-configuration-overview).
