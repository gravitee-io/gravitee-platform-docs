...
Sharding tags also apply to API Products and their plans, controlling product and plan indexing on gateways. API Products support sharding tags for multi-region and environment-segmented deployments. To learn more about configuring API Product deployment, refer to the dedicated deployment configuration documentation.
