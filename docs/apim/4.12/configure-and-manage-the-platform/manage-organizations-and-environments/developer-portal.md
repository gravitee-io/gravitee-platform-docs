...
For federated APIs, the Developer Portal conditionally displays API access information based on plan security and entrypoint availability. Learn more about [viewing federated API access information](../../govern-apis/federation/federated-apis.md#viewing-api-access-information).
