---
description: The Developer Portal gives API consumers a simplified interface onto your API Management 4.12 APIs. Learn how to configure it.
metaLinks:
  alternates:
    - developer-portal.md
---
...
The Automation API supports programmatic management of portal structure, API listings, and documentation pages for the next-generation Developer Portal. For details, see [Portal automation](../../developer-portal/new-developer-portal/customize-the-navigation/portal-automation/README.md).
...
<figure><img src="../../.gitbook/assets/self-managed dev portal link.png" alt="The portal settings page, showing the API key header, a local portal URL, and options for tiles mode, support, rating, user registration, and analytics."><figcaption></figcaption></figure>
