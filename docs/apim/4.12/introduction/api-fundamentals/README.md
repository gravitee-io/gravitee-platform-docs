---
description: Key API terminology and concepts that make the API Management 4.12 platform easier to use. Learn the fundamentals before you start building.
---
...
{% hint style="info" %}
If you already have experience with APIs, visit the [Gravitee Core Concepts](../core-concepts.md) section to learn about concepts specific to the Gravitee ecosystem.
{% endhint %}
