---
description: Deploy a Prometheus and Grafana monitoring stack for API Management 4.12 with Docker Compose. Follow the steps to enable the metrics service.
---
