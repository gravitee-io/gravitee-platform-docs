...
* [Upgrade Guides](upgrade-guides/README.md)
  ...
  * [Migrate from Redis Cache Resource 4.x to 5.x](upgrade-guides/migrate-from-redis-cache-resource-4.x-to-5.x.md)
...
* [Configure & Manage the Platform](configure-and-manage-the-platform/README.md)
  * [Gravitee Gateway](configure-and-manage-the-platform/gravitee-gateway/README.md)
    ...
    * [Gateway-Wide Redis Connection Pool Configuration](configure-and-manage-the-platform/gravitee-gateway/gateway-wide-redis-connection-pool-configuration.md)
...
* [Migrating to Gateway-Wide Pool Configuration and Updated SSL Schema](migrating-to-gateway-wide-pool-configuration-and-updated-ssl-schema.md)
