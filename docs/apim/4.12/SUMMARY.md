...
* [Kafka Gateway](kafka-gateway/README.md)
  ...
  * [Consumer Group Routing: KIP-848 Protocol (Multiplexing)](kafka-gateway/consumer-group-routing-kip-848-protocol-multiplexing.md)
  * [Creating and Managing Virtual Cluster Entities](kafka-gateway/managing-kafka-virtual-clusters.md)
  ...
  * [Managing Kafka Virtual Clusters](kafka-gateway/creating-and-managing-kafka-virtual-clusters.md)
  * [Managing Topics, Partitions, Configurations, and Admin Operations](kafka-gateway/managing-topics-partitions-configurations-and-admin-operations.md)
  ...
  * [Create & Configure Kafka APIs](kafka-gateway/create-and-configure-kafka-apis/README.md)
    * [Create Kafka APIs](kafka-gateway/create-and-configure-kafka-apis/create-kafka-apis.md)
      * [Creating Kafka APIs with Cluster and Virtual Cluster References](kafka-gateway/create-and-configure-kafka-apis/creating-kafka-apis-with-cluster-and-virtual-cluster-references.md)
  ...
  * [Producer ID Session Management and Idempotent Producers](kafka-gateway/producer-id-session-management-and-idempotent-producers.md)
  * [SASL Delegate-to-Broker Authentication](kafka-gateway/sasl-delegate-to-broker-authentication.md)
  ...
  * [Virtual Clusters Overview and Gateway Configuration](kafka-gateway/virtual-clusters-overview-and-gateway-configuration.md)
...
* [Configuring Native Kafka APIs with Cluster Endpoints](configuring-native-kafka-apis-with-cluster-endpoints.md)
