...
* [Kafka Gateway](kafka-gateway/README.md)
  ...
  * [Kafka Cluster Management API Reference](kafka-gateway/kafka-cluster-management-api-reference.md)
  * [Kafka Virtual Cluster Restrictions and Limitations](kafka-gateway/kafka-virtual-cluster-restrictions-and-limitations.md)
  * [Kafka Virtual Clusters and Producer ID Rewrite Overview](kafka-gateway/kafka-virtual-clusters-and-producer-id-rewrite-overview.md)
  * [Prerequisites and Gateway Configuration for Kafka Virtual Clusters](kafka-gateway/prerequisites-and-gateway-configuration-for-kafka-virtual-clusters.md)
  ...
  * [Create & Configure Kafka APIs](kafka-gateway/create-and-configure-kafka-apis/README.md)
    ...
    * [Configure Kafka APIs](kafka-gateway/create-and-configure-kafka-apis/configure-kafka-apis/README.md)
      ...
      * [Console UI and Database Schema Changes for Kafka Virtual Clusters](kafka-gateway/create-and-configure-kafka-apis/configure-kafka-apis/console-ui-and-database-schema-changes-for-kafka-virtual-clusters.md)
