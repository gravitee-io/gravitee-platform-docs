---
description: Federate APIs from the Mulesoft Anypoint Platform into API Management 4.12. Learn how the integration discovers and ingests them.
metaLinks:
  alternates:
...
2.  Return to the Gravitee API Management console, refresh the page, and verify that the agent's status is set to **Connected**.
    ...
    <figure><img src="../../../.gitbook/assets/govern-apis-federation-3rd-party-provide-62-1.png" alt="The Overview page of a connected Mulesoft integration, showing the provider, the connected agent, and a partly masked integration identifier."><figcaption></figcaption></figure>
