---
description: Federate event APIs from the Solace Event Portal into API Management 4.12. Learn how the integration works with an event mesh.
metaLinks:
  alternates:
    - solace.md
---
...
* Install Gravitee API Management version 4.4 or later, with an enterprise license. For more information about Enterprise edition, see[ Enterprise Edition Licensing.](../../../introduction/enterprise-edition-licensing.md#license-support)
...
5.  (Optional) Type the **Description** for the integration.
    ...
    <figure><img src="../../../.gitbook/assets/govern-apis-federation-3rd-party-provide-61-1.png" alt="The Enter Information step of the Create Integration wizard for a Solace integration, with the Create Integration button highlighted."><figcaption></figcaption></figure>
