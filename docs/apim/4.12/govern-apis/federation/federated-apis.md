---
description: Federated APIs are one of the three main v4 Gravitee API types in API Management 4.12. Learn what they can and cannot do.
metaLinks:
  alternates:
    - federated-apis.md
---
...
* For more information on how to create and manage subscriptions in APIM, see [Subscriptions](../../secure-and-expose-apis/subscriptions/README.md).
{% endhint %}
