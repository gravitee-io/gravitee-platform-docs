...
1. In the Invitations table, click **Resend** next to the invitation.
2. (Optional) Update the **Confirmation Page URL** in the dialog.
3. Click **Resend**.
...
1. In the Invitations table, click **Edit invitation role** next to the invitation.
...
1. In the Invitations table, click **Delete** next to the invitation.
