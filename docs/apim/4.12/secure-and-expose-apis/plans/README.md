...
6.  Configure the general plan settings:
    ...
    * **Sharding tags:** Selectively deploy the plan to particular API Gateways using available [sharding tags](../../configure-and-manage-the-platform/gravitee-gateway/sharding-tags.md). For more information on configuring plan deployment, see [Configure Plan Deployment](../api-products/configure-plan-deployment.md).
