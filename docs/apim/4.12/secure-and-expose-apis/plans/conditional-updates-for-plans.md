...
hidden: true
noIndex: true
description: The Management API supports optimistic concurrency for API Management 4.12 plan updates with ETag headers. Learn how conditional updates work.
---
