---
description: Start with API Management 4.12 on Gravitee Cloud, hybrid, or fully self-hosted. Compare the deployment options before you install.
metaLinks:
  alternates:
    - ./
---
...
{% hint style="info" %}
For a detailed description of Gravitee Enterprise Edition, see [enterprise-edition.md](../introduction/enterprise-edition.md "mention").
{% endhint %}
