---
description: As organizations adopt AI agents, an API Management 4.12 A2A proxy connects them securely. Follow the steps to create one and configure the gateway.
metaLinks:
  alternates:
