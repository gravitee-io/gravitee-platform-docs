---
description: AI Model Text Classification detects toxic content and prompt injection in API Management 4.12 traffic. Compare the detection models available.
---
