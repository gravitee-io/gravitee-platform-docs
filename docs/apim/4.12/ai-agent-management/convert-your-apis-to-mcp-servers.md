---
description: Deploy an API Management 4.12 REST API as an MCP Server for AI agents. Follow the steps and see how the OpenAPI specification maps to MCP tools.
---
...
2.  Find the API that you want to convert into an MCP Server.
    ...
    <figure><img src="../.gitbook/assets/EFADEF2D-0D48-41A3-9668-C4C2A6F806DA_1_201_a.jpeg" alt="The APIs list showing the first page of 2,394 APIs, with their definition, status, context path, quality score, tags, categories, owner, and visibility."><figcaption></figcaption></figure>
3.  From the API menu, click **Entrypoints**.

    <figure><img src="../.gitbook/assets/35CF5451-4B63-46D3-B173-BEBBB47EAC95_1_201_a.jpeg" alt="The Configuration page of a V4 API with Entrypoints highlighted in the API menu, showing the name, version, and owner beside a Danger Zone."><figcaption></figcaption></figure>
4. From the **Entrypoints** screen, click **MCP Entrypoint**.
5.  Click **Enable MCP**.

    <figure><img src="../.gitbook/assets/98908DA2-8C19-43DB-B89F-7C6E5E020F22_1_201_a.jpeg" alt="The MCP Entrypoint tab of an API, not yet enabled, with an Enable MCP button below an explanatory message."><figcaption></figcaption></figure>
6.  Click **+ Generate Tools from OpenAPI**.

    <figure><img src="../.gitbook/assets/2AA002A5-4D84-419D-8340-7600F9A9C5CD_1_201_a.jpeg" alt="The MCP Entrypoint tab with MCP enabled, the path set to /mcp, no tools configured, and the Generate Tools from OpenAPI button highlighted."><figcaption></figcaption></figure>
7.  In the **Generate Tools from OpenAPI** pop-up window, add your OpenAPI specification, and then click **Regenerate Tools**.

    <figure><img src="../.gitbook/assets/FF3E9B42-CABD-400C-9C01-45D59D1239ED_1_201_a.jpeg" alt="The Generate Tools from OpenAPI dialog, with an OpenAPI specification on the left and the generated weather forecast tool definition on the right, above a Regenerate Tools button."><figcaption></figcaption></figure>
8.  Click **Create**.

    <figure><img src="../.gitbook/assets/624D7AEF-49B6-433E-9340-501DD3D348ED_1_201_a.jpeg" alt="The Enable MCP Entrypoint page, with the path set to /mcp, one generated tool listed, and the Create button highlighted."><figcaption></figcaption></figure>
9.  Click **Deploy API**.

    <figure><img src="../.gitbook/assets/D4C34EEE-4E78-45A8-A220-94AFF9B6FC15_1_201_a.jpeg" alt="The MCP Entrypoint tab with MCP enabled and one tool listed, under an out-of-sync banner with the Deploy API button highlighted."><figcaption></figcaption></figure>
...
11. Click **Deploy**. You receive the message **API successfully deployed**.
    ...
    <figure><img src="../.gitbook/assets/B3BAF69E-C256-402C-B4F2-C45D15B9CDC9_1_201_a.jpeg" alt="The Deploy your API dialog open over the MCP Entrypoint tab, asking for a label to identify the deployment."><figcaption></figcaption></figure>
