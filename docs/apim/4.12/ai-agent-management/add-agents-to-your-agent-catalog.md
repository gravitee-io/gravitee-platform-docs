---
description: Add AI agents to your API Management 4.12 Agent Catalog by importing or discovering their Agent Cards. Follow the steps to create an integration.
metaLinks:
  alternates:
