---
description: Define a collection of API Management 4.12 policies centrally and reuse them across APIs. Follow the steps to create and add a group.
metaLinks:
  alternates:
...
4. (Optional) For each policy step, add a description in the **Description** field. When you enable verbose tracing on the API and gateway, policy descriptions are included as `gravitee.policy.description` span attributes in distributed tracing data.
5. Click **Save**.
6. Click **Deploy.**
