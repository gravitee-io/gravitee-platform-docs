---
description: Policies are customizable rules the API Management 4.12 Gateway runs during an API transaction. Compare policy support across v2 and v4 APIs.
metaLinks:
  alternates:
    - ./
---
...
Most policies fall into the categories of security, transformation, restrictions, performance, routing, or monitoring & testing. Although the implementation details of each policy are unique, they share a common installation and deployment, and they are compatible with subsets of request/response phases.
...
Policy support differs based on API definition and type. The following matrix shows which policies are supported by v2 proxy, v4 proxy, v4 message, v4 LLM proxy, v4 MCP proxy, and v4 A2A proxy APIs.
...
<table data-full-width="true">
    <thead>
        <tr>
            <th width="210">Policy</th>
            <th>v2 proxy APIs</th>
            <th>v4 proxy APIs</th>
            <th>v4 message APIs</th>
            <th>v4 LLM proxy APIs</th>
            <th>v4 MCP proxy APIs</th>
            <th>v4 A2A proxy APIs</th>
        </tr>
    </thead>
    <tbody>
        <tr>
        ...
        <tr>
            <td>Custom Query Parameters Parser</td>
            <td><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span></td>
            <td><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>Transform Query Parameters</td>
            <td><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span></td>
            <td><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>WS-Security Authentication</td>
            <td><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span></td>
            <td><span data-gb-custom-inline data-tag="emoji" data-code="2705">✅</span></td>
            <td></td>
            <td></td>
...
Each version of Gravitee API Management (APIM) includes a number of policies in the default distribution. [Gravitee Enterprise Edition policy plugins](../../introduction/enterprise-edition.md#enterprise-plugins) are available for download [here](https://download.gravitee.io/).
