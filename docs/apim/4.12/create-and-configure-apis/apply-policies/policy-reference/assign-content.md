---
description: The Assign Content policy changes or transforms request and response bodies in API Management 4.12. Learn how to configure the transformation.
metaLinks:
  alternates:
    - assign-content.md
---
