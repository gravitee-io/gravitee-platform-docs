---
description: Kafka governance rules policies enforce compliance standards on Kafka requests through the API Management 4.12 Gateway. Learn what they check.
---
