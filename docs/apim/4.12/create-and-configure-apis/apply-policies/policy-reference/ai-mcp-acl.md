---
description: The MCP ACL policy controls access to MCP server functionality in API Management 4.12 with an access control list. Learn how to configure it.
---
