...
* Historical analytics are now preserved after migration. V4 analytics dashboards query both v4 and v2 indices, providing a unified view of all API metrics before and after migration.
* Connection logs for migrated APIs now include records from both v2 and v4 indices, providing a unified view of all API traffic before and after migration.
* If you have existing v2 analytics indices, you must manually update their field mappings to enable this functionality. See the [field aliases configuration guide](../../preserve-v2-analytics-after-migration-to-v4.md) for the required procedure.
{% endhint %}
