...
* Analytics continuity is now supported for migrated APIs. Historical v2 analytics data remains accessible in the v4 analytics dashboard. See [V2 API Analytics Continuity](../../v2-api-analytics-continuity-after-migration.md#v2-api-analytics-continuity-after-migration) for details.
