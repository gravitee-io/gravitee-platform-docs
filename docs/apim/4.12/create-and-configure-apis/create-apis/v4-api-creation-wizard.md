...
The v4 API creation wizard makes it easy to create new Gateway APIs from scratch. You can create APIs manually or import them from existing API definitions. Supported import formats include OpenAPI (Swagger), AsyncAPI, and WSDL. WSDL imports create v4 HTTP Proxy APIs and support both inline upload and remote URL sources.

To access the v4 API creation wizard:
