...
<!-- TODO: Diagram of the HA reference architecture (clients -> wildcard DNS -> L4 TLS-passthrough load balancer -> stateless gateway pool -> backend Kafka brokers, with the control plane alongside) -->
<figure><img src="../../.gitbook/assets/PLACEHOLDER-kafka-gateway-ha-reference-architecture.png" alt=""><figcaption><p>Kafka gateway high-availability reference architecture</p></figcaption></figure>
