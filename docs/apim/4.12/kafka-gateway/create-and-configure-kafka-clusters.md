---
description: Create and manage Kafka clusters from the Kafka UI in the API Management 4.12 Console. Follow the steps to configure a cluster.
metaLinks:
  alternates:
...
2.  Click **+ Add cluster**.
    ...
    <figure><img src="../.gitbook/assets/902A4021-EA90-4AB6-84B4-C0F9E995F54E_1_201_a (1).jpeg" alt="The Kafka Clusters page with the Add cluster button highlighted, listing one cluster with its bootstrap server masked, SASL_SSL security, and last updated time."><figcaption></figcaption></figure>
3. In the **Create a new cluster** pop-up window, complete the following sub-steps:
   ...
   4.  Click **Create**. You are brought to the cluster's configuration screen.
       ...
       <figure><img src="../.gitbook/assets/F7727719-AE67-4E84-A45B-478A4D66E2F5_1_201_a.jpeg" alt="The Create a new cluster dialog, with a cluster name entered, an empty description, and placeholder bootstrap server addresses."><figcaption></figcaption></figure>
...
3.  Click **Yes, delete it.**
    ...
    <figure><img src="../.gitbook/assets/42CDC273-4677-4127-A6DF-FBB3B7F53842_1_201_a.jpeg" alt="The Delete Cluster dialog, warning that the operation is irreversible and requiring the cluster name to be typed to confirm."><figcaption></figcaption></figure>
...
* Security. By Default, the security protocol is set to **PLAINTEXT**. You can choose from the following security protocols for your cluster:
  ...
  *   SSL
      ...
      <figure><img src="../.gitbook/assets/9FAEF4B2-47B4-4D19-B2D2-D063ED96CAED_1_201_a.jpeg" alt="The Configuration tab of a Kafka cluster, with placeholder bootstrap servers and the security protocol dropdown open on PLAINTEXT, SASL_PLAINTEXT, SASL_SSL, and SSL."><figcaption></figcaption></figure>
...
3.  Click **Save**.
    ...
    <figure><img src="../.gitbook/assets/00 kafkaUI 1.png" alt="The Manage groups dialog open over a cluster&#x27;s User Permissions tab, with the groups dropdown expanded and each group listed with a clear checkbox."><figcaption></figcaption></figure>
...
5.  Click **Transfer**.
    ...
    <figure><img src="../.gitbook/assets/00 kafkaUI 2.png" alt="The Transfer ownership dialog for a cluster, with Other user selected, a user searched, and the new role for the current primary owner set to USER."><figcaption></figcaption></figure>
...
3.  Click **Select**.
    ...
    <figure><img src="../.gitbook/assets/00 kafkaUI 4.png" alt="The Select users dialog open over a cluster&#x27;s User Permissions tab, with an empty search field and no user selected yet."><figcaption></figcaption></figure>
