---
description: Install the Alert Engine integration for Access Management alongside API Management 4.12. Follow the steps, or skip them on Enterprise images.
---
