# installation-guide-rest-apis-technical-api

The APIM API component comes with its own internal API, for monitoring and retrieving technical information about the component.
