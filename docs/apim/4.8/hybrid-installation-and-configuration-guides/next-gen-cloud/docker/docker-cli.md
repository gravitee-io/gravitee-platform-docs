---
description: Install the API Management 4.8 Data Plane with Docker CLI commands for a Next-Gen Cloud hybrid. Follow the steps to run it.
---
...
3.  Run the Gateway with Redis rate limiting enabled with the following command:
    ...
    *   Replace `<CONTROL_PLANE_VERSION>` with the version that matches your Gravitee Cloud Control Plane. For example. 4.8.2.
        ...
        <figure><img src="../../../.gitbook/assets/hybrid-cloud-docker-docker-cli-324.png" alt="The Generate a token dialog on a user&#x27;s Tokens tab, with a token name entered, above an empty tokens table."><figcaption></figcaption></figure>
