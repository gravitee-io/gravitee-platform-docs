...
You can find additional details about property encryption in [Properties](docs/apim/4.8/create-and-configure-apis/apply-policies/4.9-v4-api-policy-studio.md#api-properties).
