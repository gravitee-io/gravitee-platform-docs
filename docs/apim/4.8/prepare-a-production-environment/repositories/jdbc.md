...
If you are using Docker to install and run APIM, you should place the driver in the `plugins-ext` folder and configure it by using the Docker Compose file or command line arguments. For more information, see [Customize you Installation](docs/apim/4.8/self-hosted-installation-guides/docker/customize-your-installation.md).
{% endhint %}
