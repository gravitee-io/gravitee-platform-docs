...
<figure><img src="../../.gitbook/assets/prod-env-secrets-apply-secrets-to-a-142.png" alt="The Configure Cache Redis resource dialog, with the password read from a secrets expression, SSL enabled, and the host read from a dictionary lookup."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2025-01-23 at 13.54.01 (1).png" alt="Kafka endpoint settings, with a local bootstrap server, the SASL_PLAINTEXT protocol, the SCRAM-SHA-256 mechanism, and username and password read from secrets expressions."><figcaption></figcaption></figure>
