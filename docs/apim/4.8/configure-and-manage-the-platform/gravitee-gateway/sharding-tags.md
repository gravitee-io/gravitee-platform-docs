---
description: Sharding tags tag API Management 4.8 Gateways so specific APIs deploy to a particular gateway. Learn how the tags work in practice.
---
...
1.  From the **Dashboard**, click **APIs**.
    ...
    <figure><img src="../../.gitbook/assets/click-on-apis.png" alt="The console dashboard with APIs highlighted in the left navigation, showing four total APIs and five applications with lifecycle and state pie charts."><figcaption></figcaption></figure>
...
2)  In the **Entrypoint url** field, enter your entrypoint URL.
    ...
    <figure><img src="../../.gitbook/assets/configure-and-manage-the-platform-gravit-9-1.png" alt="The Create an entrypoint mapping dialog, with empty sharding tags and entrypoint URL fields."><figcaption></figcaption></figure>
3) Click **Ok.**
{% endtab %}
...
2.  In the **Default TCP port** field, type the number of your TCP port.
    ...
    <figure><img src="../../.gitbook/assets/configure-and-manage-the-platform-gravit-10-1.png" alt="The Create an entrypoint mapping dialog, explaining that the mapping links an entrypoint URL to sharding tags, with empty sharding tags and default TCP port fields."><figcaption></figcaption></figure>
3. Click **Ok**.
{% endtab %}
...
3.  In the **Default Kafka port** field, type your default Kafka port.
    ...
    <figure><img src="../../.gitbook/assets/configure-and-manage-the-platform-gravit-11-1.png" alt="The Create an entrypoint mapping dialog with a Kafka bootstrap domain pattern and port, and an empty sharding tags field."><figcaption></figcaption></figure>
4. Click **Ok**.
{% endtab %}
{% endtabs %}
