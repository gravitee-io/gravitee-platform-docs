...
Starting from version 4.7.6, you can use dictionaries in a [Multi-tenancy](docs/apim/4.8/self-hosted-installation-guides/multi-tenancy.md) setup. With this new capability, you can complete the following actions:
...
You can use dictionaries anywhere in APIM where [Gravitee Expression Language](docs/apim/4.8/gravitee-expression-language.md) is supported, such as when defining policies for API flows. You can access dictionary properties with the Expression Language statement `#dictionaries`.
{% endhint %}
