...
*   **OpenID Connect Discovery Endpoint:** Enter the URL where an OIDC-compatible authorization server publishes its metadata
    ...
    {% endhint %}
* Use the **Initial Access Token Provider** drop-down menu to select the [initial access token flow](applications-1.md#initial-access-token-flows):
...
* **Trust Store Type:** Use the drop-down menu to specify trusted SSL/TLS certificates. See [#dcr-trusted-certificate-configuration-details](applications-1.md#dcr-trusted-certificate-configuration-details "mention") for more information.
* **Key Store Type:** Use the drop-down menu to configure a key store. See [#dcr-trusted-certificate-configuration-details](applications-1.md#dcr-trusted-certificate-configuration-details "mention") for more information.
...
* [Authorization code](applications-1.md#authorization-code)
* [Implicit](applications-1.md#implicit)
* [Resource owner credentials](applications-1.md#resource-owner-credentials)
* [Client credentials](applications-1.md#client-credentials)
* [Refresh token](applications-1.md#refresh-token)
