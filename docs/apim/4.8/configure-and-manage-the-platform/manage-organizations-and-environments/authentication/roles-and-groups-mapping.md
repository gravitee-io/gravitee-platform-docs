---
description: Assign roles to API Management 4.8 users through groups rather than individually. Learn how group and role mapping works.
---
...
<figure><img src="../../../.gitbook/assets/configure-and-manage-the-platform-manage-4-1.png" alt="Empty Groups Mapping and Roles Mapping panels, each with a link to add a mapping."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/configure-and-manage-the-platform-manage-150-1.png" alt="A Groups Mapping entry, with a JSON path condition on the user profile and the group it maps to."><figcaption><p>Group Mapping configuration</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/configure-and-manage-the-platform-manage-152-1.png" alt="A Roles Mapping entry, with a JSON path condition on the profile roles, the organization role set to ADMIN, and the environment role dropdown open."><figcaption><p>Role Mapping configuration</p></figcaption></figure>
