---
description: Set up API Management 4.8 Console authentication with Microsoft Entra ID. Follow the steps to configure the identity provider.
---
...
4.  Configure the **API permissions** to allow Gravitee to read the user **email**, **openid**, and **profile** details.
    ...
    <figure><img src="../../../.gitbook/assets/configure-and-manage-the-platform-manage-2-1-v2.png" alt="The API permissions page of an app registration in an external identity provider, listing four delegated Microsoft Graph permissions for email, openid, profile, and user profile."><figcaption></figcaption></figure>
