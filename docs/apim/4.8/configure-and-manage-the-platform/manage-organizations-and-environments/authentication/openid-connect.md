---
description: OpenID Connect is an authentication protocol built on OAuth 2.0, supported by API Management 4.8. Follow the steps to configure it.
---
...
<figure><img src="../../../.gitbook/assets/platform-manage-organizations-and-e-319.png" alt="An identity provider configuration form, with a placeholder client ID, a masked client secret, placeholder token, introspection, authorize, userinfo, and logout endpoints, and openid and email scopes."><figcaption></figcaption></figure>
