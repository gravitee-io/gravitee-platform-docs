...
4.  Type the **Integration Name.**
    ...
    <figure><img src="../../../.gitbook/assets/govern-federation-mulesoft-anypoint-39.png" alt="The Enter Information step of the Create Integration wizard for a Mulesoft integration, with the Create Integration button highlighted."><figcaption></figcaption></figure>
...
2.  Return to the Gravitee API Management console, refresh the page, and verify that the agent's status is set to **Connected**.
    ...
    <figure><img src="../../../.gitbook/assets/govern-federation-mulesoft-anypoint-62.png" alt="The Overview page of a connected Mulesoft integration, showing the provider, the connected agent, and a partly masked integration identifier."><figcaption></figcaption></figure>
