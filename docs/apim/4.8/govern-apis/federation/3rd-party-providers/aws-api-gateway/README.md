---
description: Federate APIs from AWS API Gateway, the built-in AWS solution, into API Management 4.8. Learn how the integration works for you.
---
...
1.  In the Gravitee API Management console, after refreshing, you should now see the agent's status set to `Connected`.<br>
    ...
    <figure><img src="../../../../.gitbook/assets/govern-federation-aws-api-gateway-r-2.png" alt="The Overview page of a connected federation integration, showing the provider, a connected agent, and a partly masked integration identifier."><figcaption></figcaption></figure>
