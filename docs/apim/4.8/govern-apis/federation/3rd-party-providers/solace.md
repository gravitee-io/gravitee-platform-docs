---
description: Federate event APIs from the Solace Event Portal into API Management 4.8. Learn how the integration works with an event mesh.
---
...
5.  (Optional) Type the **Description** for the integration.
    ...
    <figure><img src="../../../.gitbook/assets/govern-federation-solace-61.png" alt="The Enter Information step of the Create Integration wizard for a Solace integration, with the Create Integration button highlighted."><figcaption></figcaption></figure>
...
2.  Return to the Gravitee API Management console, refresh the page, and verify that the agent's status is set to **Connected**.<br>
    ...
    <figure><img src="../../../.gitbook/assets/govern-federation-solace-3.png" alt="The Overview page of a connected Solace integration, showing the provider, a connected agent, and a partly masked integration identifier."><figcaption></figcaption></figure>
