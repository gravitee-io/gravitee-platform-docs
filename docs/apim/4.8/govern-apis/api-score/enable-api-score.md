---
description: API Score is available in Gravitee Cloud; a self-hosted API Management 4.8 install needs it enabled. Follow the steps to turn it on.
---
...
1.  From the home page, click **Settings**.
    ...
    <figure><img src="../../.gitbook/assets/govern-api-score-enable-api-score-218.png" alt="The console dashboard with API Score in the left navigation, showing total API and application counts and top API statistics."><figcaption></figcaption></figure>
