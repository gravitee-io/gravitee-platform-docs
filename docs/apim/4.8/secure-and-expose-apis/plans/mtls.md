...
To use an mTLS plan, you need to [enable HTTPS on your Gateway(s)](docs/apim/4.8/prepare-a-production-environment/configure-your-http-server.md#enable-https-support). &#x20;
