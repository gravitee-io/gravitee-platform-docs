...
8. If you selected **OpenAPI specification** as the API format, you can choose to enable the following:
   ...
   *   **Add OpenAPI Specification Validation:** This adds an [OpenAPI Specification Validation policy](docs/apim/4.8/create-and-configure-apis/apply-policies/policy-reference/oas-validation.md) to the imported API.
