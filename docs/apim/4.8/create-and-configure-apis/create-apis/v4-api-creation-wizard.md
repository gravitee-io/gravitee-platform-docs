---
description: Create a v4 API with the API Management 4.8 creation wizard, from API details through to entrypoints. Follow the steps in order.
---
...
<figure><img src="../../.gitbook/assets/v4 step 2 (1).png" alt="Step 2 of the API creation wizard, with Proxy Generic Protocol selected over Protocol Mediation and Kafka Protocol."><figcaption></figcaption></figure>

### Generic proxy entrypoints

If you chose **Proxy Generic Protocol**, select either HTTP Proxy or TCP Proxy as your entrypoint.

<figure><img src="../../.gitbook/assets/v4 3 (1).png" alt="Step 2 of the API creation wizard, with HTTP Proxy selected over TCP Proxy as the API entrypoint."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/v4 wizard_step 2 message entrypoints.png" alt="Step 2 of the API creation wizard, with HTTP GET and HTTP POST ticked and Server-Sent Events and Webhook left clear."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/a v4 00 (1).png" alt="Step 3 of the API creation wizard, with Kafka and MQTT 5.x ticked and Azure Service Bus, Mock, RabbitMQ, and Solace left clear."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/a v4 1 (1).png" alt="Step 4 of the API creation wizard, listing one default keyless plan in standard mode with edit and remove icons."><figcaption></figcaption></figure>
...
* (Optional) Use the [Gravitee Expression Language](../../gravitee-expression-language.md) to define additional selection rules. If you are managing multiple plans that share the same type, this will help the plan selection process.
...
2. Define your **JWKS resolver**. This defines how your JSON Web Key Set is retrieved. The options are:
   ...
   * GATEWAY\_KEYS
   * JWKS\_URL
3. Define your Resolver parameter. This field supports the [Gravitee Expression Language](../../gravitee-expression-language.md).
...
7. Use the [Gravitee Expression Language](../../gravitee-expression-language.md) to define additional selection rules. If you are managing multiple plans that share the same type, this will help the plan selection process.
