...
* For APIs that have either of the given [sharding tags](docs/apim/4.8/configure-and-manage-the-platform/gravitee-gateway/sharding-tags.md): `tags:china-internet tags:china`
* For an API name that contains one term but not another: `name:"*Allan*" NOT name:"*Test_"`
* For any APIs that have [health checks](docs/apim/4.8/create-and-configure-apis/configure-v4-apis/health-checks.md) configured: `has_health_check:true`
