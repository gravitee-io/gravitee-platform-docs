---
description: Filter the list of APIs that appear in the API Management 4.8 Console. Follow the steps to search, and see the worked search examples.
hidden: true
noIndex: true
---
...
*   **Portal Visibility.** This maps to if your API is set to public or private in your Developer Portal.
    ...
    <figure><img src="../../.gitbook/assets/25C6D5D9-187B-46B6-BDEA-9402B5B8B9B4_1_201_a.jpeg" alt="The APIs list with the filter row highlighted, showing API Type, API Status, Sharding Tags, Categories, Portal Status, and Portal Visibility dropdowns above 2,942 APIs."><figcaption></figcaption></figure>
