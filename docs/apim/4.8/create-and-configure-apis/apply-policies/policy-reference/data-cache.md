...
* To start with, add a [cache resource](docs/apim/4.8/create-and-configure-apis/apply-policies/resources.md#cache) to the API (Redis or the built-in gateway cache). Then, add a new flow to the API in the policy studio.
