...
<figure><img src="../../../.gitbook/assets/config-apis-apply-policies-policy-r-145.png" alt="A flow&#x27;s request phase containing a data cache policy, an HTTP callout, and a second data cache policy, each with a condition shown above it, and an empty response phase below."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/config-apis-apply-policies-policy-r-147.png" alt="The HTTP callout policy configuration, with a description, a trigger condition on the cache miss attribute, the POST method, a token endpoint URL, and an Authorization request header."><figcaption></figcaption></figure>
