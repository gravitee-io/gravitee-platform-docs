...
<figure><img src="../../../.gitbook/assets/49-expose-apim-as-an-mcp-server-339.png" alt="The User details page of a service account, showing its source, organization role, and creation date, the organization and environment roles assigned, and an empty Groups panel." width="375"><figcaption></figcaption></figure>
{% endtab %}
{% endtabs %}
