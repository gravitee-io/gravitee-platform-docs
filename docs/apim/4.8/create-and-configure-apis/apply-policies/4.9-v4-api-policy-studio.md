---
description: The v4 Policy Studio designs flows for APIs using the v4 API Management 4.8 definition. Follow the example to create a flow and add a policy.
hidden: true
noIndex: true
---
...
<figure><img src="../../.gitbook/assets/0 ps9.png" alt="The Policies page with flows grouped by plan, annotated to show which label is the plan name, which is the path, and which is the flow name."><figcaption></figcaption></figure>
