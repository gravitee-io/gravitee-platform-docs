---
description: Add documentation to a v4 API from the API Management 4.8 Console so consumers know how to use it. Follow the steps to add pages and folders.
---
...
<figure><img src="../../.gitbook/assets/documentation_nothing added 1.png" alt="The Pages tab of an API&#x27;s documentation, empty, with Add new folder and Add new page buttons."><figcaption><p>Add pages and/or folders to your API documentation</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/docs_add folder 1.png" alt="The Add new folder dialog, with a folder name entered and Public visibility selected over Private."><figcaption><p>Add a folder</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/docs_folder added 1.png" alt="The Pages tab listing one folder, hidden and public, with actions to edit, reorder, and delete it."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/docs_add page 1.png" alt="The Configure page step of the documentation page wizard, with a page name entered and Public visibility selected."><figcaption><p>Markdown page configuration</p></figcaption></figure>

#### Step 2: Add content

Choose how you want to add content: **Fill in the content myself** or **Import from file**

<figure><img src="../../.gitbook/assets/docs_add content.png" alt="The Determine source step of the page wizard, offering to fill in the content manually, import from a file, or import from a URL, which is marked coming soon."><figcaption><p>Choose how to add content to a Markdown page</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/docs_page content 1.png" alt="The Add content step of the page wizard, with Markdown in the editor on the left and its rendered preview on the right."><figcaption><p>Add content to a Markdown page</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/docs_nested 1.png" alt="The Pages tab inside a folder, listing one published public page with actions to edit, unpublish, reorder, and delete it."><figcaption><p>Test page added to test folder</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/config-apis-v4-config-documentation-359.png" alt="Configure OpenAPI Viewer screenshot" width="563"><figcaption><p>Configure OpenAPI Viewer</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/docs_editing 1.png" alt="The Pages tab inside a folder, listing a published page and a hidden subfolder with their visibility and last updated times."><figcaption><p>Select from Actions to edit a page</p></figcaption></figure>
...
1.  Click **Open API in Developer Portal**
    ...
    <figure><img src="../../.gitbook/assets/docs_open api 1.png" alt="The Pages tab of an API&#x27;s documentation, with the Open API in Developer Portal button circled."><figcaption><p>Open API in Developer Portal</p></figcaption></figure>
2.  Click on **Documentation** in the header options

    <figure><img src="../../.gitbook/assets/docs_dev portal docs 1.png" alt="The Documentation tab of an API in the developer portal, showing the rendered Markdown page beside a table of contents."><figcaption><p>API documentation</p></figcaption></figure>
...
4.  Select the **Broadcasts** tab
    ...
    <figure><img src="../../.gitbook/assets/configure messages.png" alt="The Messages page of an API, with the channel set to Email, recipients chosen by role, and a title and message entered."><figcaption><p>Configure messages</p></figcaption></figure>
