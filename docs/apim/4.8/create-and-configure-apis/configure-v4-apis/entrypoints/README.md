---
description: Entrypoints define how consumers reach a v4 API Management 4.8 API, for proxy or message APIs. Compare the entrypoint types.
---
...
<figure><img src="../../../.gitbook/assets/configure v4 message entrypoints.png" alt="The Entrypoints tab of a message API, showing one context path above an entrypoint types table listing HTTP GET and HTTP POST, both set to automatic quality of service."><figcaption><p>v4 message API entrypoint configuration</p></figcaption></figure>
...
<table data-view="cards"><thead><tr><th></th><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td></td><td><a href="http-get.md">HTTP GET</a></td><td></td><td><a href="https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.8/create-and-configure-apis/configure-v4-apis/entrypoints/broken-reference/README.md">https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.8/create-and-configure-apis/configure-v4-apis/entrypoints/broken-reference/README.md</a></td></tr><tr><td></td><td><a href="http-post.md">HTTP POST</a></td><td></td><td><a href="https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.8/create-and-configure-apis/configure-v4-apis/entrypoints/broken-reference/README.md">https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.8/create-and-configure-apis/configure-v4-apis/entrypoints/broken-reference/README.md</a></td></tr><tr><td></td><td><a href="websocket.md">WebSocket</a></td><td></td><td><a href="https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.8/create-and-configure-apis/configure-v4-apis/entrypoints/broken-reference/README.md">https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.8/create-and-configure-apis/configure-v4-apis/entrypoints/broken-reference/README.md</a></td></tr><tr><td></td><td><a href="webhook.md">Webhook</a></td><td></td><td><a href="https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.8/create-and-configure-apis/configure-v4-apis/entrypoints/broken-reference/README.md">https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.8/create-and-configure-apis/configure-v4-apis/entrypoints/broken-reference/README.md</a></td></tr><tr><td></td><td><a href="server-sent-events.md">Server-sent Events</a></td><td></td><td><a href="https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.8/create-and-configure-apis/configure-v4-apis/entrypoints/broken-reference/README.md">https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.8/create-and-configure-apis/configure-v4-apis/entrypoints/broken-reference/README.md</a></td></tr></tbody></table>
