...
2.  Click your API that you created in [create-an-api.md](create-an-api.md "mention").
    ...
    <figure><img src="../../.gitbook/assets/how-to-guides-first-api-add-a-polic-321.png" alt=""><figcaption></figcaption></figure>
3.  Click **Policies**.
...
11. In the **Deploy your API** pop-up window, click **Deploy**.
    ...
    <figure><img src="../../.gitbook/assets/how-to-guides-first-api-add-a-polic-322.png" alt=""><figcaption></figcaption></figure>
