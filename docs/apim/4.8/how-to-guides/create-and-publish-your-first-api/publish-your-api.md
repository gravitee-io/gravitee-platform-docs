...
2.  Click the API that you created in [create-an-api.md](create-an-api.md "mention").
    ...
    <figure><img src="../../.gitbook/assets/49-expose-apim-as-an-mcp-server-333.png" alt=""><figcaption></figcaption></figure>
...
4.  In the **Publish API** pop-up window, click **Publish**. Your API is now published to the Developer Portal.
    ...
    <figure><img src="../../.gitbook/assets/49-expose-apim-as-an-mcp-server-334.png" alt=""><figcaption></figcaption></figure>
...
2.  In the Developer Portal, click **Explore APIS.**
    ...
    <figure><img src="../../.gitbook/assets/49-expose-apim-as-an-mcp-server-335.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/49-expose-apim-as-an-mcp-server-336.png" alt=""><figcaption></figcaption></figure>
