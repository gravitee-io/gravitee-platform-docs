...
2.  Click the API that you created in [create-an-api.md](create-an-api.md "mention").
    ...
    <figure><img src="../../.gitbook/assets/how-to-guides-first-api-add-api-doc-326.png" alt="The APIs list filtered by a saved search, with APIs highlighted in the left navigation and one API listed."><figcaption></figcaption></figure>
...
4.  Click **Documentation Pages**, and then click **Add new page**.
    ...
    <figure><img src="../../.gitbook/assets/how-to-guides-first-api-add-api-doc-327.png" alt="The Documentation Pages tab of an API, empty, with Add new folder and Add new page buttons."><figcaption></figcaption></figure>
5.  From the **Add new page** dropdown menu, click Markdown.

    <figure><img src="../../.gitbook/assets/how-to-guides-first-api-add-api-doc-328.png" alt="The Documentation Pages tab with the Add new page menu open, offering Markdown, OpenAPI, AsyncAPI, and AsciiDoc."><figcaption></figcaption></figure>
...
7.  In the **Visibility** section, Click **Public**, and then click **Next**.
    ...
    <figure><img src="../../.gitbook/assets/how-to-guides-first-api-add-api-doc-329.png" alt="The Configure page step of the documentation page wizard, with a page name entered and Public visibility selected over Private."><figcaption></figcaption></figure>
