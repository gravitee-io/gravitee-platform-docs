---
description: Create and manage Kafka clusters from the Kafka UI in the API Management 4.8 Console. Follow the steps to configure a cluster.
hidden: true
noIndex: true
---
...
3.  Click **+ Add cluster**.
    ...
    <figure><img src="../.gitbook/assets/902A4021-EA90-4AB6-84B4-C0F9E995F54E_1_201_a.jpeg" alt="The Kafka Clusters page with the Add cluster button highlighted, listing one cluster with its bootstrap server masked, SASL_SSL security, and last updated time."><figcaption></figcaption></figure>
