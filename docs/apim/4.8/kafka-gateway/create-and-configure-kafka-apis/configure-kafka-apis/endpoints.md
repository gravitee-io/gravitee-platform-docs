...
<figure><img src="../../../.gitbook/assets/A 11 endpoint (1).png" alt="The Endpoints page of a Kafka API, showing a default broker group with one endpoint and an Edit button."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/A 11 endpoint3 (1).png" alt="The endpoint group editor with the General tab selected, showing the group name field."><figcaption></figcaption></figure>

By selecting the **Configuration** tab, you can edit the security settings of your Kafka endpoint group.

<figure><img src="../../../.gitbook/assets/A 11 endpoint4 (1).png" alt="The endpoint group editor with the Configuration tab selected, showing the security protocol set to PLAINTEXT."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/A 11 endpoint1 (1).png" alt="The endpoint editor with the General tab selected, showing the endpoint name and a placeholder bootstrap servers value."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/A 11 endpoint2 (1).png" alt="The endpoint editor with the Configuration tab selected and Inherit configuration from the endpoint group switched on, leaving the security protocol read-only."><figcaption></figcaption></figure>
