...
<figure><img src="../../../.gitbook/assets/A 11 policy 1 (1).png" alt=""><figcaption></figcaption></figure>
...
3.  Click **Create**.
    ...
    <figure><img src="../../../.gitbook/assets/A 11 policy 0 (1).png" alt=""><figcaption></figcaption></figure>
4.  In the Flow details panel, select the **Global** header to add a policy to the **Interact** phase of the Kafka API transaction.

    <figure><img src="../../../.gitbook/assets/A 11 policy 2 (1).png" alt=""><figcaption></figcaption></figure>
    ...
    <figure><img src="../../../.gitbook/assets/A 11 policy 3 (1).png" alt=""><figcaption></figcaption></figure>

    Fill out the policy configuration details and click **Add policy**.

    <figure><img src="../../../.gitbook/assets/AAA policy (1).png" alt=""><figcaption></figcaption></figure>
5.  In the Flow details panel, select the **Event messages** header to add a policy to the **Publish** and/or **Subscribe** phase of the Kafka API transaction.
    ...
    <figure><img src="../../../.gitbook/assets/A 11 policy 4 (1).png" alt=""><figcaption></figcaption></figure>

    Select the [Kafka Quota](../../../create-and-configure-apis/apply-policies/policy-reference/kafka-quota.md) policy.

    <figure><img src="../../../.gitbook/assets/A 11 policy 5 (1).png" alt=""><figcaption></figcaption></figure>

    Fill out the policy configuration details and click **Add policy**.

    <figure><img src="../../../.gitbook/assets/AAB policy (1).png" alt=""><figcaption></figcaption></figure>
