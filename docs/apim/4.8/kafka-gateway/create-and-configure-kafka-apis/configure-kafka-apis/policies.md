...
<figure><img src="../../../.gitbook/assets/A 11 policy 1 (1).png" alt="The Policies page of a native Kafka API, listing a default keyless flow and a Common group, with no flows yet selected."><figcaption></figcaption></figure>
...
3.  Click **Create**.
    ...
    <figure><img src="../../../.gitbook/assets/A 11 policy 0 (1).png" alt="The Create a new flow dialog for a native API, with a flow name entered and a note that only one flow is allowed."><figcaption></figcaption></figure>
4.  In the Flow details panel, select the **Global** header to add a policy to the **Interact** phase of the Kafka API transaction.

    <figure><img src="../../../.gitbook/assets/A 11 policy 2 (1).png" alt="The Policies page with a new flow selected, showing the Connect phase marked coming soon and an empty Interact phase between the client and the broker."><figcaption></figcaption></figure>
    ...
    <figure><img src="../../../.gitbook/assets/A 11 policy 3 (1).png" alt="The Policies for Interact phase dialog, offering the Kafka ACL and Kafka Topic Mapping policies."><figcaption></figcaption></figure>

    Fill out the policy configuration details and click **Add policy**.

    <figure><img src="../../../.gitbook/assets/AAA policy (1).png" alt="The Policies page with a Kafka Topic Mapping policy added to the Interact phase of the selected flow."><figcaption></figcaption></figure>
5.  In the Flow details panel, select the **Event messages** header to add a policy to the **Publish** and/or **Subscribe** phase of the Kafka API transaction.
    ...
    <figure><img src="../../../.gitbook/assets/A 11 policy 4 (1).png" alt="The Event messages tab of a flow, showing empty Publish and Subscribe phases between the client and the broker."><figcaption></figcaption></figure>

    Select the [Kafka Quota](../../../create-and-configure-apis/apply-policies/policy-reference/kafka-quota.md) policy.

    <figure><img src="../../../.gitbook/assets/A 11 policy 5 (1).png" alt="The Policies for Publish phase dialog, offering the Kafka Quota policy."><figcaption></figcaption></figure>

    Fill out the policy configuration details and click **Add policy**.

    <figure><img src="../../../.gitbook/assets/AAB policy (1).png" alt="The Event messages tab with a Kafka Quota policy added to the Publish phase of the selected flow."><figcaption></figcaption></figure>
