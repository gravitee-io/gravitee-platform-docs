---
description: Configure Kafka APIs from the API Management 4.8 Console, a UI for creating and amending them. Learn what you can change there.
---
...
<figure><img src="../../../.gitbook/assets/A 1 config general copy (1).png" alt="The Configuration page of a Kafka API, with the API menu items highlighted from Configuration through to Deployment."><figcaption></figcaption></figure>
