...
* **Start the API:** Deploy the API to all Gateways, or the Gateways specified using [sharding tags](docs/apim/4.8/configure-and-manage-the-platform/gravitee-gateway/sharding-tags.md)
...
To learn more about these resources and how to add them, refer to the [Resources](docs/apim/4.8/create-and-configure-apis/apply-policies/resources.md) documentation.
