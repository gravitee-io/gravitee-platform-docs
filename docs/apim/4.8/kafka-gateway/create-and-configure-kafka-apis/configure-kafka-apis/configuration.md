---
description: The Configuration section manages high-level settings for a Kafka API in API Management 4.8. Learn what you can customize.
---
...
<figure><img src="../../../.gitbook/assets/A 1 config general (1).png" alt="The General tab of a Kafka API&#x27;s Configuration page, showing name and version fields with empty description, labels and categories, beside the owner and timestamps."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/A 1 notifications 2 (1).png" alt="The New notification dialog, with a notification name entered and the notifier dropdown open on Default Email Notifier and Default Webhook Notifier."><figcaption></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/A 1 config audit logs (1).png" alt="The Audit Logs tab of an API&#x27;s Configuration page, listing dated events such as API updated, plan published, and plan created, with a filter for events and a date range."><figcaption></figcaption></figure>
