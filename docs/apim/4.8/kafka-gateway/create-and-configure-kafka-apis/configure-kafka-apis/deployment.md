...
From the **Configuration** header you can control where your API is deployed through the use of [sharding tags](docs/apim/4.8/configure-and-manage-the-platform/gravitee-gateway/sharding-tags.md). Sharding tags are configured at the Organization level.
...
<figure><img src="../../../../4.6/.gitbook/assets/1 shard 2 (1).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../../4.6/.gitbook/assets/1 deploy 1 (1).png" alt=""><figcaption></figcaption></figure>

Use the checkboxes to select two API definitions you'd like to compare. The comparison is automatically generated.

<figure><img src="../../../../4.6/.gitbook/assets/1 deploy 2 (1).png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../../4.6/.gitbook/assets/1 deploy 3 (1).png" alt=""><figcaption></figcaption></figure>
