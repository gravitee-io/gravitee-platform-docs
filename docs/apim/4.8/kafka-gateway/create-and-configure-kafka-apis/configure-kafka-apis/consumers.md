...
* [oauth2.md](docs/apim/4.8/secure-and-expose-apis/plans/oauth2.md "mention")
* [jwt.md](docs/apim/4.8/secure-and-expose-apis/plans/jwt.md "mention")
* [api-key.md](docs/apim/4.8/secure-and-expose-apis/plans/api-key.md "mention")
* [keyless.md](docs/apim/4.8/secure-and-expose-apis/plans/keyless.md "mention")
