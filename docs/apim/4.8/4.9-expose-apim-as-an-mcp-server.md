...
7.  In the **User details** screen, assign the service account permissions. The AI assistant's capabilities are determined by the permissions you set for the service account.
    ...
    <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info">
      <p>For information about the permissions that you need to set for a specific action, see <a href="management-api-reference.md" title="mention">management-api-reference.md</a>.</p>
    </div>
...
11. Click **Generate**.
    ...
    <figure><img src=".gitbook/assets/49-expose-apim-as-an-mcp-server-324.png" alt=""><figcaption></figcaption></figure>
...
13. Click **Close**.
    ...
    <div data-gb-custom-block data-tag="hint" data-style="warning" class="hint hint-warning">
      <p>You cannot view your token after you click <strong>Close.</strong></p>
    </div>
