---
description: Install the API Management 4.8 MCP Server so AI clients can call your platform. Follow the steps to install it and create a service account token.
hidden: true
noIndex: true
---
...
6.  In the **Users** screen, click the service account that you created.
    ...
    <figure><img src=".gitbook/assets/49-expose-apim-as-an-mcp-server-338.png" alt="The organization Users page, listing an administrator and a service account, with the service account row highlighted."><figcaption></figcaption></figure>
7.  In the **User details** screen, assign the service account permissions. The AI assistant's capabilities are determined by the permissions you set for the service account.
    ...
    <figure><img src=".gitbook/assets/49-expose-apim-as-an-mcp-server-339.png" alt="The User details page of a service account, showing its source, organization role, and creation date, the organization and environment roles assigned, and an empty Groups panel."><figcaption></figcaption></figure>
8.  In the **You have unsaved changes** pop-up window, click **Save**.

    <figure><img src=".gitbook/assets/49-expose-apim-as-an-mcp-server-340.png" alt="The detail page of a service account, showing its source, organization role, and creation date, with the environment roles set and an unsaved changes bar offering Save."><figcaption></figcaption></figure>
9.  Navigate to the **Tokens** section, and then click **+ Generate a personal token**.

    <figure><img src=".gitbook/assets/49-expose-apim-as-an-mcp-server-323.png" alt="The detail page of a service account scrolled to the Tokens panel, with the Generate a personal token button highlighted above empty API, application, and token lists."><figcaption></figcaption></figure>
10. In the **Generate a token** pop-up window, enter a name for your token. For example, mcp-server-token.
11. Click **Generate**.

    <figure><img src=".gitbook/assets/hybrid-cloud-docker-docker-cli-324.png" alt="The Generate a token dialog, with a token name entered, over the empty token list."><figcaption></figcaption></figure>
