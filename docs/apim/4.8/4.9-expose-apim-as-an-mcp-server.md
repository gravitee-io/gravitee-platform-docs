...
6.  In the **Users** screen, click the service account that you created.
    ...
    <figure><img src=".gitbook/assets/49-expose-apim-as-an-mcp-server-338.png" alt=""><figcaption></figcaption></figure>
...
8.  In the **You have unsaved changes** pop-up window, click **Save**.
    ...
    <figure><img src=".gitbook/assets/49-expose-apim-as-an-mcp-server-340.png" alt=""><figcaption></figcaption></figure>
9.  Navigate to the **Tokens** section, and then click **+ Generate a personal token**.

    <figure><img src=".gitbook/assets/49-expose-apim-as-an-mcp-server-323.png" alt=""><figcaption></figcaption></figure>
