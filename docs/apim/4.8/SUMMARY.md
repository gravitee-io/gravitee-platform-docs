...
* [Release Notes](overview/release-notes/README.md)
  * [APIM 4.8](overview/release-notes/apim-4.8.md)
  * [APIM 4.7](https://documentation.gravitee.io/apim/overview/release-notes/apim-4.7)
...
* [Changelog](overview/changelog/README.md)
  * [APIM 4.7.x](overview/changelog/apim-4.7.x.md)
...
* [Gateway Resource Sizing Guidelines](install-and-upgrade/gateway-resource-sizing-guidelines.md)
* [Production Sizing Guidelines](install-and-upgrade/production-sizing-guidelines.md)
* [Production Best Practices](install-and-upgrade/production-best-practices/README.md)
  * [Internal APIs](install-and-upgrade/production-best-practices/internal-apis.md)
  * [Deployments](install-and-upgrade/production-best-practices/deployments.md)
  * [Authentication](install-and-upgrade/production-best-practices/authentication.md)
  * [Protections](install-and-upgrade/production-best-practices/protections.md)
  * [General Recommendations](install-and-upgrade/production-best-practices/settings/README.md)
    * [Default APIM Settings](install-and-upgrade/production-best-practices/settings/default-apim-settings.md)
    * [API Design](install-and-upgrade/production-best-practices/settings/api-design.md)
    * [API Review and Quality](install-and-upgrade/production-best-practices/settings/api-review-and-quality.md)
    * [Property Encryption](install-and-upgrade/production-best-practices/settings/property-encryption.md)
    * [Documentation Sanitizer](install-and-upgrade/production-best-practices/settings/documentation-sanitizer.md)
...
* [Configure Kafka APIs](kafka-gateway/configure-kafka-apis/README.md)
  ...
  * [Policies](kafka-gateway/configure-kafka-apis/policies/README.md)
...
* [Debug mode](policies/debug-mode.md)
...
* [Applications](expose-apis/applications/README.md)
  * [Create an Application](expose-apis/applications/create-an-application.md)
