...
6. You can customize the CSS using either of the following options:
   ...
   *   In the **Advanced CSS box**, enter CCS tokens. For example:
       ...
       * For a full list of the available CSS tokens that you can use to customize your New Developer Portal, see [#available-css-tokens](4.9-layout-and-theme.md#available-css-tokens "mention"). \{% endhint %\}### Verification
