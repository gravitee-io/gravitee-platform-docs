...
6. You can customize the CSS using either of the following options:
   ...
   *   In the **Advanced CSS box**, enter CCS tokens. For example:
       ...
       <div data-gb-custom-block data-tag="hint" data-style="info" class="hint hint-info">
         ...
         <li>For a full list of the available CSS tokens that you can use to customize your New Developer Portal, see <a href="4.9-layout-and-theme.md#available-css-tokens" title="mention">#available-css-tokens</a>.</li>
         </ul>
       </div>
### Verification
