...
1.  Click **Applications** from its header menu.\\
    ...
    <figure><img src="../../../4.7/.gitbook/assets/00 apps (1).png" alt=""><figcaption></figcaption></figure>
...
3.  Use the filters to set constraints on which API logs are shown.\\
    ...
    <figure><img src="../../../4.7/.gitbook/assets/00 logs (1).png" alt=""><figcaption></figcaption></figure>
4.  Click the arrow to view the details for a particular log entry. **The Connection Logs** tab shows request and response information, which can be recorded for all APIs. The **Messages** tab is used for message logs, which can only be recorded for v4 message APIs.\\
    ...
    <figure><img src="../../../4.7/.gitbook/assets/00 log (1).png" alt=""><figcaption></figcaption></figure>

{% hint style="warning" %}
The API publisher determines which information is logged for a given API. To configure what information is logged and visible to an API subscriber, see [Modify logging information](docs/apim/4.8/analyze-and-monitor-apis/logging.md#modify-logging-information).
{% endhint %}
