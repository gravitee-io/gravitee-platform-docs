---
description: Trace every request the API Management 4.8 Gateway handles with the Gravitee OpenTelemetry feature. Learn how tracing is set up.
---
...
<figure><img src="../.gitbook/assets/1 otel 1 (1).png" alt="The OpenTelemetry settings of an API, with tracing switched off and the verbose option disabled beneath it."><figcaption></figcaption></figure>
