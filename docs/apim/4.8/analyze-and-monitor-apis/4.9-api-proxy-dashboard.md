...
* You must create a v4 proxy API. For more information about creating a v4 proxy API, see [v4-api-creation-wizard.md](docs/apim/4.8/create-and-configure-apis/create-apis/v4-api-creation-wizard.md "mention").
