...
{% hint style="info" %}
You can obscure the value of this API key by using [configuration-level secrets](docs/apim/4.8/prepare-a-production-environment/sensitive-data-management/apply-secrets-to-configurations.md) in `gravitee.yml`.
{% endhint %}
...
| tenant         | ID of the tenant evaluated for the API (see [tenants](docs/apim/4.8/configure-and-manage-the-platform/gravitee-gateway/tenants.md))                                                                                                                                                                                                                                                                                                                                                                                                                                                |                                                                                              |
