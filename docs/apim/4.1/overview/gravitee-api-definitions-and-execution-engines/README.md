...
The [v2 API Creation Wizard ](docs/apim/4.1/guides/create-apis/how-to/v2-api-creation-wizard.md)creates v2 Gateway APIs compatible with the legacy execution engine that can be augmented with flows designed in the [v2 Policy Studio](docs/apim/4.1/guides/policy-design/v2-api-policy-design-studio.md). The [v4 API Creation Wizard](docs/apim/4.1/guides/create-apis/how-to/v4-api-creation-wizard.md) creates v4 APIs compatible with the reactive execution engine that can be augmented with flows designed in the [v4 Policy Studio](docs/apim/4.1/guides/policy-design/v4-api-policy-design-studio.md).
