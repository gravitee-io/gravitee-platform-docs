...
<figure><img src="../../.gitbook/assets/Access API Quality settings.gif" alt="An animation that opens the API Quality settings, showing quality metrics enabled with weighting fields for description, logo, categories, labels, documentation, and health check."><figcaption><p>Access the API Quality settings</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Enabnle API Quality.gif" alt="An animation that enables API review and API quality metrics on the API Quality settings page, ending with the Save button active."><figcaption><p>Enable API quality metrics and API quality review</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Create custom API quality rule.gif" alt="An animation that creates a custom quality rule, entering a security policy rule name, a description, and a weight, then saving it."><figcaption><p>Create custom API quality rule</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/View quality score.gif" alt="An animation that opens an API&#x27;s general settings and scrolls to its Quality panel, showing a three percent score with the rules met and not met listed beside it."><figcaption></figcaption></figure>
