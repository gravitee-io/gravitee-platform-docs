...
Alternatively, you can configure the [Helm Chart](docs/apim/4.1/getting-started/install-guides/install-on-kubernetes/configure-helm-chart.md) to use a custom role.
{% endhint %}
