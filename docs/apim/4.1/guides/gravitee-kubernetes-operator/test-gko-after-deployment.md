...
* Ensure that `services.sync.kubernetes` is set to `true`. This property is disabled by default, but must be enabled for the Gateway to communicate with a Kubernetes Operator. How the Gateway is deployed determines how the property is configured:
  ...
  * For [other deployment strategies](../../getting-started/install-guides/README.md) (e.g., deployment using a VM), you can update the configuration:
...
{% hint style="info" %}
See the [Configure APIM Gateway](../../getting-started/configuration/the-gravitee-api-gateway/README.md) section for more information on using environment variables in Gateway configurations.
{% endhint %}
...
<figure><img src="../../.gitbook/assets/Screenshot 2023-07-06 at 9.19.26 PM.png" alt="The console Home board showing widget tiles for API and application counts and lifecycle and state pie charts, each with a close icon."><figcaption><p>APIM Console dashboard</p></figcaption></figure>
