...
{% hint style="info" %}
An administrator can create documentation following the process described [here](docs/apim/4.1/guides/developer-portal/advanced-developer-portal-configuration/documentation.md).
{% endhint %}
