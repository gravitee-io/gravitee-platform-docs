...
<figure><img src="../../../../../../.gitbook/assets/dev portal_access (1).png" alt=""><figcaption><p>Access the Developer Portal from the Management Console</p></figcaption></figure>

The homepage will open in a new browser tab:

<figure><img src="../../../../../../.gitbook/assets/dev portal_home (1).png" alt=""><figcaption><p>Sample Developer Portal homepage</p></figcaption></figure>
