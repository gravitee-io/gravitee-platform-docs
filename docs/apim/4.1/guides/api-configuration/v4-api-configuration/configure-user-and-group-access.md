...
<figure><img src="../../../.gitbook/assets/guides-api-configuration-v2-api-configur-39-1.png" alt="The Members tab of an API&#x27;s user and group access page, with the primary owner&#x27;s name blurred and a panel of ten inherited group members below, all names blurred."><figcaption><p>Add members to your API</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/transfer ownership.png" alt="The Transfer ownership tab of an API, with Group selected, an administrator group chosen, and the new role for the current primary owner set to OWNER."><figcaption><p>Transfer API ownership</p></figcaption></figure>
