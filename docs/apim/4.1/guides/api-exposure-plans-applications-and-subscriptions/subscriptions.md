...
<figure><img src="../../.gitbook/assets/api_key_subscripiton_management.png" alt="A subscription&#x27;s detail page showing its identifier, API key plan, accepted status, subscriber, and application, with an API Keys panel listing one active key and a Renew button."><figcaption><p>API key plan subscription</p></figcaption></figure>
