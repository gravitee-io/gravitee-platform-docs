...
<figure><img src="../../.gitbook/assets/client_registration_settings.png" alt="The portal Client Registration settings, with dynamic client registration enabled and Simple, Browser, Web, Native, and Backend-to-Backend application types all ticked."><figcaption><p>Client Registration settings</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/add_dcr_provider.png" alt="The Providers panel of the Client Registration settings, empty, with a message that providers will appear here and a round add button below."><figcaption><p>Add a client registration provider</p></figcaption></figure>

You are presented with the following options when configuring a client registration provider:

<figure><img src="../../.gitbook/assets/client_registration_provider.png" alt="A client registration provider named DCR Example, with a sample description, an OpenID Connect discovery endpoint, and the Client Credentials token provider selected."><figcaption><p>Configure a client registration provider</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/client_credentials_token_provider.png" alt="The client registration provider form with the Client Credentials token provider selected, showing empty client ID, client secret, scopes, and client template fields above a renew-secret option."><figcaption><p>Client credentials token provider</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2023-03-23 at 12.02.08 PM.png" alt="The client registration provider form with the Initial Access Token provider selected, showing an empty initial access token field above the renew-secret option."><figcaption><p>Directly provide initial access token</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/delete_application.png" alt="The OpenID Connect Integration panel of an application, with the client ID and client secret blacked out, the Authorization Code grant selected, and one redirect URI."><figcaption><p>Delete an application</p></figcaption></figure>
