...
\
For more information, see the [JSON Validation policy](docs/apim/4.1/reference/policy-reference/json-validation.md) reference.
{% endtab %}
...
For more information, see the [REST to SOAP policy](docs/apim/4.1/reference/policy-reference/rest-to-soap.md) reference.
{% endtab %}
...
\
For more information, see the [Mock policy](docs/apim/4.1/reference/policy-reference/mock.md) reference.
{% endtab %}

{% tab title="Request Validation" %}
For each operation, `NOT` `NULL` rules are created with query parameters and headers.\
\
For more information, see the [Request Validation policy](docs/apim/4.1/reference/policy-reference/request-validation.md) reference.
{% endtab %}
...
For more information, see the [XML Validation policy](docs/apim/4.1/reference/policy-reference/xml-validation.md) reference.
{% endtab %}
{% endtabs %}
