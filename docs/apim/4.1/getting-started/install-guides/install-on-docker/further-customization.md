...
For more information, about plugin deployment, see [Deployment](docs/apim/4.1/overview/plugins.md#deployment).
...
For more information on the JDBC plugin and drivers, see [JDBC](docs/apim/4.1/getting-started/configuration/configure-repositories/jdbc.md#jdbc).
