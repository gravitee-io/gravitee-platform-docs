...
<figure><img src="../../../4.0/.gitbook/assets/plans_add policy (1).png" alt=""><figcaption><p>Add policy to the response phase of traditional proxy API</p></figcaption></figure>
...
<figure><img src="../../../4.0/.gitbook/assets/plans_add policy subscribe (1).png" alt=""><figcaption><p>Add policy to the subscribe phase of a message proxy API</p></figcaption></figure>
