...
<img src="../../../.gitbook/assets/file.excalidraw (11).svg" alt="A hand-drawn diagram of three external clients calling the gateway through a firewall, the gateway calling a backend service, and the console configuring the gateway." class="gitbook-drawing">
...
<figure><img src="../../../.gitbook/assets/apis_homescreen.png" alt="The APIs list filtered by a saved search, showing eight APIs with their status, context path, owner, definition, and visibility."><figcaption><p>APIs homscreen</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/options.png" alt="The Get started building your API page, offering Create a V4 API from scratch, Build with API Designer, Create a V2 API from scratch, and Import an API definition."><figcaption><p>Options to create a new Gateway API</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/api_details.png" alt="Step 1 of the API creation wizard, with an API name, version number, and description filled in."><figcaption><p>Fill in API details</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/traditional or message.png" alt="Step 2 of the API creation wizard, with neither Proxy Upstream Protocol nor Introspect Messages From Event-Driven Backend selected yet."><figcaption><p>Traditional or message proxy selection</p></figcaption></figure>
...
<table data-card-size="large" data-view="cards"><thead><tr><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><p><strong>Traditional Proxy (Proxy Upstream Protocol)</strong></p><p>Gateway APIs 101 | Proxy backend API servers</p></td><td><a href="traditional-proxy.md">traditional-proxy.md</a></td></tr><tr><td><p><strong>Message Proxy (Introspect Messages From Event-Driven Backend)</strong></p><p>Gateway APIs 101 | Proxy event/message brokers</p></td><td><a href="message-proxy.md">message-proxy.md</a></td></tr></tbody></table>
