...
If you want to use a custom prefix, you need to follow the following [instructions](../configure-repositories/README.md#use-a-custom-prefix).
...
If you want to use a custom prefix, you need to follow the following [instructions](../configure-repositories/README.md#use-a-custom-prefix-1).
