---
description: Install and deploy a complete API Management 4.13 platform on any Kubernetes cluster with a manifest. Follow the steps to do it.
hidden: true
noIndex: true
metaLinks:
  alternates:
    - deploy-apim-with-kubernetes-manifest.md
---
