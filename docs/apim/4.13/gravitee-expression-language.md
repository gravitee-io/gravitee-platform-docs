---
description: Gravitee Expression Language queries object graphs to configure API Management 4.13 policies dynamically. Learn the syntax and expression markers.
---
