---
description: Set up and manage roles, scopes, permissions and users in API Management 4.13. Follow the steps to configure your organization.
metaLinks:
  alternates:
    - user-management.md
---
...
| `EXPLORER` | Create, read | Kafka Explorer connections in Gamma Event Stream Management: create a connection or test a draft (create), and list the connections or read the brokers, topics, consumer groups, and messages behind them (read). Editing, deleting, and sharing one connection is governed by its own `EXPLORER` role membership. |
