---
description: Resource recommendations for an API Management 4.13 Gateway instance, based on traffic and deployment context. Learn how to size it.
metaLinks:
  alternates:
...
<figure><img src="../.gitbook/assets/deployments and capacity.png" alt="A diagram contrasting an active/active load balancing setup, where the load balancer sends traffic to both gateways, with an active/passive failover setup, where the second path is dashed." width="563"><figcaption><p>Load balancer</p></figcaption></figure>
