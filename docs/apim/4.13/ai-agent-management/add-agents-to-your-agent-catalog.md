---
description: Add AI agents to your API Management 4.13 Agent Catalog by importing or discovering their Agent Cards. Follow the steps to create an integration.
metaLinks:
  alternates:
...
5.  Click **Create Integration**.
    ...
    <figure><img src="../.gitbook/assets/ai-agent-management-add-agents-to-your-a-282-1.png" alt="The Enter Information step of the Create Integration wizard, with a name and a well-known URL entered and an empty description."><figcaption></figcaption></figure>
...
1.  From the **Dashboard**, click **Integrations**.
    ...
    <figure><img src="../.gitbook/assets/ai-agent-management-add-agents-to-your-a-283-1.png" alt="The console dashboard with Integrations highlighted in the left navigation, showing API and application totals and lifecycle and state pie charts."><figcaption></figcaption></figure>
