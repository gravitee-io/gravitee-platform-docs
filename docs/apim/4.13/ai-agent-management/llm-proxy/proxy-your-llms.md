---
description: An API Management 4.13 LLM proxy exposes an OpenAI-compatible API you can plug into any compatible client. Follow the steps to proxy your LLM.
---
