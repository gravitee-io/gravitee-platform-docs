---
description: Set the target URL when an API Management 4.13 LLM proxy endpoint uses the OpenAI-compatible provider. Follow the steps to verify the target.
---
