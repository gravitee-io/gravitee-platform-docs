---
description: Route an API Management 4.13 LLM proxy request to a different model without changing the client. Follow the steps to add the Assign attributes policy.
---
