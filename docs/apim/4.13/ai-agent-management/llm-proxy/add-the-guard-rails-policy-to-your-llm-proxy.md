---
description: The Guard Rails policy evaluates prompts on an API Management 4.13 LLM proxy for unsafe content. Follow the steps to add it and create a resource.
---
