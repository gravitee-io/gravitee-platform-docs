---
description: Install a fully self-hosted API Management 4.13 with Docker Compose. Follow the steps to download the compose file and verify the stack.
metaLinks:
  alternates:
...
* **(Enterprise Edition only)** Obtain a license key. For more information about Enterprise Edition, see [enterprise-edition.md](../introduction/enterprise-edition.md "mention").
