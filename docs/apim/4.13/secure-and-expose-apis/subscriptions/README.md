---
description: A subscription is how an API Management 4.13 publisher controls who uses their API and on what terms. Learn how subscriptions work.
metaLinks:
  alternates:
    - ./
---
