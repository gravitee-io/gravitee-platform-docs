---
description: Filter the list of APIs that appear in the API Management 4.13 Console. Follow the steps to search, and see the worked search examples.
metaLinks:
  alternates:
...
*   In the **Search** field, type the API field that you want to search for. Here is a list of API fields that you can search for:
    ...
    * Owner
    ...
    <figure><img src="../../.gitbook/assets/3AE562B9-9783-444B-8E6A-698E54BC78C8_4_5005_c.jpeg" alt="The APIs list with the search field highlighted, filtered by a term that matches 21 APIs shown with their type, status, tags, categories, and owner."><figcaption></figcaption></figure>
...
*   **Portal Visibility.** This maps to if your API is set to public or private in your Developer Portal.
    ...
    <figure><img src="../../.gitbook/assets/25C6D5D9-187B-46B6-BDEA-9402B5B8B9B4_1_201_a (1).jpeg" alt="The APIs list with the filter row highlighted, showing API Type, API Status, Sharding Tags, Categories, Portal Status, and Portal Visibility dropdowns above 2,942 APIs."><figcaption></figcaption></figure>
...
1.  From the **APIs** screen, click the **plus (+)**.
    ...
    <figure><img src="../../.gitbook/assets/DC25467C-F821-4CD6-96D8-087711201B17_4_5005_c.jpeg" alt="The APIs list with the column-picker plus icon highlighted at the right of the table header."><figcaption></figcaption></figure>
...
3.  Click **Apply**. The selection is saved in your browser storage.
    ...
    <figure><img src="../../.gitbook/assets/A78E227F-82D4-4792-8367-BA5F7F68790D_1_201_a.jpeg" alt="The APIs list with the column picker open, listing API Type, API Status, Access, Quality, Sharding Tags, Categories, Owner, Portal Status, and Portal Visibility all ticked, with an Apply button."><figcaption></figcaption></figure>
