---
description: Create a Redis cache resource for API Management 4.13 Cache and Data Cache policies. Follow the steps for per-resource and Sentinel settings.
---
