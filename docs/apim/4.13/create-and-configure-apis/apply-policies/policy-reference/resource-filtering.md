---
description: The Resource Filtering policy restricts or allows access to specific REST resources in API Management 4.13. Learn how to configure it.
metaLinks:
  alternates:
...
<figure><img src="../../../.gitbook/assets/config-apis-apply-policies-policy-r-179.png" alt="The resource filtering policy configuration open over the Policies page, with a trigger condition on a JWT scope claim and a blacklist rule covering all paths and every HTTP method."><figcaption><p>Screenshot of the Resource Filtering policy - if the authenticated user doesn't have the required scope, then blacklist all endpoint paths</p></figcaption></figure>
