---
description: The Basic Authentication policy manages basic auth headers on API Management 4.13 calls and compares credentials. Learn how to configure it.
metaLinks:
  alternates:
