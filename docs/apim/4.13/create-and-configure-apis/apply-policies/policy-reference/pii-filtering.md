---
description: The PII Filtering policy detects and redacts personally identifiable information in API Management 4.13 using token classification. Learn how.
---
