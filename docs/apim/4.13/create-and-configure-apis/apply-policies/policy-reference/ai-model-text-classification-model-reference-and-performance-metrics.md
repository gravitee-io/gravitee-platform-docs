---
description: The toxicity and prompt injection models available to API Management 4.13 text classification, with their performance metrics. Compare the models.
---
