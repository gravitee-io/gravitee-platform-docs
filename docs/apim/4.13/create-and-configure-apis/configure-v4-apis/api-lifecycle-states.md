---
description: A v4 API lifecycle state controls its visibility on the API Management 4.13 Developer Portal. Learn the allowed transitions and retirement flow.
---
