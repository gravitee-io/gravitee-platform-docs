---
description: Add documentation to a v4 API from the API Management 4.13 Console so consumers know how to use it. Follow the steps to add pages and folders.
metaLinks:
  alternates:
    - documentation.md
---
...
1.  Click **OpenAPI in Developer Portal**
    ...
    <figure><img src="../../.gitbook/assets/docs_open api 1.png" alt="The Pages tab of an API&#x27;s documentation, with the Open API in Developer Portal button circled."><figcaption><p>OpenAPI in Developer Portal</p></figcaption></figure>
