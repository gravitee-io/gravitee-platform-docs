---
description: Historical analytics survive when you migrate an API Management 4.13 HTTP proxy API from v2 to v4. Follow the steps to update existing indices.
---
