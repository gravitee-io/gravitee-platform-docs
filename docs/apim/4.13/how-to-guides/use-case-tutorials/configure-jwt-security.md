---
description: Apply JSON Web Token security to your API Management 4.13 APIs. Follow the steps to configure the gateway APIs and the plan.
metaLinks:
  alternates:
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-co-189.png" alt="The Plans tab of an API with the Add new plan menu open, offering OAuth2, JWT, API Key, and Keyless plan types."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-5-1-1-1-1.png" alt="The JWT authentication configuration step of plan creation, with the signature set to RSA_RS256 above the JWKS resolver options."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides-use-case-tutorials-configu-6-1-1-1.png" alt="The JWT authentication configuration step, with the resolver set to JWKS_URL and a resolver parameter built from an expression-language variable."><figcaption></figcaption></figure>
