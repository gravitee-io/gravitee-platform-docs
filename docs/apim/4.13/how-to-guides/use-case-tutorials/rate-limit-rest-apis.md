...
3.  Select **Policies** from the inner left nav
    ...
    **Flows vs. policies** Flows are a collection of policies. Flows can be specified for each individual plan, e.g., API Key (SILVER), API Key (GOLD), and API Key (PLATINUM). Alternatively, a common flow can be applied to all plans within the specific AP&#x49;_._<br>
    ...
    <figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-ra-194.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/haley 2.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/haley 3.png" alt=""><figcaption></figcaption></figure>

5. Use the search bar or scroll to navigate to the **Quota** policy, then click **Select**.

<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-rate-li-29-2-1.png" alt=""><figcaption></figcaption></figure>

6.  Toggle **Add response headers** ON and click **Save**.<br>

    <figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-ra-195.png" alt=""><figcaption></figcaption></figure>
7.  Enter values for **Max requests (static)**_,_ **Time duration**, and **Time unit**, e.g., 100 requests per 1 month<br>

    <figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-ra-196.png" alt=""><figcaption></figcaption></figure>
8. Click **Add policy**
9.  On the **Policies** page, click **Save**<br>

    <figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-ra-197.png" alt=""><figcaption></figcaption></figure>
10. Click **Deploy API** to redeploy the API and have the changes take effect<br>

    <figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-ra-198.png" alt=""><figcaption></figcaption></figure>
...
2.  Modify the flow name, operator, path, methods, and conditions as desired (leaving name and path blank will apply default values)<br>
    ...
    <figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-ra-199.png" alt=""><figcaption></figcaption></figure>
3. Click **Create**
4.  Select the **+** icon within the request phase section. This lets us use the Rate Limit policy to limit the number of requests any API consumer can make to the API within a short period of time.<br>
    ...
    <figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-ra-200.png" alt=""><figcaption></figcaption></figure>
5.  Use the search bar or scroll to navigate to the **Rate Limit** policy, then click **Select**<br>

    <figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-ra-201.png" alt=""><figcaption></figcaption></figure>
6.  Enter values for **Max requests (static)**_,_ **Time duration**, and **Time unit**, e.g., 5 requests per 1 second
    ...
    <figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-ra-202.png" alt=""><figcaption></figcaption></figure>
7. Click **Add policy**
8. On the **Policies** page, click **Save**

<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-rate-li-38-2-1.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-rate-li-41-1-1.png" alt=""><figcaption></figcaption></figure>

5. Use the search bar or scroll to navigate to the **Rate Limit** policy, then click **Select**

<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-rate-li-42-1-1.png" alt=""><figcaption></figcaption></figure>

6. Enter values for **Max requests (static)**_,_ **Time duration**, and **Time unit**, e.g., 100 requests per 1 second

<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-rate-li-43-1-1.png" alt=""><figcaption></figcaption></figure>

7. Click **Add policy**
8. On the **Policies** page, click **Save**

<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-rate-li-44-1-1.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-rate-li-45-2-1.png" alt=""><figcaption></figcaption></figure>

3. Click **API Key**
4.  Enter a plan **Name**, **Description** (optional), and modify **Subscriptions** and **Access-Control** (optional)<br>

    <figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-ra-208.png" alt=""><figcaption></figcaption></figure>
5. Click **Next**, then optionally propagate the API Key to upstream API or add a selectional rule

<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-rate-li-47-2-1.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-rate-li-48-2-1.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-rate-li-49-2-1.png" alt=""><figcaption></figcaption></figure>

9. Click **Add plan**
10. Add additional plans or select **Validate my plans** to continue with the API creation process

<figure><img src="../../.gitbook/assets/how-to-guides/use-case-tutorials/rate-limit-rest-apis/how-to-guides-use-case-tutorials-rate-li-50-2-1.png" alt=""><figcaption></figcaption></figure>
