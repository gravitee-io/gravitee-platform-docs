---
description: Establish a Server-Sent Events channel and consume messages through API Management 4.13. Follow the steps to identify and connect an endpoint.
metaLinks:
  alternates:
