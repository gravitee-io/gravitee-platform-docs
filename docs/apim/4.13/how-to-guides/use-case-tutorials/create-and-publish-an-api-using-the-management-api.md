---
description: Create and publish an HTTP proxy API through the Management API in API Management 4.13. Follow the steps from access token to published API.
metaLinks:
  alternates:
...
Your API must have at least one Security/Consumer [Plan](../../secure-and-expose-apis/plans/README.md) associated with it before it can be deployed to a Gateway. For more information about Plans, see [broken-reference](../../../4.9/how-to-guides/use-case-tutorials/broken-reference/ "mention"). The following procedure explains how to create a `KEYLESS` plan.
