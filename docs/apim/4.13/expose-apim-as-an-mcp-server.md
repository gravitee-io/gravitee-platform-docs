---
description: Install the API Management 4.13 MCP Server so AI clients can call your platform. Follow the steps to install it and create a service account token.
metaLinks:
  alternates:
