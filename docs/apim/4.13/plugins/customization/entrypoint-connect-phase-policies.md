---
description: The Entrypoint Connect phase runs when a client opens a native Kafka connection to the API Management 4.13 Gateway. Learn how to interrupt one.
---
