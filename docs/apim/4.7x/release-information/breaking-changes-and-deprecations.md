...
Particular plugins are only available to enterprise customers. [See Gravitee APIM Enterprise Edition](../introduction/apim-enterprise-edition.md) for additional information.
