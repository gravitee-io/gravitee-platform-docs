...
{% hint style="info" %}
For a detailed description of Gravitee Enterprise Edition, see [open-source-vs-enterprise-edition.md](../introduction/open-source-vs-enterprise-edition.md "mention").
{% endhint %}
