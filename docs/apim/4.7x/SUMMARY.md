...
* [Introduction](README.md)
  ...
  * [Release Notes](introduction/release-notes/README.md)
    * [APIM 4.7](introduction/release-notes/apim-4.7.md)
  ...
  * [Changelog](introduction/changelog/README.md)
    * [APIM 4.7.x](introduction/changelog/apim-4.7.x.md)
  ...
  * [Breaking Changes & Deprecations](introduction/breaking-changes-and-deprecations.md)
  * [Community](introduction/community/README.md)
    * [Community Forum](introduction/community/community-forum.md)
    * [Contribute to APIM](introduction/community/contribute-to-apim.md)
* [Getting Started](getting-started/README.md)
  * [Gateway Resource Sizing Guidelines](getting-started/gateway-resource-sizing-guidelines.md)
...
* [Hybrid Installation & Configuration Guides](hybrid-installation-and-configuration-guides/README.md)
  ...
  * [Classic Cloud](hybrid-installation-and-configuration-guides/classic-cloud/README.md)
    ...
    * [Configure Redis](hybrid-installation-and-configuration-guides/classic-cloud/configure-redis.md)
    * [Configure Logstash](hybrid-installation-and-configuration-guides/classic-cloud/configure-logstash.md)
    * [Configure Fluentd](hybrid-installation-and-configuration-guides/classic-cloud/configure-fluentd.md)
    * [Configure Alert Engine](hybrid-installation-and-configuration-guides/classic-cloud/configure-alert-engine.md)
  * [Multi-tenancy](hybrid-installation-and-configuration-guides/multi-tenancy.md)
  * [Cloud Certificate Renewal](hybrid-installation-and-configuration-guides/cloud-certificate-renewal.md)
* [Self-Hosted Installation Guides](self-hosted-installation-guides/README.md)
  ...
  * [RPM](self-hosted-installation-guides/rpm/README.md)
    * [Quick install](self-hosted-installation-guides/rpm/quick-install.md)
    * [Manual install](self-hosted-installation-guides/rpm/manual-install.md)
...
* [Create & Configure APIs](create-and-configure-apis/README.md)
  ...
  * [Configure v2 APIs](create-and-configure-apis/configure-v2-apis/README.md)
    ...
    * [Load-balancing, Failover, and Health-checks](create-and-configure-apis/configure-v2-apis/load-balancing-failover-and-health-checks.md)
...
* [Secure & Expose APIs](secure-and-expose-apis/README.md)
  ...
  * [Applications](secure-and-expose-apis/applications/README.md)
    ...
    * [Metadata](secure-and-expose-apis/applications/metadata.md)
...
* [Kafka Gateway](kafka-gateway/README.md)
  ...
  * [Create & Configure Kafka APIs](kafka-gateway/create-and-configure-kafka-apis/README.md)
    ...
    * [Configure Kafka APIs](kafka-gateway/create-and-configure-kafka-apis/configure-kafka-apis/README.md)
      ...
      * [Policies](kafka-gateway/create-and-configure-kafka-apis/configure-kafka-apis/policies/README.md)
...
* [Prepare a Production Environment](prepare-a-production-environment/README.md)
  * [Production Sizing Guidelines](prepare-a-production-environment/production-sizing-guidelines.md)
...
* [Customize Plugins](customize-plugins/README.md)
  * [Deployment](customize-plugins/deployment.md)
  * [Customization](customize-plugins/customization.md)
