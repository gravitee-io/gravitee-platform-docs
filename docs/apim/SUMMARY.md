...
* [Policy Reference](reference/policy-reference/README.md)
  ...
  * [Override HTTP Method](reference/policy-reference/template-policy-rework-structure-1.md)
  ...
  * [Assign Attributes](<reference/policy-reference/template-policy-rework-structure-1 (1) (1).md>)
  * [Assign Metrics](<reference/policy-reference/template-policy-rework-structure-1 (1).md>)
