...
* [Policy Reference](reference/policy-reference/README.md)
  ...
  * [Assign Attributes](reference/policy-reference/template-policy-rework-structure-1.md)
  * [API Key](reference/policy-reference/api-key.md)
  * [Assign Metrics](reference/policy-reference/template-policy-rework-structure-2.md)
  * [Cache](reference/policy-reference/template-policy-rework-structure-3.md)
  * [Circuit Breaker](reference/policy-reference/template-policy-rework-structure-4.md)
  * [Data Logging Masking](reference/policy-reference/template-policy-rework-structure-5.md)
  * [Message Filtering](reference/policy-reference/message-filtering.md)
  * [Copy of Template Policy - Rework Structure](reference/policy-reference/template-policy-rework-structure-6.md)
  ...
  * [Groovy](reference/policy-reference/template-policy-rework-structure-8.md)
  * [HTTP Callout](reference/policy-reference/template-policy-rework-structure-9.md)
  * [HTTP Signature](reference/policy-reference/template-policy-rework-structure-10.md)
  * [IP filtering](reference/policy-reference/template-policy-rework-structure-11.md)
  * [JSON Threat Protection](reference/policy-reference/template-policy-rework-structure-12.md)
  * [JSON Validation](reference/policy-reference/template-policy-rework-structure-13.md)
  * [JSON Web Signature (JWS)](reference/policy-reference/template-policy-rework-structure-14.md)
  * [JSON Web Token (JWT)](reference/policy-reference/template-policy-rework-structure-15.md)
