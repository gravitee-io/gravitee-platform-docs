...
* [Configuration](getting-started/configuration/README.md)
  ...
  * [Configure Authentication](getting-started/configuration/configure-authentication/README.md)
    * [Connect with In-Memory Users](getting-started/configuration/configure-authentication/connect-with-in-memory-users.md)
    * [Connect with LDAP/Active Directory](getting-started/configuration/configure-authentication/connect-with-ldap-active-directory.md)
    * [Connect with APIM Repository](getting-started/configuration/configure-authentication/connect-with-apim-repository.md)
    * [Connect with Gravitee.io Access Management](getting-started/configuration/configure-authentication/connect-with-gravitee.io-access-management.md)
    * [Connect with GitHub](getting-started/configuration/configure-authentication/connect-with-github.md)
    * [Connect with Google](getting-started/configuration/configure-authentication/connect-with-google.md)
    * [Connect with Keycloak](getting-started/configuration/configure-authentication/connect-with-keycloak.md)
...
* [Release Notes](releases-and-changelog/release-notes.md)
  * [APIM 4.x (2023-07-20)](releases-and-changelog/release-notes/gravitee-4.x/README.md)
    ...
    * [Page 1](releases-and-changelog/release-notes/gravitee-4.x/page-1.md)
