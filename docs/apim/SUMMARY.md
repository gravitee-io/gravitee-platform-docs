...
* [Policy Reference](reference/policy-reference/README.md)
  ...
  * [New Override HTTP Method](reference/policy-reference/template-policy-rework-structure-1.md)
  ...
  * [Assign Attributes](reference/policy-reference/template-policy-rework-structure-2.md)
  * [Assign Metrics](reference/policy-reference/template-policy-rework-structure-3.md)
  ...
  * [Mock](reference/policy-reference/template-policy-rework-structure-7.md)
  * [Transform Headers](reference/policy-reference/template-policy-rework-structure-8.md)
  * [Dynamic Routing](reference/policy-reference/dynamic-routing.md)
  * [Generate JWT](reference/policy-reference/template-policy-rework-structure-9.md)
  ...
  * [XML Threat Protection](reference/policy-reference/template-policy-rework-structure-16.md)
  * [JSON Validation](reference/policy-reference/template-policy-rework-structure-17.md)
  * [JSON to JSON](reference/policy-reference/template-policy-rework-structure-18.md)
  ...
  * [OAuth2](reference/policy-reference/template-policy-rework-structure-22.md)
  * [OpenID Connect UserInfo](reference/policy-reference/template-policy-rework-structure-23.md)
  * [Rate Limit](reference/policy-reference/template-policy-rework-structure-24.md)
  * [Regex Threat Protection](reference/policy-reference/template-policy-rework-structure-25.md)
  * [Request Content Limit](reference/policy-reference/template-policy-rework-structure-26.md)
  * [Resource Filtering](reference/policy-reference/template-policy-rework-structure-27.md)
  * [REST to SOAP](reference/policy-reference/template-policy-rework-structure-28.md)
  * [Retry](reference/policy-reference/template-policy-rework-structure-29.md)
  * [Role-based Access Control (RBAC)](reference/policy-reference/template-policy-rework-structure-30.md)
  * [SSL Enforcement](reference/policy-reference/template-policy-rework-structure-31.md)
  * [Traffic Shadowing](reference/policy-reference/template-policy-rework-structure-32.md)
  * [Transform Query Parameters](reference/policy-reference/template-policy-rework-structure-33.md)
  * [Request Validation](reference/policy-reference/template-policy-rework-structure-34.md)
  * [XML Validation](reference/policy-reference/template-policy-rework-structure-35.md)
  * [XSLT](reference/policy-reference/template-policy-rework-structure-36.md)
