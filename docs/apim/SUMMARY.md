...
* [Policy Reference](reference/policy-reference/README.md)
  ...
  * [JSON Validation](reference/policy-reference/template-policy-rework-structure-15.md)
  * [JSON to JSON](reference/policy-reference/template-policy-rework-structure-16.md)
  * [JSON Web Signature (JWS)](reference/policy-reference/template-policy-rework-structure-17.md)
  * [JSON Web Token (JWT)](reference/policy-reference/template-policy-rework-structure-18.md)
