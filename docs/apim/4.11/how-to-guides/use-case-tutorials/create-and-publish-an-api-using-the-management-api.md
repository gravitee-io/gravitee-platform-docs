---
description: Create and publish an HTTP proxy API through the Management API in API Management 4.11. Follow the steps from access token to published API.
metaLinks:
  alternates:
