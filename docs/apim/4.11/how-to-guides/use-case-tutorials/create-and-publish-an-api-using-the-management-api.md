...
Your API must have at least one Security/Consumer [Plan](../../secure-and-expose-apis/plans/) associated with it before it can be deployed to a Gateway. For more information about Plans, see [broken-reference](../../../4.9/how-to-guides/use-case-tutorials/broken-reference/ "mention"). The following procedure explains how to create a `KEYLESS` plan.
