---
description: The Message Filtering policy lets a publisher control which messages are streamed to subscribers in API Management 4.11. Learn how to set it.
metaLinks:
  alternates:
