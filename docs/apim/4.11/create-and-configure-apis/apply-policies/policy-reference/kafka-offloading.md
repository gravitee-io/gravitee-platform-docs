---
description: The Kafka Offloading policy controls how message content is offloaded to storage in API Management 4.11. Learn how to configure it.
metaLinks:
  alternates:
    - kafka-offloading.md
---
...
1.  Configure the Azure Blob Storage Resource by adding the following information:
    ...
    * Specify the **container name**.
    ...
    <figure><img src="../../../.gitbook/assets/create-and-configure-apis-apply-policies-263-1.png" alt="The Configure Storage Azure Blob Resource dialog, with a resource name entered and empty connection string and default container name fields."><figcaption></figcaption></figure>
2.  In the Policy Studio, configure the policy with the following information:
    ...
    * Link the policy to the configured **Azure Storage Resource**.
    ...
    <figure><img src="../../../.gitbook/assets/create-and-configure-apis-apply-policies-264-1.png" alt="The Policies for Publish phase dialog configuring message offloading, with the storage resource dropdown open, an offloading header name, and empty header value and size fields."><figcaption></figcaption></figure>
