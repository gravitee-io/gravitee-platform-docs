---
description: Add documentation to a v4 API from the API Management 4.11 Console so consumers know how to use it. Follow the steps to add pages and folders.
metaLinks:
  alternates:
    - documentation.md
---
