---
description: The Kafka endpoint mediates between a Kafka cluster and an HTTP client in API Management 4.11. Follow the steps to set the bootstrap servers.
metaLinks:
  alternates:
    - kafka.md
---
