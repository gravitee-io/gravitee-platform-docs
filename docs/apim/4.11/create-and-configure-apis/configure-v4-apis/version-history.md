---
description: Version History shows a v4 API's deployment history and the JSON definition of each version in API Management 4.11. Follow the steps to view it.
metaLinks:
  alternates:
    - version-history.md
---
