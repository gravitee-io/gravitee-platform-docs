---
description: The Elasticsearch connector for API Management 4.11 uses the HTTP API that Elasticsearch instances expose. Learn how to configure it.
---
...
The Elasticsearch (ES) connector uses the HTTP API exposed by ES instances.
