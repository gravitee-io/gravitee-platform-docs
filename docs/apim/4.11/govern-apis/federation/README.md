---
description: Federation brings APIs from other gateways and brokers into API Management 4.11 for a single catalogue. Learn how it works.
metaLinks:
  alternates:
    - ./
---
...
* [Enable Federation when installing with .zip](../../self-hosted-installation-guides/.zip.md#enable-federation)
{% endhint %}
