---
description: Federate event APIs from the Solace Event Portal into API Management 4.11. Learn how the integration works with an event mesh.
metaLinks:
  alternates:
    - solace.md
---
...
* Install Gravitee API Management version 4.4 or later, with an enterprise license. For more information about Enterprise edition, see[ Enterprise Edition Licensing.](../../../readme/enterprise-edition-licensing.md#license-support)
