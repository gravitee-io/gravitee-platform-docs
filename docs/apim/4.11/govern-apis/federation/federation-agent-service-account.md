---
description: Create a service account so the federation agent can authenticate to your API Management 4.11 installation. Follow the steps.
metaLinks:
  alternates:
...
<figure><img src="../../.gitbook/assets/govern-apis-federation-federation-agent-128-1.png" alt="The Pre-register a user page with Service Account selected and a federation agent service name entered."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/govern-apis-federation-federation-agent-129-1.png" alt="A permissions matrix for a role, with every permission on the integration row ticked and the surrounding rows clear."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/govern-apis-federation-federation-agent-130-1.png" alt="The Generate a token dialog open over a user&#x27;s detail page, with a token name entered."><figcaption></figcaption></figure>
