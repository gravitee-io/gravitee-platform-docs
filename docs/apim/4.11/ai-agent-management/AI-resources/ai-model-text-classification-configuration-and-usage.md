---
description: Configure an API Management 4.11 text classification policy by choosing a model and input sources. Follow the steps and see the known limitations.
---
