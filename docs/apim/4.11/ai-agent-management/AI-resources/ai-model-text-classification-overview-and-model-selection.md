---
description: AI Model Text Classification detects toxic content and prompt injection in API Management 4.11 traffic. Compare the detection models available.
---
