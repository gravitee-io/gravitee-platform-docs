...
![Screenshot showing the template screen](/.gitbook/assets/LLM_Dashboard_template_screen.jpg)
5. (Optional) Change the name of the dashboard and the labels for the dashboard. To change the name of the dashboard and the labels for the dashboard, complete the following sub-steps:
    ...
    ![Screenshot showing dashboard with the edit button visible](/.gitbook/assets/LLM_Dashboard_edit_button.jpg)
    ...
    ![Screenshot showing the edit popup window](/.gitbook/assets/LLM_Dashboard_edit_popup_window.jpg)
6. (Optional) Change the timeframe for the dashboard. To changee the timeframe for the dashboard, compelte the following sub-steps:
    ...
    b. Select a new time frame or select **custom** to enter a custome timeframe. 
     ![Screenshot showing the edit popup window](/.gitbook/assets/LLM_Dashboard_timeframe_dropdown_menu.jpg)

## Verification 
Your dashboard appears in the Dashboard list.
![Screenshot showing the edit popup window](/.gitbook/assets/LLM_Dashboard_dashboard_list.jpg)