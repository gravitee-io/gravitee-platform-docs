---
description: Gateway logging applies to all v4 API Management 4.11 APIs by default. Follow the steps to enable and configure the logging you need.
---
...
<figure><img src="../../.gitbook/assets/analyze-and-monitor-apis-logging-configu-360-1.png" alt="The Duration section of the logging settings, explaining the maximum full-logging duration with the value set to zero."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/analyze-and-monitor-apis-logging-configu-361-1.png" alt="The Audit section of the logging settings, with auditing of log consultation and generation of logging audit events both enabled."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/analyze-and-monitor-apis-logging-configu-362-1.png" alt="The User section of the logging settings, with display of the end user on API logging enabled."><figcaption></figcaption></figure>
