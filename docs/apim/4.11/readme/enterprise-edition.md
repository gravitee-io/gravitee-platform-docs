...
* [AI Semantic Caching](https://download.gravitee.io/#graviteeio-ee/apim/plugins/policies/gravitee-policy-ai-semantic-caching/): Reduces LLM API costs and latency by reusing responses for semantically similar requests using vector embeddings. Requires Gravitee APIM Enterprise Edition.
