---
description: Key API terminology and concepts that make the API Management 4.11 platform easier to use. Learn the fundamentals before you start building.
---
