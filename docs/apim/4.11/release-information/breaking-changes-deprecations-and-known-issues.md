...
**Users with no environment role can access APIs and applications** 
User accounts without a role set in an environment are still able to access APIs and applications.

As a workaround, [steps for workaround]

Track the issue here: [Users with no environment role can access APIs and applications](https://github.com/gravitee-io/issues/issues/11243)
