...
* If no endpoint matches the gateway's tenant after filtering, requests fail with a 503 error—there is no automatic fallback to untagged endpoints unless explicitly defined.
<!-- /PIPELINE:APIM-12498 -->
