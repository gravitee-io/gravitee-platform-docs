...
6.  Configure the general plan settings:
    ...
    * **Groups excluded:** Prevent specified [user groups](../../../4.9/configure-and-manage-the-platform/manage-organizations-and-environments/user-management.md) from accessing this plan
7. Click **Next**
