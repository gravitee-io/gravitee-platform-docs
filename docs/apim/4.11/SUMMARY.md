...
* [Create & Configure APIs](create-and-configure-apis/README.md)
  ...
  * [Apply Policies](create-and-configure-apis/apply-policies/README.md)
    * [AI - Model Text Classification Model](create-and-configure-apis/apply-policies/ai-model-text-classification-model-reference.md)
...
* [AI - Model Text Classification Overview](guides/ai-model-text-classification-overview.md)
  * [AI - Model Text Classification Configuration and Restrictions](guides/ai-model-text-classification-configuration-and-restrictions.md)
