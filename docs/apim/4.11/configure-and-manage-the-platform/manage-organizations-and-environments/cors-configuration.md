---
description: CORS lets a web page request resources from another domain in API Management 4.11. Follow the steps to configure it for your organization.
metaLinks:
  alternates:
...
2.  In the **Settings screen**, navigate to the **CORS** section.
    ...
    <figure><img src="../../.gitbook/assets/configure-and-manage-the-platform-manage-14-1-1.png" alt="The organization CORS settings, with the Allow-Headers field highlighted and a list of permitted headers below the allowed methods."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/configure-and-manage-the-platform-manage-1-1-1-1.png" alt="The organization CORS settings with the Access-Control-Allow-Methods dropdown open, showing GET, DELETE, PATCH, POST, PUT, and OPTIONS all ticked."><figcaption></figcaption></figure>
