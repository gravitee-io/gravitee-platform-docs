---
description: Tenants let an API Management 4.11 API select a backend endpoint per deployment. Learn how the multi-endpoint capability works.
metaLinks:
  alternates:
    - tenants.md
---
...
1.  Navigate to **Organization Settings** and select **Tenants**. Click **Add a tenant** and enter the following information:
    ...
    <figure><img src="../../.gitbook/assets/create-a-tenant-with-key-field.png" alt="The Create a tenant dialog open over the Tenants page, with empty name, key, and description fields, above a list of eight tenants."><figcaption><p>Create a tenant dialog with Name, Key, and Description fields</p></figcaption></figure>
