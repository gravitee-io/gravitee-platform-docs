---
description: Upgrade an API Management 4.9 installation that was installed with RPM packages. Follow the steps to back up your configuration first.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/upgrade-guides/upgrade-with-rpm
---
