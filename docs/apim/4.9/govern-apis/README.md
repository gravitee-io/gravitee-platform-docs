---
description: The API governance features API Management 4.9 offers, from scoring through to federation. Browse what is available to you.
metaLinks:
  alternates:
    - https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/govern-apis
---
