...
2.  In the **Portal** section, click **API Quality**.
    ...
    <figure><img src="../../.gitbook/assets/image%20(220)%20(1).png" alt=""><figcaption></figcaption></figure>
3.  In the **API Score** section, turn on **Enable API Score**.

    <figure><img src="../../.gitbook/assets/image%20(221)%20(1).png" alt=""><figcaption></figcaption></figure>
