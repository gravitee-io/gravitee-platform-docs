---
description: Federation brings APIs from other gateways and brokers into API Management 4.9 for a single catalogue. Learn how it works.
metaLinks:
  alternates:
    - https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/govern-apis/federation
---
