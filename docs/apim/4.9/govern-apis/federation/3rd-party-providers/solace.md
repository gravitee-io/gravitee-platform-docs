---
description: Federate event APIs from the Solace Event Portal into API Management 4.9. Learn how the integration works with an event mesh.
metaLinks:
  alternates:
    - >-
...
1.  From the Dashboard, click **Integrations.**
    ...
    <figure><img src="../../../.gitbook/assets/govern-apis-federation-3rd-party-provide-16-1.png" alt="The API Management console dashboard with Integrations highlighted in the left navigation menu."><figcaption></figcaption></figure>
...
2.  Return to the Gravitee API Management console, refresh the page, and verify that the agent's status is set to **Connected**.<br>
    ...
    <figure><img src="../../../.gitbook/assets/govern-federation-solace-51.png" alt="The Overview page of a connected Solace integration, showing the provider, a connected agent, and a partly masked integration identifier."><figcaption></figcaption></figure>
