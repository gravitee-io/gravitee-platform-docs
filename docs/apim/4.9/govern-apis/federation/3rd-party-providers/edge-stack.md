---
description: Edge Stack is a cloud native API gateway running in Kubernetes, federated into API Management 4.9. Learn how the integration works.
metaLinks:
  alternates:
    - >-
...
6.  Click **Create** **Integration**.
    ...
    <figure><img src="../../../.gitbook/assets/govern-apis-federation-3rd-party-provide-2-1-1.png" alt="The Enter Information step of the Create Integration wizard, with a short name entered and an empty description."><figcaption></figcaption></figure>
