...
metaLinks:
  alternates:
    - /broken/spaces/bGmDEarvnV52XdcOiV8o/pages/irPDNRUAgLWLMFOqrVk8
---
...
*   **API list filters**\
    ...
    <figure><img src="../../.gitbook/assets/release-information-release-notes-a-43.png" alt="The APIs list with the filter row highlighted, showing API Type, API Status, Sharding Tags, Categories, Portal Status, and Portal Visibility dropdowns above the first page of 2,942 APIs."><figcaption></figcaption></figure>
