...
1. [Log in](https://eu.cloud.gravitee.io/) to your Gravitee Cloud account.
    ...
    <figure><img src="../../.gitbook/assets/00 cert cloud (1).png" alt=""><figcaption></figcaption></figure>
2. Select **Settings** from the menu, go to the **Account tokens** page, and then click **Generate Account Token**.

    <figure><img src="../../.gitbook/assets/00 cert generate (1).png" alt=""><figcaption></figcaption></figure>
3.  Give your token a name, and then click **Generate**. Save both your account token and the URL from the **Example** section.
    ...
    <figure><img src="../../.gitbook/assets/00 cert token (1).png" alt=""><figcaption></figcaption></figure>
    ...
    <figure><img src="../../.gitbook/assets/00 cert 01 (1).png" alt=""><figcaption></figcaption></figure>
4. Under the **Authorization** header, use the drop-down menu to select **Bearer Token** as the **Auth Type**, and then enter your account token.
    ...
    <figure><img src="../../.gitbook/assets/00 cert 02 (1).png" alt=""><figcaption></figcaption></figure>
5. Click **Send** to renew your certificate. The certificate is returned in base64.

    <figure><img src="../../.gitbook/assets/00 cert post 2 (1).png" alt=""><figcaption></figcaption></figure>
