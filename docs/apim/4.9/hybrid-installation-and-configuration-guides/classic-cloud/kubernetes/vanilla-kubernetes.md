---
description: Gravitee can use Redis for both caching and rate limiting in a hybrid API Management 4.9 deployment. Follow the steps on Kubernetes.
hidden: true
noIndex: true
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/hybrid-installation-and-configuration-guides/classic-cloud/kubernetes/vanilla-kubernetes
---
