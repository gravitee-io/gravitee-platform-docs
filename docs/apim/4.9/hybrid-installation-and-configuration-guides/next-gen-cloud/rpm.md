---
description: Install a hybrid API Management 4.9 Gateway from the RPM package. Follow the steps for the Linux distribution you are running.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/hybrid-installation-and-configuration-guides/next-gen-cloud/rpm
---
