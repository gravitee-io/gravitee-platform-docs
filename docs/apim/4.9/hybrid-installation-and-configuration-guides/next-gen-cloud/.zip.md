---
description: Install a Next-Gen Cloud hybrid API Management 4.9 deployment from the binary distribution. Follow the steps to set it up.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/hybrid-installation-and-configuration-guides/next-gen-cloud/.zip
---
