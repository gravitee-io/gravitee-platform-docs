---
description: The MongoDB plugin ships in the default API Management 4.9 distribution. Follow the steps to configure MongoDB as your repository.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/prepare-a-production-environment/repositories/mongodb
---
