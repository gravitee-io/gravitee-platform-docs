---
description: The API Management 4.9 Management API exposes both the Console and Developer Portal REST APIs. Learn how to deploy them safely.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/prepare-a-production-environment/production-best-practices/deployments
---
