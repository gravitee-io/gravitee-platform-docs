---
description: API publishers can send notifications about their APIs in API Management 4.9. Learn what notifiers do and how to restrict them.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/prepare-a-production-environment/production-best-practices/general-recommendations/notifiers
---
