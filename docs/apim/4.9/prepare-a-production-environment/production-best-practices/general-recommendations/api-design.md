...
* Enable and configure CORS at the API level. This ensures the best level of security when APIs are consumed by browser-based applications. For more information, see [CORS](docs/apim/4.9/create-and-configure-apis/configure-v4-apis/cors.md).
