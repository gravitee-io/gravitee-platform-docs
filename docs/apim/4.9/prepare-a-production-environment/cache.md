...
APIM also supports the Gravitee [Cache Redis](docs/apim/4.9/create-and-configure-apis/apply-policies/resources.md#cache-redis) resource plugin, based on [Redis](https://redis.io/documentation). This plugin is not in the default distribution, but can be [downloaded](https://download.gravitee.io/#graviteeio-apim/plugins/resources/gravitee-resource-cache-redis/) and deployed with these [instructions](docs/apim/4.9/plugins/deployment.md#deployment).
