...
To configure an OAuth2 plan, you must first create an [OAuth2 client resource](docs/apim/4.9/create-and-configure-apis/apply-policies/resources.md) that represents your OAuth 2.0 authorization server.
