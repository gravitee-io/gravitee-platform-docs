---
description: A JWT plan secures an API Management 4.9 API with signed claims passed between two parties. Learn how the token is validated.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/secure-and-expose-apis/plans/jwt
---
...
<figure><img src="../../.gitbook/assets/plan_jwt configure.png" alt="The JWT authentication configuration step, with the signature set to RSA_RS256, the resolver set to GIVEN_KEY, authorization header propagation on, and the user claim set to sub."><figcaption></figcaption></figure>
