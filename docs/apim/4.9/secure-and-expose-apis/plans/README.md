...
6.  Configure the general plan settings:
    ...
    * **Sharding tags:** Selectively deploy the plan to particular API Gateways using available [sharding tags](docs/apim/4.9/configure-and-manage-the-platform/gravitee-gateway/sharding-tags.md)
    * **Groups excluded:** Prevent specified [user groups](docs/apim/4.9/configure-and-manage-the-platform/manage-organizations-and-environments/user-management.md) from accessing this plan
7. Click **Next**
...
{% hint style="warning" %}
This workflow only applies to [v4 APIs and v2 APIs in emulation mode](docs/apim/4.9/create-and-configure-apis/gravitee-api-definitions/execution-engine.md#v2-gateway-api-emulation-mode).
{% endhint %}
