...
5.  Click on **Global settings** in the Application menu.\\
    ...
    <figure><img src="../../../4.8/.gitbook/assets/00 groups added to applications 1 (1).png" alt=""><figcaption></figcaption></figure>
...
{% hint style="info" %}
Only users with the required permissions can manage application members. See [User Management](docs/apim/4.9/configure-and-manage-the-platform/manage-organizations-and-environments/user-management.md).
{% endhint %}
...
5.  In the **Danger Zone**, click **Delete** \\
    ...
    <figure><img src="../../../4.8/.gitbook/assets/00 groups added to applications 2 (1).png" alt=""><figcaption></figcaption></figure>
