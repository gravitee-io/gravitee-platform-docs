...
3.  From the Organization navigation menu, select **Users**, and then click **Add user**.
    ...
    <figure><img src="../.gitbook/assets/01 (1) (1).png" alt=""><figcaption></figcaption></figure>
...
5.  Click **Create**.
    ...
    <figure><img src="../.gitbook/assets/02 (1) (1).png" alt=""><figcaption></figcaption></figure>
6.  From the **Users** screen, click on your service account.

    <figure><img src="../.gitbook/assets/03 (1) (1).png" alt=""><figcaption></figcaption></figure>
7.  Ensure that your service account has the ADMIN role on the organization, and the API\_PUBLISHER role on the desired environment.
    ...
    <figure><img src="../.gitbook/assets/04 (2) (1).png" alt=""><figcaption></figcaption></figure>

    \
    The following screenshot shows the environment-level permissions that are included in the API\_PUBLISHER role:

    <figure><img src="../.gitbook/assets/05 (1) (1).png" alt=""><figcaption></figcaption></figure>
