...
2.  Select **Organization** from the navigation menu.\\
    ...
    <figure><img src="../../4.8/.gitbook/assets/00 (1).png" alt=""><figcaption></figcaption></figure>
3.  From the Organization navigation menu, select **Users**, and then click **Add user**.\\

    <figure><img src="../../4.8/.gitbook/assets/01 (1) (1).png" alt=""><figcaption></figcaption></figure>
...
5.  Click **Create**.\\
    ...
    <figure><img src="../../4.8/.gitbook/assets/02 (1) (1).png" alt=""><figcaption></figcaption></figure>
6.  From the **Users** screen, click on your service account.\\

    <figure><img src="../../4.8/.gitbook/assets/03 (1) (1).png" alt=""><figcaption></figcaption></figure>
7.  Ensure that your service account has the ADMIN role on the organization, and the API\_PUBLISHER role on the desired environment.\\
    ...
    <figure><img src="../../4.8/.gitbook/assets/04 (2) (1).png" alt=""><figcaption></figcaption></figure>

    \
    The following screenshot shows the environment-level permissions that are included in the API\_PUBLISHER role:\\

    <figure><img src="../../4.8/.gitbook/assets/05 (1) (1).png" alt=""><figcaption></figcaption></figure>
8.  From your newly created service account, scroll to the **Tokens** section, and then click **Generate a personal token**.\\

    <figure><img src="../../4.8/.gitbook/assets/06 (1) (1).png" alt=""><figcaption></figcaption></figure>
9.  Give your token a name, and then click **Generate**.\\

    <figure><img src="../../4.8/.gitbook/assets/07 (1) (1).png" alt=""><figcaption></figcaption></figure>
