---
description: Configure a webhook subscription from the Developer Portal 4.9 catalog. Follow the steps to set it up for your application.
metaLinks:
  alternates:
    - >-
...
1.  From the Developer Portal's catalog, navigate to the webhook that you want to configure.
    ...
    <figure><img src="../../.gitbook/assets/developer-portal-new-developer-portal-co-299-1.png" alt="The developer portal catalogue, showing a welcome banner above a grid of API cards, most noting that their description is missing."><figcaption></figcaption></figure>
2.  Click **Learn More**.
...
6.  In the **Configure Consumer** page, complete the following steps:
    ...
    <figure><img src="../../.gitbook/assets/developer-portal-new-developer-portal-co-300-1.png" alt="The Configure Consumer step of the subscription wizard, with an empty channel, a required callback URL, an empty headers table, no retry, no security, and trust store and key store set to none."><figcaption></figcaption></figure>
7.  Click **Next**.
...
<figure><img src="../../.gitbook/assets/developer-portal-new-developer-portal-co-301-1.png" alt="The My Subscriptions tab of an API in the developer portal, showing the subscription&#x27;s application, plan, and timestamps beside an API access panel with a placeholder base URL and curl command, above the callback and retry configuration."><figcaption></figcaption></figure>
