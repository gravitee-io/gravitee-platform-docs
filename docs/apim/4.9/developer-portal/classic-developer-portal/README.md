---
description: The features and functionality of the classic Developer Portal 4.9. Browse the tiles to find the area you need to change.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/developer-portal/classic-developer-portal
---
