---
description: Install the API Management 4.9 MCP Server so AI clients can call your platform. Follow the steps to install it and create a service account token.
metaLinks:
  alternates:
    - >-
...
7.  In the **User details** screen, assign the service account permissions. The AI assistant's capabilities are determined by the permissions you set for the service account.
    ...
    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-12-1.png" alt="A Gravitee Cloud overview showing development, production, and test environment cards, with the product and version badge on each one highlighted."><figcaption></figcaption></figure>
8.  In the **You have unsaved changes** pop-up window, click **Save**.

    <figure><img src=".gitbook/assets/4-9-expose-apim-as-an-mcp-server-340-1-1 (2).png" alt="The detail page of a service account, showing its source, organization role, and creation date, with the environment roles set and an unsaved changes bar offering Save."><figcaption></figcaption></figure>
