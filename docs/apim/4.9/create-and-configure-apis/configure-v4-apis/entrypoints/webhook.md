...
The Advanced version of the webhook plugin offers improved QoS. In the Console, use the drop-down menu to choose between the available options. QoS compatibility is detailed [here](docs/apim/4.9/create-and-configure-apis/configure-v4-apis/quality-of-service.md).
