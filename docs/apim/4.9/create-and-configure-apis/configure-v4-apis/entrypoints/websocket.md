...
3. Use the drop-down menu to choose between the available options. QoS compatibility is detailed [here](https://github.com/gravitee-io/gravitee-platform-docs/blob/main/docs/apim/4.10/create-and-configure-apis/configure-v4-apis/quality-of-service.md).
