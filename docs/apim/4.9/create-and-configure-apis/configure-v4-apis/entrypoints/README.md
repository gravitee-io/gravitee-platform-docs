...
As of Gravitee 4.3, the ability to create APIs with message API entrypoints is an [Enterprise Edition](docs/apim/4.9/readme/enterprise-edition.md) capability. To learn more about Gravitee Enterprise Edition and what's included in various enterprise packages, please:
