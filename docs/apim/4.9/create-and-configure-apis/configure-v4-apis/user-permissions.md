---
description: Configure user and group access to your API Management 4.9 APIs. Follow the steps to add members and set their permissions.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/configure-v4-apis/user-permissions
---
