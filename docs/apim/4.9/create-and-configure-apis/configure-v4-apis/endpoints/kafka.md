---
description: The Kafka endpoint mediates between a Kafka cluster and an HTTP client in API Management 4.9. Follow the steps to set the bootstrap servers.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/configure-v4-apis/endpoints/kafka
---
