---
description: Configure the Azure Service Bus endpoint for a v4 message API in API Management 4.9. Follow the steps through the initial settings.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/configure-v4-apis/endpoints/azure-service-bus
---
