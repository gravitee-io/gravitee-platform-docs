---
description: The Mock endpoint emulates a backend HTTP server so you can test an API Management 4.9 v4 API. Follow the steps to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/configure-v4-apis/endpoints/mock
---
