---
description: Configure the Solace endpoint for a v4 message API in API Management 4.9. Learn the configuration it needs and how it is implemented.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/configure-v4-apis/endpoints/solace
---
