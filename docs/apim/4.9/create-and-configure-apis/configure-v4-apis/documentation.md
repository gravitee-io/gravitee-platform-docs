---
description: Add documentation to a v4 API from the API Management 4.9 Console so consumers know how to use it. Follow the steps to add pages and folders.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/configure-v4-apis/documentation
---
