---
description: Health checks monitor the availability of endpoints behind a v4 HTTP proxy API in API Management 4.9. Follow the steps to configure them.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/configure-v4-apis/health-checks
---
