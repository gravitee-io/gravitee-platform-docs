...
5.  Click the **Resources** header.
    ...
    <figure><img src="../../../4.7/.gitbook/assets/A%201%20config%20resources.png" alt=""><figcaption></figcaption></figure>
6. Click **+ Add resource**.
7.  Use the search field or scroll to select the resource you'd like to configure.

    <figure><img src="../../../4.7/.gitbook/assets/A%201%20resources%202.png" alt=""><figcaption></figcaption></figure>
