---
description: The Kafka ACL policy defines access control lists on cluster resources proxied by API Management 4.9. Learn how to configure them.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/kafka-acl
---
