---
description: The Kafka Topic Mapping policy maps one topic name to another so clients can use their own in API Management 4.9. Learn how to set it.
metaLinks:
  alternates:
    - >-
...
<figure><img src="../../../.gitbook/assets/create-and-configure-apis-apply-policies-153-2 (2).png" alt=""><figcaption><p>Kafka Topic Mapping policy configuration UI</p></figcaption></figure>
{% endtab %}
