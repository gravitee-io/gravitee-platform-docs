---
description: The Retry policy replays requests in API Management 4.9 when the backend fails or a condition matches. Learn how to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/retry
---
