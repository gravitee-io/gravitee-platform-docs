---
description: The Keyless security policy treats every request to an API Management 4.9 API as valid and blocks none. Learn when to use it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/keyless
---
