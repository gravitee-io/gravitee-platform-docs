---
description: The JWT policy validates a token's signature and expiry before API Management 4.9 calls the backend. Learn how to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/4.9-jwt-validator
---
