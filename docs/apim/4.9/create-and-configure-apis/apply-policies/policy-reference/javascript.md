---
description: The JavaScript policy runs scripts at any stage of API Management 4.9 Gateway processing. Learn how to configure the policy.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/javascript
---
