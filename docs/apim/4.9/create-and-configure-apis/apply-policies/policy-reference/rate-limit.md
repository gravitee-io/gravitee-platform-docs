---
description: API Management 4.9 offers three rate limit policies for capping request volume. Compare them and learn how to configure each one.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/rate-limit
---
