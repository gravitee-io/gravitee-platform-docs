---
description: The SSL Enforcement policy restricts access to requests meeting your SSL criteria in API Management 4.9. Learn how to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/ssl-enforcement
---
