---
description: The IP Filtering policy allows or denies specific IP addresses on an API Management 4.9 API. Learn how to configure the filters.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/ip-filtering
---
