---
description: The Transform Headers policy overrides headers on incoming or outgoing API Management 4.9 traffic. Learn how to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/transform-headers
---
