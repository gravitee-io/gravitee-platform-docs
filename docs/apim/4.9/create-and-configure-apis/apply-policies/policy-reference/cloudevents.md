---
description: The CloudEvents policy builds a CloudEvents JSON object from messages in API Management 4.9. Learn how the data content type is set.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/cloudevents
---
