---
description: The Generate JWT policy issues a signed JWT with configurable claims for API Management 4.9 to forward to a backend. Learn how to set it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/generate-jwt
---
