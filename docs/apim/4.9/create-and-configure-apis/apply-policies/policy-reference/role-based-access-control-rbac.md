---
description: The Role-based Access Control policy restricts a resource to the roles you specify in API Management 4.9. Learn how to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/role-based-access-control-rbac
---
