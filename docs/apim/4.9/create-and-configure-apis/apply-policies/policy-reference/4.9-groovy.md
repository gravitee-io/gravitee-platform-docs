---
description: The Groovy policy runs a Groovy script at any stage of request processing on the API Management 4.9 Gateway. Learn how to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/4.9-groovy
---
