---
description: The Latency policy adds artificial delay to a request or a response in API Management 4.9. Learn how to configure the delay.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/latency
---
