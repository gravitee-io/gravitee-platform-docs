---
description: The JSON Validation policy validates payloads against a JSON schema in API Management 4.9. Learn how to configure the schema it uses.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/json-validation
---
