---
description: The Regex Threat Protection policy inspects request headers, path, parameters, and body in API Management 4.9. Learn how to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/regex-threat-protection
---
