---
description: The mTLS policy verifies that a client certificate is present on an API Management 4.9 request. Learn how to configure the policy.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/mtls
---
