---
description: The XML Threat Protection policy validates an XML request body against structural limits in API Management 4.9. Learn how to set them.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/xml-threat-protection
---
