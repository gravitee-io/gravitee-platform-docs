---
description: The HTTP Callout policy invokes an external URL and stores the response in API Management 4.9 variables. Learn how to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/http-callout
---
