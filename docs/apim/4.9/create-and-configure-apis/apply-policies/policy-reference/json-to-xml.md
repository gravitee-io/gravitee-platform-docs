---
description: The JSON to XML policy converts JSON payloads to XML before API Management 4.9 sends or returns them. Learn how to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/json-to-xml
---
