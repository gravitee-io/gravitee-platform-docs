---
description: The Data Logging Masking policy conceals sensitive data in API Management 4.9 logs using JSONPath rules. Learn how to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/data-logging-masking
---
