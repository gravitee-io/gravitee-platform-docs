---
description: The Kafka Quota policy enforces limits on the data Kafka clients exchange through API Management 4.9. Learn how to configure quotas.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/kafka-quota
---
...
<figure><img src="../../../.gitbook/assets/config-apis-apply-policies-policy-r-155.png" alt=""><figcaption><p>Kafka Quota Policy UI</p></figcaption></figure>
