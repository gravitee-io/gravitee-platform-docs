---
description: The Assign Metrics policy pushes extra metrics alongside the native request metrics in API Management 4.9. Learn how to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/assign-metrics
---
