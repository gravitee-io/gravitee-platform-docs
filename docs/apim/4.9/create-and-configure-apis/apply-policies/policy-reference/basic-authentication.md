---
description: The Basic Authentication policy manages basic auth headers on API Management 4.9 calls and compares credentials. Learn how to configure it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/basic-authentication
---
