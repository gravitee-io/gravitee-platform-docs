---
description: The REST to SOAP policy exposes a SOAP backend as a REST API through API Management 4.9. Learn how the SOAP envelope is passed on.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/rest-to-soap
---
