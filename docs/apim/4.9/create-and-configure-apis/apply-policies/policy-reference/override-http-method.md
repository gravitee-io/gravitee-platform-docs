---
description: The Override HTTP Method policy replaces the method sent by the consumer in API Management 4.9. Learn how to configure the override.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/override-http-method
---
