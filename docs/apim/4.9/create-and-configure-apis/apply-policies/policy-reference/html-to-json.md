---
description: The HTML to JSON transformation policy converts response content in API Management 4.9. Learn how to configure the mapping it applies.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/html-to-json
---
