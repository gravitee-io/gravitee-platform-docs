---
description: The Access Management authorization server resource introspects a token issued by Gravitee for API Management 4.9. Learn how to set it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/oauth2/gravitee.io-am-authorization-server
---
