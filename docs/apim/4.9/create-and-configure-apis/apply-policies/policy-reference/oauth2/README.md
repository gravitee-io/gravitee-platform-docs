---
description: The OAuth2 policy checks access token validity through introspection in API Management 4.9. Learn how to configure the policy.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/oauth2
---
