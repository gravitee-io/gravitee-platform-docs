---
description: The API Key policy checks API keys during request processing so only approved apps reach your API Management 4.9 API. Learn how to set it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/policy-reference/api-key
---
