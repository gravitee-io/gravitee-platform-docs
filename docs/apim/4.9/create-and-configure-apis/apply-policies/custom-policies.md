---
description: Policies act as a proxy controller in the API Management 4.9 Gateway. Follow the steps to generate a policy skeleton and apply your own.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/custom-policies
---
