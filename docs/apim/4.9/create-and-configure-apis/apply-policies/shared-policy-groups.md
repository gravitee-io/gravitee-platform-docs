---
description: Define a collection of API Management 4.9 policies centrally and reuse them across APIs. Follow the steps to create and add a group.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/shared-policy-groups
---
