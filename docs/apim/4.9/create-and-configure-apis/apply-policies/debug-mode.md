---
description: Debug mode diagnoses v2 and v4 proxy API flows in API Management 4.9. Learn how to read the debug timeline and the inspector.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/apply-policies/debug-mode
---
...
8.  Click **Send**. You are shown a timeline of the order of the flows and policies.
    ...
    <figure><img src="../../.gitbook/assets/create-and-configure-apis-apply-policies-302-1.png" alt="The Debug page after sending a request that returned 404, showing the policy timeline with a keyless security step and a prompt to select a step."><figcaption></figcaption></figure>
