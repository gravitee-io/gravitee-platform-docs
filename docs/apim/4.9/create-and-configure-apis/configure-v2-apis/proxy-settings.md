...
**Deployments** is where you can choose to use [sharding tags](docs/apim/4.9/configure-and-manage-the-platform/gravitee-gateway/sharding-tags.md) sharding tags to control where your API is deployed. To configure sharding tags for your API:
