---
description: The articles covering how to configure a v2 API in API Management 4.9, from proxy settings through to access. Browse what you need.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/configure-v2-apis
---
