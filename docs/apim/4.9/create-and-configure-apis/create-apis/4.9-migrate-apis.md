---
description: Migrate existing v2 APIs to v4 with the API Management 4.9 Migration feature. Follow the prerequisites and steps to migrate them.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/create-apis/4.9-migrate-apis
---
