...
{% hint style="info" %}
Refer to [Tenants](docs/apim/4.9/configure-and-manage-the-platform/gravitee-gateway/tenants.md) and/or [Sharding tags](docs/apim/4.9/configure-and-manage-the-platform/gravitee-gateway/sharding-tags.md) for more information.
{% endhint %}
