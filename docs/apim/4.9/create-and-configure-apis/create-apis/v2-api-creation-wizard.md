---
description: The v2 API definition is a JSON representation of your Gateway API. Follow the API Management 4.9 creation wizard step by step.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/create-and-configure-apis/create-apis/v2-api-creation-wizard
---
