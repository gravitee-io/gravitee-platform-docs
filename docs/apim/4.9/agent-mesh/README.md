...
* Token-based rate limiting via Gravitee's [Prompt Token Tracking](docs/apim/4.9/create-and-configure-apis/apply-policies/policy-reference/ai-prompt-token-tracking.md) policy.
* Routing to different LLMs.
* Threat protection via Gravitee's [Prompt Guard Rails](docs/apim/4.9/create-and-configure-apis/apply-policies/policy-reference/ai-prompt-guard-rails.md) policy.
