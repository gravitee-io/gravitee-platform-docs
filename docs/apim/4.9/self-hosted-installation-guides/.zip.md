---
description: Install API Management 4.9 from the .zip distribution. Follow the steps for a self-hosted deployment on your own machine.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/self-hosted-installation-guides/.zip
---
