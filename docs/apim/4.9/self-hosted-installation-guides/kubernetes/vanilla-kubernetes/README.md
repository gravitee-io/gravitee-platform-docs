---
description: Deploy a complete self-hosted API Management 4.9 platform on Kubernetes using Helm charts. Follow the steps to install the platform.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/self-hosted-installation-guides/kubernetes/vanilla-kubernetes
---
