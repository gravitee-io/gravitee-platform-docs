...
<figure><img src="../../../.gitbook/assets/A%2011%20policy%201.png" alt=""><figcaption></figcaption></figure>
...
3.  Click **Create**.
    ...
    <figure><img src="../../../.gitbook/assets/A%2011%20policy%200.png" alt=""><figcaption></figcaption></figure>
4.  In the Flow details panel, select the **Global** header to add a policy to the **Interact** phase of the Kafka API transaction.

    <figure><img src="../../../.gitbook/assets/A%2011%20policy%202.png" alt=""><figcaption></figcaption></figure>
    ...
    <figure><img src="../../../.gitbook/assets/A%2011%20policy%203.png" alt=""><figcaption></figcaption></figure>

    Fill out the policy configuration details and click **Add policy**.

    <figure><img src="../../../.gitbook/assets/AAA%20policy.png" alt=""><figcaption></figcaption></figure>
5.  In the Flow details panel, select the **Event messages** header to add a policy to the **Publish** and/or **Subscribe** phase of the Kafka API transaction.
    ...
    <figure><img src="../../../.gitbook/assets/A%2011%20policy%204.png" alt=""><figcaption></figcaption></figure>

    Select the [Kafka Quota](../../../create-and-configure-apis/apply-policies/policy-reference/kafka-quota.md) policy.

    <figure><img src="../../../.gitbook/assets/A%2011%20policy%205.png" alt=""><figcaption></figcaption></figure>

    Fill out the policy configuration details and click **Add policy**.

    <figure><img src="../../../.gitbook/assets/AAB%20policy.png" alt=""><figcaption></figcaption></figure>
