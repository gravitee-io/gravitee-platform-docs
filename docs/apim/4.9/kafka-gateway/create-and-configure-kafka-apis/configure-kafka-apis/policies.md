...
<figure><img src="../../../../4.7/.gitbook/assets/A 11 policy 1.png" alt=""><figcaption></figcaption></figure>
...
3.  Click **Create**.\\
    ...
    <figure><img src="../../../../4.7/.gitbook/assets/A 11 policy 0.png" alt=""><figcaption></figcaption></figure>
4.  In the Flow details panel, select the **Global** header to add a policy to the **Interact** phase of the Kafka API transaction.\\

    <figure><img src="../../../../4.7/.gitbook/assets/A 11 policy 2.png" alt=""><figcaption></figcaption></figure>

    Choose either the Kafka ACL or [Kafka Topic Mapping](docs/apim/4.9/create-and-configure-apis/apply-policies/policy-reference/kafka-topic-mapping.md) policy. \\

    <figure><img src="../../../../4.7/.gitbook/assets/A 11 policy 3.png" alt=""><figcaption></figcaption></figure>

    Fill out the policy configuration details and click **Add policy**.\\

    <figure><img src="../../../../4.7/.gitbook/assets/AAA policy.png" alt=""><figcaption></figcaption></figure>
5.  In the Flow details panel, select the **Event messages** header to add a policy to the **Publish** and/or **Subscribe** phase of the Kafka API transaction.\\
    ...
    <figure><img src="../../../../4.7/.gitbook/assets/A 11 policy 4.png" alt=""><figcaption></figcaption></figure>

    Select the [Kafka Quota](docs/apim/4.9/create-and-configure-apis/apply-policies/policy-reference/kafka-quota.md) policy. \\

    <figure><img src="../../../../4.7/.gitbook/assets/A 11 policy 5.png" alt=""><figcaption></figcaption></figure>

    Fill out the policy configuration details and click **Add policy**.\\

    <figure><img src="../../../../4.7/.gitbook/assets/AAB policy.png" alt=""><figcaption></figcaption></figure>
