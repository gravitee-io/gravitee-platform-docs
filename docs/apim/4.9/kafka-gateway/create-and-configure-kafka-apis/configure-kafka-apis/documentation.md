---
description: The Documentation section creates Developer Portal pages for a Kafka API in API Management 4.9. Learn how to inform consumers.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/kafka-gateway/create-and-configure-kafka-apis/configure-kafka-apis/documentation
---
