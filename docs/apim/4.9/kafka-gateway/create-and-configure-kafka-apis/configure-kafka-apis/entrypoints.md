---
description: Entrypoints define the protocol and settings consumers use to reach a Kafka API in API Management 4.9. Learn how to configure them.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/kafka-gateway/create-and-configure-kafka-apis/configure-kafka-apis/entrypoints
---
