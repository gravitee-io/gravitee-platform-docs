---
description: Configure Kafka APIs from the API Management 4.9 Console, a UI for creating and amending them. Learn what you can change there.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/kafka-gateway/create-and-configure-kafka-apis/configure-kafka-apis
---
...
<figure><img src="../../../.gitbook/assets/A 1 config general copy.png" alt="The Configuration page of a Kafka API, with the API menu items highlighted from Configuration through to Deployment."><figcaption></figcaption></figure>
