---
description: The Deployment section manages sharding tags and tracks changes to a Kafka API in API Management 4.9. Learn what it records.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/kafka-gateway/create-and-configure-kafka-apis/configure-kafka-apis/deployment
---
