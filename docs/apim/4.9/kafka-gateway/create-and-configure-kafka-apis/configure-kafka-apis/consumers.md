...
<figure><img src="../../../../4.7/.gitbook/assets/A plan.png" alt=""><figcaption></figcaption></figure>
...
* [oauth2.md](docs/apim/4.9/secure-and-expose-apis/plans/oauth2.md "mention")
* [jwt.md](docs/apim/4.9/secure-and-expose-apis/plans/jwt.md "mention")
* [api-key.md](docs/apim/4.9/secure-and-expose-apis/plans/api-key.md "mention")
* [keyless.md](docs/apim/4.9/secure-and-expose-apis/plans/keyless.md "mention")
...
<figure><img src="../../../../4.7/.gitbook/assets/1 sub 1.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../../../4.7/.gitbook/assets/1 sub create 1.png" alt=""><figcaption></figcaption></figure>

You'll be taken to a screen that displays your subscription details.

<figure><img src="../../../../4.7/.gitbook/assets/1 sub details.png" alt=""><figcaption></figcaption></figure>
...
*   Display subscriptions based on plan selections\\
    ...
    <figure><img src="../../../../4.7/.gitbook/assets/1 sub c.png" alt=""><figcaption></figcaption></figure>
*   Search for an application display subscriptions associated with a plan name\\

    <figure><img src="../../../../4.7/.gitbook/assets/1 sub b.png" alt=""><figcaption></figcaption></figure>
*   Select subscription status options to display subscriptions matching that criteria\\

    <figure><img src="../../../../4.7/.gitbook/assets/1 sub a.png" alt=""><figcaption></figcaption></figure>
...
4.  Select the **Broadcasts** tab \\
    ...
    <figure><img src="../../../../4.7/.gitbook/assets/1 broadcast.png" alt=""><figcaption></figcaption></figure>
