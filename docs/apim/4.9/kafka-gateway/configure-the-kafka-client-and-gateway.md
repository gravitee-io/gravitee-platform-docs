...
<figure><img src="../.gitbook/assets/kafka-gw-configure-the-kafka-client-10.png" alt="" width="555"><figcaption><p>The Kafka client routes to the correct API through the gateway using SNI routing.</p></figcaption></figure>
