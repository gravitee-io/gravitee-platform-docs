...
{% hint style="info" %}
You can obscure the value of this API key by using [configuration-level secrets](../../../4.10/prepare-a-production-environment/sensitive-data-management/configure-secrets/) in `gravitee.yml`.
{% endhint %}
...
| [Metrics](../../../4.10/analyze-and-monitor-apis/reporters/#metrics-sent-via-reporters) | Response time (for both gateway and endpoint), content length, request count | Metrics            |
| [Logs](../../../4.10/analyze-and-monitor-apis/reporters/#log-data-sent-via-reporters)   | Request body, response body, headers, request id, method                     | Log                |
...
{% hint style="info" %}
The default metrics published by Gravitee can be found [here](../../../4.10/analyze-and-monitor-apis/reporters/#metrics-sent-via-reporters).
{% endhint %}
...
<div data-full-width="false"><figure><img src="../../../4.10/.gitbook/assets/gravitee-full-datadog-dashboard-screenshot (1).png" alt="" width="563"><figcaption></figcaption></figure></div>
