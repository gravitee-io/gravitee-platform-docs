---
description: API Management 4.9 supports standard Java logging per component, plus debug logging for specific areas. Learn how to enable it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/configure-and-manage-the-platform/debug-logging
---
