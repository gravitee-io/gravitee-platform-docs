---
description: Configure general API Management 4.9 Management API settings in the gravitee.yaml file. Browse the configuration guides you need.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/configure-and-manage-the-platform/management-api
---
