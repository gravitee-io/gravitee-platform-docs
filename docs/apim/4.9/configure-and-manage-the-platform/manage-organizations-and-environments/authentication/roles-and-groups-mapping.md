---
description: Assign roles to API Management 4.9 users through groups rather than individually. Learn how group and role mapping works.
metaLinks:
  alternates:
    - >-
...
<figure><img src="../../../.gitbook/assets/platform-manage-organizations-and-e-11.png" alt="Empty Groups Mapping and Roles Mapping panels, each with a link to add a mapping."><figcaption></figcaption></figure>
