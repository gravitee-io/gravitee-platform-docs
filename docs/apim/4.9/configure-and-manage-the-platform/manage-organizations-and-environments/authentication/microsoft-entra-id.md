...
{% hint style="info" %}
For documentation about securing your APIs with OAuth2 and Entra ID, see the documentation on the [JWT Plan](docs/apim/4.9/secure-and-expose-apis/plans/jwt.md).
{% endhint %}
