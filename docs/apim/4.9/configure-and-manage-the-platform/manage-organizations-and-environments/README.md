...
{% hint style="info" %}
CORS can also be configured at the API level. For more information, see the [v2 API](docs/apim/4.9/create-and-configure-apis/configure-v2-apis/proxy-settings.md) and [v4 API ](docs/apim/4.9/create-and-configure-apis/configure-v4-apis/cors.md)CORS documentation.
{% endhint %}
{% endtab %}
...
{% hint style="info" %}
To learn more about notifications, refer to the [Notifications](docs/apim/4.9/configure-and-manage-the-platform/gravitee-gateway/notifications.md) documentation.
{% endhint %}
{% endtab %}
{% endtabs %}
