...
The tab is enabled by default, but depending on the number of APIs, it may take a while to load. You can disable it in your Gateway settings. See [dashboards](docs/apim/4.9/analyze-and-monitor-apis/dashboards.md) for more information.
