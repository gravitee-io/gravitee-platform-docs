---
description: The API Management 4.9 Console is the graphical interface for configuring gateways and creating APIs. Learn what it lets you do.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/configure-and-manage-the-platform/manage-organizations-and-environments/apim-console
---
...
The tab is enabled by default, but depending on the number of APIs, it may take a while to load. You can disable it in your Gateway settings. See [dashboards](../../analyze-and-monitor-apis/dashboards.md) for more information.
