---
description: Set alerting conditions for the API Management 4.9 Gateway from the platform settings. Follow the steps to configure them.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/configure-and-manage-the-platform/gravitee-gateway/alerts
---
...
<figure><img src="../../.gitbook/assets/alerts.png" alt="The environment Alerts board, listing alerts by severity with their descriptions, recent counts, and last alert times."><figcaption><p>Alerts</p></figcaption></figure>
