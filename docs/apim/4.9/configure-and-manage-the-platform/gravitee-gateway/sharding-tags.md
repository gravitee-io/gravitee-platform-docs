...
To learn more about how to deploy APIs to specific Gateways based on sharding tags, refer to [Configure Deployments](docs/apim/4.9/create-and-configure-apis/configure-v2-apis/proxy-settings.md).
...
{% hint style="success" %}
You've just learned how to configure sharding tags for your Gravitee API Gateways. To apply sharding tags to APIs to control where those APIs are deployed, refer to [this documentation](docs/apim/4.9/create-and-configure-apis/configure-v2-apis/proxy-settings.md).
{% endhint %}
