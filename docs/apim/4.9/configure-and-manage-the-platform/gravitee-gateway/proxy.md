---
description: Define specific proxies for specific use cases in API Management 4.9. Learn where proxy configurations can be applied to it.
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/configure-and-manage-the-platform/gravitee-gateway/proxy
---
