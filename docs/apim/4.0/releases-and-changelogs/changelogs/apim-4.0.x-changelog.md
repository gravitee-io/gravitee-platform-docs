...
* Mock Policy - Example value is not correct when the GET method return an array [#6289](https://github.com/gravitee-io/issues/issues/6289)
...
* Getting 400 bad requests and random time outs apim version 3.20.14 [#9266](https://github.com/gravitee-io/issues/issues/9266)
