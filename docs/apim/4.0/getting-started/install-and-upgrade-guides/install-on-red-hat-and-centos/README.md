...
{% hint style="warning" %}
RPM install is not supported on distributions with old versions of RPM, such as SLES 11 and CentOS 5 — in this case, you need to [install APIM with .zip](docs/apim/4.0/getting-started/install-and-upgrade-guides/install-with-.zip.md) instead.
{% endhint %}
