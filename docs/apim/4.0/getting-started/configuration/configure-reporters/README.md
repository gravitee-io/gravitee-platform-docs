---
description: Guide to configuring Reporters.
---
...
Configuration details for the Elasticsearch reporter are available in the [Elasticsearch Repository](../configure-repositories/elasticsearch.md#elasticsearch) documentation.
