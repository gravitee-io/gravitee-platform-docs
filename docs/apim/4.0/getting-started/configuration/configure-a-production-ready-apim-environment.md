...
APIM includes many other configuration options and every environment is unique. However you configure new settings (via the `gravitee.yml` file, APIM Console, or environment and system variables) it is important to understand that one configuration type can override another. [Configure APIM Gateway](configure-apim-gateway/README.md) gives a good overview of this topic.
{% endhint %}
...
<div align="right" data-full-width="true"><figure><img src="../../.gitbook/assets/prod_def apim4.png" alt="The organization settings page, with the management title and URL, support, user registration, and automatic validation of registration requests all enabled." width="563"><figcaption><p>Organization settings</p></figcaption></figure></div>
