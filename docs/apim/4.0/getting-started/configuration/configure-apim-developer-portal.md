...
<figure><img src="../../.gitbook/assets/settings_theme.png" alt="The portal Theme settings, with Theme highlighted in the portal menu, showing logo and favicon upload areas beside a live preview of the portal home page."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/portal_url.png" alt="The portal General settings, showing the API key header, portal URL, an override homepage title toggle, and options for tiles mode and support."><figcaption></figcaption></figure>
