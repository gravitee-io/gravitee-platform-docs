...
<figure><img src="../../.gitbook/assets/plan-diagram.png" alt="A diagram showing an application subscribing to one of three plans, which in turn sit in front of an API."><figcaption><p>High-level plan diagram</p></figcaption></figure>
