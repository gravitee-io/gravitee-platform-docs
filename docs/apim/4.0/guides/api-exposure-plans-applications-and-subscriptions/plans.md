...
The **Deployment** section allows you to selectively deploy the plan to particular APIs using sharding tags which you can learn more about [here](docs/apim/4.0/getting-started/configuration/configure-apim-gateway/sharding-tags.md).
...
You can configure basic authentication for keyless plans by associating a basic authentication policy with either an LDAP or inline resource. For more details, see the [Basic Authentication policy](docs/apim/4.0/reference/policy-reference/basic-authentication.md).
{% endhint %}
...
{% hint style="warning" %}
This workflow only applies to [v4 APIs and v2 APIs in emulation mode.](docs/apim/4.0/overview/gravitee-api-definitions-and-execution-engines/plan-selection.md#plan-selection)
{% endhint %}
