...
1.  From the **Documentation** page, select **Import multiple files**
    ...
    <figure><img src="../../../.gitbook/assets/documentation_import multiple files.png" alt="The portal Documentation settings with the Import multiple files link highlighted above the page list."><figcaption><p>Import multiple documentation files</p></figcaption></figure>
