...
<figure><img src="../../.gitbook/assets/policy studio_flow.png" alt="The Policy Studio of a message API, with a sample API key flow selected and its entrypoints, operations, and channel operator shown beside empty request and response phases."><figcaption><p>Sample v4 Policy Studio</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/create a new flow.png" alt="The Create a new flow dialog for a message API, with an empty flow name, the Equals operator, and empty channel, entrypoints, operations, and condition fields."><figcaption><p><strong>Create a new flow</strong> module</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/sample add policy.png" alt="The Policies for Request phase dialog, with security, transformation, and other category filters above API key, assign attributes, JSON web tokens, keyless, latency, OAuth2, and transform headers policies."><figcaption><p>Sample policy selection</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/latency policy.png" alt="The Policy Studio with a sample HTTP GET flow selected, showing a Latency policy added to the request phase between the entrypoint and the endpoint."><figcaption><p>Sample policy applied</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/flow modes.png" alt="The Flow execution dialog, explaining default and best match flow selection, with the mode set to Default and Fail on flow mismatch switched off."><figcaption><p>v4 Policy Studio: Configure flow mode</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/policy studio_properties expert.png" alt="The Manage API properties page in expert mode, showing a single text area with a sample property key and value."><figcaption><p>API properties expert mode</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/policy studio_encryption.png" alt="The Manage API properties page listing one encrypted test property whose value is masked."><figcaption><p>Encrypted API property</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/policy studio_dynamic properties.png" alt="The Configure dynamic properties panel beside its documentation, showing the polling schedule and HTTP method on the left and a JOLT transformation example on the right."><figcaption><p>Configure dynamic properties</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/example1_properties.png" alt="The Manage API properties page of a draft API, listing three shop properties mapped to URL placeholders."><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/example1_dynamic routing.png" alt="The Policies for Request phase dialog configuring dynamic routing, with a wildcard match expression and a redirect built from a property lookup on a store header, beside the policy documentation."><figcaption></figcaption></figure>
