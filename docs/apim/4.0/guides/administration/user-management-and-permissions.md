...
4.  At the **API** scope, select **+ Add a role**
    ...
    <figure><img src="../../.gitbook/assets/Add an API scope role.gif" alt="An animation that adds a new API-scope role, entering a name and description and then stepping through the permissions matrix of API, documentation, plan, and other rows."><figcaption><p>Create an API scope role</p></figcaption></figure>
...
9.  Once you are done, select **Create.**
    ...
    <figure><img src="../../.gitbook/assets/Writer role.gif" alt="An animation that opens the Roles page and reviews the organization, environment, API, and application role lists, including system, default, and custom roles."><figcaption><p>Define the "Writer" role permissions</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Delete a user.png" alt="The organization Users page, with the delete icon on one row circled, listing ten of 153 users whose display names are masked."><figcaption><p>Delete a user</p></figcaption></figure>
