...
<figure><img src="../../../.gitbook/assets/guide-gko-custom-resource-definitio-45.png" alt="A diagram of two Kubernetes clusters each running a gateway, both writing to a shared MongoDB, with a third cluster where the operator listens to custom resources and sends requests to the management API."><figcaption><p>Gateways in different Kubernetes Clusters</p></figcaption></figure>
