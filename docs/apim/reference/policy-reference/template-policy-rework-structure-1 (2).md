...
* [Examples](<template-policy-rework-structure-1 (2).md#examples>)
* [Configuration](<template-policy-rework-structure-1 (2).md#configuration>)
* [Compatibility Matrix](<template-policy-rework-structure-1 (2).md#compatibility-matrix>)
* [Errors](<template-policy-rework-structure-1 (2).md#errors>)
* [Changelogs](<template-policy-rework-structure-1 (2).md#changelogs>)
