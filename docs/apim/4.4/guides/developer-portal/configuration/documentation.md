...
* If a page is **Private**, you can configure access lists to either require or exclude certain [roles and groups](../../../using-the-product/administration/) by toggling the **Excluded** option.
