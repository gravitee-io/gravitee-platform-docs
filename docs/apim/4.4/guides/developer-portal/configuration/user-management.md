...
{% hint style="info" %}
By default, the `gravitee.yml` configuration file disables email because email requires configuring an SMTP email service. You must set up email for your APIM deployment per the [SMTP configuration guide](../../../using-the-product/using-the-gravitee-api-management-components/configuration.md) to be able to modify the SMTP settings.
{% endhint %}

<figure><img src="../../../.gitbook/assets/Screenshot 2023-06-05 at 12.03.55 PM.png" alt="The SMTP settings, disabled, with placeholder host, port, username, password, protocol, subject, and sender values greyed out."><figcaption><p>SMTP default settings</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/Screenshot 2023-06-05 at 12.14.03 PM.png" alt="The developer portal account creation form, with empty first name, last name, email, position, and city fields above a Sign up button."><figcaption><p>Developer portal sign up page</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/guide-devportal-config-user-managem-93.png" alt="The organization Users page, listing two primary owners with their status, source, and a masked email address."><figcaption><p>Management Console user overview</p></figcaption></figure>
