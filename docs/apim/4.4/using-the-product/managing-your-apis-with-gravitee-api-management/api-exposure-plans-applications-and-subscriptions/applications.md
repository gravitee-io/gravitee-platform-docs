...
{% hint style="info" %}
Only users with the required permissions can manage application members. See [User Management and Permissions](docs/apim/4.4/using-the-product/administration/user-management-and-permissions.md).
{% endhint %}
