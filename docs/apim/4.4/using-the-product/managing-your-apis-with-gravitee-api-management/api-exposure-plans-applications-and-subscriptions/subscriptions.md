...
{% hint style="info" %}
To be notified of subscription validation tasks, enable [Notifications](docs/apim/4.4/using-the-product/using-the-gravitee-api-management-components/apim-console/notifications.md)
{% endhint %}
