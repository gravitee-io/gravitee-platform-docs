...
When defining the response body content, you can use [Gravitee Expression Language (EL)](docs/apim/4.4/using-the-product/managing-your-apis-with-gravitee-api-management/gravitee-expression-language.md) to provide a dynamic mock response.
