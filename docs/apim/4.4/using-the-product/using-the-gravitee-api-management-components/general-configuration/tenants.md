...
# Configuring the Tenants in Gravitee API Management Gateway
...
1.  Navigate to **Organization Settings** and select **Tenants**_**.**_ Select **Add a tenant** and enter the value for each of your regions, e.g., “usa” and “eu." We also recommend giving each tenant a descriptive name.
    ...
    <figure><img src="../../../.gitbook/assets/tenant_create.png" alt="The Create a tenant dialog, with a tenant name and a description explaining that it routes traffic to a regional datacentre."><figcaption></figcaption></figure>
