...
<img src="../../../../.gitbook/assets/file.excalidraw (4) (1).svg" alt="A hand-drawn diagram of three external clients calling the gateway through a firewall, the gateway calling a backend service, and the console configuring the gateway." class="gitbook-drawing">
