...
Configuration details for the Elasticsearch reporter are available in the [Elasticsearch Repository](docs/apim/4.4/configuration/repositories/elasticsearch.md#elasticsearch) documentation.
