---
description: >-
  An overview about Configuring Webhook Subscriptions with Gravitee Developer
  Portal.
---

# Configuring Webhook Subscriptions with Gravitee Developer Portal
...
2.  (Optional) Use the search field
    ...
    <figure><img src="broken-reference" alt=""><figcaption><p>Find your Webhook subscription in the Developer Portal</p></figcaption></figure>
3.  Click on the subscription, then on **Subscribe**

    <figure><img src="broken-reference" alt=""><figcaption><p>Subscribe to your Webhook subscription</p></figcaption></figure>
4.  Choose a **PUSH plan.** A PUSH plan is limited to Webhooks and enables you to subscribe to APIs that have a subscription listener (currently also limited to Webhooks).
    ...
    <figure><img src="broken-reference" alt=""><figcaption><p>Choose a PUSH plan</p></figcaption></figure>
...
<figure><img src="broken-reference" alt=""><figcaption><p>Define your Webhook subscription settings</p></figcaption></figure>

6.  Next, choose which application will be the subscriber and (optionally) leave a message for the API Owner.

    <figure><img src="broken-reference" alt=""><figcaption><p>Choose the subscriber application</p></figcaption></figure>
7.  Select **Next** to validate your subscription request

    <figure><img src="broken-reference" alt=""><figcaption><p>Submit to validate your Webhook subscription</p></figcaption></figure>
