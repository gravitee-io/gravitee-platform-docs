...
* **Quality of service:** Use the drop-down menu to choose between the available options. QoS compatibility is detailed [here](../../../../guides/api-configuration/v4-api-configuration/quality-of-service.md).
...
The Documentation step is supported for v4 APIs. See [this page](../../../../guides/api-configuration/v4-api-configuration/documentation.md) to learn how to create documentation for a v4 API.
