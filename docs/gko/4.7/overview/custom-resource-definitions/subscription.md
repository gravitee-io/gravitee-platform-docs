...
* For a detailed guide on managing subscriptions with GKO, see [manage-jwt-subscriptions-with-gko.md](docs/gko/4.7/guides/manage-jwt-subscriptions-with-gko.md "mention").
