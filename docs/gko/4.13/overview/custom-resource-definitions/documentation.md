---
description: The Documentation custom resource creates Developer Portal pages through the Gravitee Kubernetes Operator 4.13. Compare portal scope and API scope.
---
