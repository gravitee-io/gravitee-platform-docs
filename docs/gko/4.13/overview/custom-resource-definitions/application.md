---
description: The Application custom resource declares a consumer application for the Gravitee Kubernetes Operator 4.13. Compare the simple and OAuth types.
---
