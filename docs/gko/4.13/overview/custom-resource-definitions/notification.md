---
description: The Notification custom resource routes API event alerts to the Console through the Gravitee Kubernetes Operator 4.13. See a worked example.
---
