---
description: The Subscription custom resource is the Gravitee Kubernetes Operator 4.13 equivalent of a Console subscription, including API keys. See a worked example.
---
