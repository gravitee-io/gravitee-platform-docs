---
description: ManagementContext connects the Gravitee Kubernetes Operator 4.13 to an API Management organization and environment. Compare the four authentication methods.
---
