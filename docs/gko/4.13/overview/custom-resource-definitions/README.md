---
description: The custom resource definitions the Gravitee Kubernetes Operator 4.13 installs, and how to read their status conditions. Browse the full CRD reference.
---
