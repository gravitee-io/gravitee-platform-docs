---
description: The Group custom resource creates a group in an API Management environment through the Gravitee Kubernetes Operator 4.13. Follow its validation rules.
---
