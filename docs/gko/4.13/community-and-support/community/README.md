---
description: What to expect from the Gravitee community forum as a user of the Gravitee Kubernetes Operator 4.13 and the wider platform. See how to get involved.
---
