...
* [Custom Resource Definitions](overview/custom-resource-definitions/README.md)
  ...
  * [Dictionary](overview/custom-resource-definitions/managing-dictionaries-via-kubernetes-crd/README.md)
    * [Dictionary management overview](overview/custom-resource-definitions/managing-dictionaries-via-kubernetes-crd/dictionary-management-overview.md)
    * [Dictionary management restrictions and validation](overview/custom-resource-definitions/managing-dictionaries-via-kubernetes-crd/dictionary-management-restrictions-and-validation.md)
...
* [Manage dictionaries with the Automation API](guides/managing-dictionaries-via-automation-api.md)
...
* [Changelog](releases-and-changelog/changelog/README.md)
  * [GKO 4.12.x](releases-and-changelog/changelog/gko-4.12.x.md)
