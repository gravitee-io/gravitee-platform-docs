---
description: Set the Gateway to load API definitions from local ConfigMaps rather than the repository in Gravitee Kubernetes Operator 4.13 deployments. Follow the steps.
---
