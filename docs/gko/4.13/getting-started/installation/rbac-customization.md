---
description: The Gravitee Kubernetes Operator 4.13 needs different RBAC permissions in cluster and namespaced scope. Follow the steps to modify or disable the defaults.
---
