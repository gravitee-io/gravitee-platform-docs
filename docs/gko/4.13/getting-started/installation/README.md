---
description: The methods available for installing the Gravitee Kubernetes Operator 4.13, covering both Helm and OperatorHub. Compare them before you install.
---
