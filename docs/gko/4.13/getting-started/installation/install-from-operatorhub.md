---
description: Install the Gravitee Kubernetes Operator 4.13 from OperatorHub on OpenShift or on Kubernetes with OLM. Compare the channels and how it differs from Helm.
---
