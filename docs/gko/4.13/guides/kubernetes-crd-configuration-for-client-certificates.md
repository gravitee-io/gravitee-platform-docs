---
description: The Application CRD holds several client certificates for mTLS plans in the Gravitee Kubernetes Operator 4.13. Rotate them without downtime.
---
