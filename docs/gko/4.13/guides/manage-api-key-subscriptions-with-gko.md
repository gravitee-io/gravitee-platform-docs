---
description: Subscribe an application to an API Key plan with the Gravitee Kubernetes Operator 4.13. Follow the steps to set custom keys and rotate without downtime.
---
