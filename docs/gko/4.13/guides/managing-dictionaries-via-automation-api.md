---
description: Create and update manual and dynamic dictionaries through the Automation API in Gravitee Kubernetes Operator 4.13 deployments. Follow the steps to set one up.
---
