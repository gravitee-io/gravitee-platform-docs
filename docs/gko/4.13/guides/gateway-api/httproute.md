---
description: HTTPRoute routes HTTP traffic from a Gateway listener to Kubernetes Services through the Gravitee Kubernetes Operator 4.13. See header rules and redirects.
---
