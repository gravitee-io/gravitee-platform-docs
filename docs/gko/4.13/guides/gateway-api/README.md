---
description: The Gravitee Kubernetes Operator 4.13 implements the Kubernetes Gateway API for routing. Follow the steps to enable the controller and map the resources.
---
