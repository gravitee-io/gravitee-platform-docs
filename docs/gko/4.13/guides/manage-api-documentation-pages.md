---
description: Define API documentation pages in Gravitee Kubernetes Operator 4.13 API definition CRDs for the Classic Developer Portal. See what the CRDs support.
---
