...
* it removes the need to use a ManagementContext, and also enables the [DB-less mode](docs/gko/4.4/guides/db-less-mode.md)
...
* Unless you're running in [DB-less mode](docs/gko/4.4/guides/db-less-mode.md), the Gateway will still need to connect to a central repository to manage other aspects of the API lifecycle, such a subscription management.
