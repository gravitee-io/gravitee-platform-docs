...
The most common setup, which is aligned with the proposed [Example Architecture](docs/gko/4.4/overview/example-architecture.md), uses the following configuration:
