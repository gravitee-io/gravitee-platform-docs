---
description: Deploy the Gateway as an ingress runtime with the Gravitee Kubernetes Operator 4.8 as its controller. Follow the steps to deploy, test, and secure it.
---
