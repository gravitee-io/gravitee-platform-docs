---
description: Templating injects values from Kubernetes Secrets and ConfigMaps into Gravitee Kubernetes Operator 4.8 CRDs at runtime. Follow the steps to use it.
---
