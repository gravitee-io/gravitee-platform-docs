---
description: Publish Gravitee Kubernetes Operator 4.8 APIs to the Developer Portal with the lifecycle state attribute. Follow the steps to publish and set a category.
---
