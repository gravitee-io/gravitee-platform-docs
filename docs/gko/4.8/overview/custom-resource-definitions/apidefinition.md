---
description: ApiDefinition declares a v2 API for the Gravitee Kubernetes Operator 4.8 to deploy to the Gateway. Create one, follow its lifecycle, and delete your API.
---
