---
description: GatewayClassParameters configures the Gravitee Kubernetes Operator 4.8 implementation of the Kubernetes Gateway API. See the options and an example.
---
