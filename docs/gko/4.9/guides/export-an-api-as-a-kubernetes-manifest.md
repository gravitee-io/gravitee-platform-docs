---
description: Export a v2 or v4 API from the Console as a Kubernetes manifest for the Gravitee Kubernetes Operator 4.9. Follow the steps in the UI or the Management API.
---
