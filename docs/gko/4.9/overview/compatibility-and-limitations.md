---
description: Which API Management versions the Gravitee Kubernetes Operator 4.9 supports, plus its deprecation policy and known limits. Check it before you upgrade.
---
