---
description: How the Gravitee Kubernetes Operator 4.9 fits a platform with a control plane, data planes, and GitOps tooling. See how it fits your architecture.
---
