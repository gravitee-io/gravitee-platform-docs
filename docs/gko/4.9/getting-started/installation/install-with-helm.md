---
description: Install the Gravitee Kubernetes Operator 4.9 with Helm, the preferred method. Follow the steps from prerequisites through upgrades and configuration.
---
