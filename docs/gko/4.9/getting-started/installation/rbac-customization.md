---
description: The Gravitee Kubernetes Operator 4.9 needs different RBAC permissions in cluster and namespaced mode. Follow the steps to modify or disable the defaults.
---
...
<figure><img src="../../.gitbook/assets/gs-install-rbac-customization-18 (1).png" alt="The verbs GKO needs on webhooks, CRDs, ConfigMaps, Secrets, Ingress, and TokenReviews."><figcaption><p>GKO required permissions</p></figcaption></figure>
