...
<figure><img src="../../.gitbook/assets/gs-api-storage-and-control-options--3 (1).png" alt="GKO syncs API definitions into APIM, and Gateways across regions read from the shared database."><figcaption><p>One operator, multiple clusters/regions</p></figcaption></figure>
