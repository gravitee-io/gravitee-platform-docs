...
* [Create an MCP Dashboard from Template](create-an-mcp-dashboard-from-template.md)
...
* [API Reference](reference/api-reference.md)
  ...
  * [MCP Analytics Facets and Dashboard Templates](reference/mcp-analytics-facets-and-dashboard-templates.md)
