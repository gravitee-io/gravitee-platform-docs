---
description: Deploy the Gateway as an ingress runtime with the Gravitee Kubernetes Operator 4.11 as its controller. Follow the steps and see where v4 support stops.
---
