---
description: Package Gravitee Kubernetes Operator 4.11 custom resources in your own Helm chart. Follow the steps to define, install, and upgrade CRDs with Helm.
---
