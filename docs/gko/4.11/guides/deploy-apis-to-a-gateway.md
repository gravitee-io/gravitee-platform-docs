---
description: The state attribute on Gravitee Kubernetes Operator 4.11 API definitions starts or stops an API on the Gateway. Follow the steps to deploy and control it.
---
