---
description: Manage JWT subscriptions with the Gravitee Kubernetes Operator 4.11 without an external identity provider. Follow the steps from plan to subscription.
---
