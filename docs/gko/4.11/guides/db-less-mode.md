---
description: DB-less mode runs a Gravitee Kubernetes Operator 4.11 Gateway with no database, for faster starts and autoscaling. See what is available and when to use it.
---
