...
<figure><img src="../.gitbook/assets/guides-export-an-api-as-a-kubernetes-man-2-1 (1).png" alt=""><figcaption></figcaption></figure>

In the modal that opens, select the **CRD API Definition** tab and click the **Export** button.

<figure><img src="../.gitbook/assets/guides-export-an-api-as-a-kubernetes-man-1-1-1 (1).png" alt=""><figcaption></figcaption></figure>
