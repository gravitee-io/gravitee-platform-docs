---
description: Install the Gravitee Kubernetes Operator 4.11, connect it to API Management, and create your first ApiV4Definition. Follow the quickstart or the video tutorial.
---
...
<figure><img src="../.gitbook/assets/gs-quickstart-guide-4.png" alt="The Echo API Declarative entry in the API list, owned by the gko-service-account user."><figcaption></figcaption></figure>
