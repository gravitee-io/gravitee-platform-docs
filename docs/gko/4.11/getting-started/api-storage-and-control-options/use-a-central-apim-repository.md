---
description: Send Gravitee Kubernetes Operator 4.11 API definitions and deployment events to the API Management repository, where the Gateway loads them. See the examples.
---
...
<figure><img src="../../.gitbook/assets/gs-api-storage-and-control-options--3.png" alt="GKO syncs API definitions into APIM, and Gateways across regions read from the shared database."><figcaption><p>One operator, multiple clusters/regions</p></figcaption></figure>
