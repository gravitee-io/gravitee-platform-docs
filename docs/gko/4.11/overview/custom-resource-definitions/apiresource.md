---
description: ApiResource declares reusable pointers to authentication providers and caches for the Gravitee Kubernetes Operator 4.11. Reference them from an API definition.
---
