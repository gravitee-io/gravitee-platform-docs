---
description: The SharedPolicyGroup custom resource creates a shared policy group for the Gravitee Kubernetes Operator 4.11. Reference it from an ApiV4Definition.
---
