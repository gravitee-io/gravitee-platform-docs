---
description: KafkaRoute exposes Kafka traffic through the Gravitee Kubernetes Operator 4.11 Gateway API controller, which is off by default. See how to enable it.
---
