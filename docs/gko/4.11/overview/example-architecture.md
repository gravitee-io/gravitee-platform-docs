---
description: How the Gravitee Kubernetes Operator 4.11 fits a platform with a control plane, data planes, and GitOps tooling. See how it fits your architecture.
---
...
<figure><img src="../.gitbook/assets/overview-example-architecture-9.png" alt="A central control plane, API definitions versioned in Git, and GKO syncing them to data planes."><figcaption></figcaption></figure>
