---
description: The custom resource definitions the Gravitee Kubernetes Operator 4.12 installs, and how to read their status conditions. Browse the full CRD reference.
---
...
* [`Dictionary`](./#custom-resource-definitions)
