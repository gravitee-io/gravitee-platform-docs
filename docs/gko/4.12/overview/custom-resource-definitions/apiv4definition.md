---
description: ApiV4Definition declares a v4 API for the Gravitee Kubernetes Operator 4.12, carrying synchronous and asynchronous traffic. Follow its lifecycle.
---
