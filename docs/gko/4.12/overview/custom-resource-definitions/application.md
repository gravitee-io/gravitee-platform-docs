---
description: The Application custom resource declares a consumer application for the Gravitee Kubernetes Operator 4.12. Compare the simple and OAuth types.
---
