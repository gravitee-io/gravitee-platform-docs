---
description: Dictionary management gives the Gravitee Kubernetes Operator 4.12 environment-scoped key-value stores for API policies. Learn the key concepts.
---
