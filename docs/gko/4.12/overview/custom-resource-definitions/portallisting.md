---
description: PortalListing publishes APIs to locations in a portal navigation tree through the Gravitee Kubernetes Operator 4.12. See the key fields and validation.
---
