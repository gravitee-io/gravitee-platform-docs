---
description: The Portal custom resource declares a Developer Portal instance and its navigation tree for the Gravitee Kubernetes Operator 4.12. See the key fields.
---
