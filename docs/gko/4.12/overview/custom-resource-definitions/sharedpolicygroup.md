---
description: The SharedPolicyGroup custom resource creates a shared policy group for the Gravitee Kubernetes Operator 4.12. Reference it from an ApiV4Definition.
---
