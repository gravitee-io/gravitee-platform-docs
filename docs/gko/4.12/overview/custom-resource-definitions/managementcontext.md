---
description: ManagementContext connects the Gravitee Kubernetes Operator 4.12 to an API Management organization and environment. Compare the four authentication methods.
---
