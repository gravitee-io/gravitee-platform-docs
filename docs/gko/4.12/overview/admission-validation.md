---
description: Admission validation dry-runs a custom resource against the Automation API before the Gravitee Kubernetes Operator 4.12 stores it. See when the call is skipped.
---
