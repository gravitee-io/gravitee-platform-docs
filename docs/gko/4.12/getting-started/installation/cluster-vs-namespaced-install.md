---
description: Run the Gravitee Kubernetes Operator 4.12 across a whole cluster or scoped to one namespace, set by a Helm parameter. Compare the two before you install.
---
