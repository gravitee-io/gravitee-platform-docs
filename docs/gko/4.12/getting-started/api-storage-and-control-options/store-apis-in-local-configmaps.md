---
description: Deliver Gravitee Kubernetes Operator 4.12 API definitions to the Gateway through ConfigMaps local to the cluster. See the examples and the trade-offs.
---
