---
description: Send Gravitee Kubernetes Operator 4.12 API definitions and deployment events to the API Management repository, where the Gateway loads them. See the examples.
---
