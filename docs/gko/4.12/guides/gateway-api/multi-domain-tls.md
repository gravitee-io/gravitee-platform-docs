---
description: Serve several domains from one Gravitee Kubernetes Operator 4.12 Gateway with a TLS listener each. Follow the steps to define listeners and attach routes.
---
