---
description: Automate TLS certificates for a Gravitee Kubernetes Operator 4.12 Gateway with cert-manager. Follow the steps to create a ClusterIssuer and enable HTTPS.
---
