---
description: Run self-hosted API Management with the Kubernetes Gateway API for ingress, using the Gravitee Kubernetes Operator 4.12. Follow the configuration steps.
---
