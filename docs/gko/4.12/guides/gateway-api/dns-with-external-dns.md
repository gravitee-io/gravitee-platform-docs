---
description: Automate DNS records for a Gravitee Kubernetes Operator 4.12 Gateway with external-dns annotations. Follow the steps to configure GatewayClassParameters.
---
