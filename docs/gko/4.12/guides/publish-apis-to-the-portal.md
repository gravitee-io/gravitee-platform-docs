---
description: Publish Gravitee Kubernetes Operator 4.12 APIs to the Developer Portal with the lifecycle state attribute. Follow the steps to publish, deprecate, or archive.
---
