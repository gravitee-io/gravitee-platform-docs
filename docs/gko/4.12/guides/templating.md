---
description: Templating injects values from Kubernetes Secrets and ConfigMaps into Gravitee Kubernetes Operator 4.12 CRDs at runtime. Follow the steps to use it.
---
