...
<figure><img src="../.gitbook/assets/guide-export-an-api-as-a-kubernetes-1.png" alt="The Export API modal offering a Gravitee API definition tab and a CRD API Definition tab."><figcaption></figcaption></figure>
