---
description: GatewayClassParameters configures the Gravitee Kubernetes Operator 4.10 implementation of the Kubernetes Gateway API. See the options and an example.
---
