...
- A Kubernetes cluster with the GKO installed. For more information about installing GKO, see [Quick Start Guide](/gravitee-kubernetes-operator-gko/getting-started/quickstart-guide)
