---
description: KafkaRoute exposes Kafka traffic through the Gravitee Kubernetes Operator 4.10 Gateway API controller, which is off by default. See how to enable it.
---
