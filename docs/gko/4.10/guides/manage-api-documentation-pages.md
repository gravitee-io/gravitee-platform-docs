---
description: Define API documentation pages alongside an API in Gravitee Kubernetes Operator 4.10 definition CRDs. See which page types the CRDs support.
---
