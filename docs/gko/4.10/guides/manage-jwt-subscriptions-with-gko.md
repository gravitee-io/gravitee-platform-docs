---
description: Manage JWT subscriptions with the Gravitee Kubernetes Operator 4.10 without an external identity provider. Follow the steps from plan to subscription.
---
