---
description: The Gravitee Kubernetes Operator 4.10 stores API definitions and deployment events in the API Management repository or in local ConfigMaps. Compare the options.
---
