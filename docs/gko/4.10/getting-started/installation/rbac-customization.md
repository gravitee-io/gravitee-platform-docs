---
description: The Gravitee Kubernetes Operator 4.10 needs different RBAC permissions in cluster and namespaced scope. Follow the steps to modify or disable the defaults.
---
...
<figure><img src="../../.gitbook/assets/gs-install-rbac-customization-18.png" alt="The verbs GKO needs on webhooks, CRDs, ConfigMaps, Secrets, Ingress, and TokenReviews."><figcaption><p>GKO Required Permissions</p></figcaption></figure>
