...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/bGmDEarvnV52XdcOiV8o/configure-and-manage-the-platform/manage-organizations-and-environments/applications
---
...
* An API consumer must have a user account to register an application and subscribe to an API (see [User Management](/broken/pages/xsh2GnwkefrImwU5ulT5)).
...
{% hint style="warning" %}
Dynamic Client Registration is an [Enterprise Edition](enterprise-edition.md) capability
{% endhint %}
...
{% hint style="info" %}
Only users with the required permissions can manage application members. See [User Management](/broken/pages/xsh2GnwkefrImwU5ulT5).
{% endhint %}
