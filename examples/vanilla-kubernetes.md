...
* Complete the steps in [Broken link](/broken/pages/Qq8hshXUfimdn1KiCi9g#prepare-your-installation "mention").
...
* Create your first API. For more information about creating your first API, see [Broken link](/broken/pages/YmJtoxwjolS5Cxe5mIIO "mention").
* Add native Kafka capabilities. For more information about adding native Kafka capabilities, see [configure-the-kafka-client-and-gateway.md](configure-the-kafka-client-and-gateway.md "mention").
