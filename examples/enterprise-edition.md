...
For more information on plugins and how to deploy them, see [Broken link](/broken/pages/fYllC9QYOn4OH7uXT4vB "mention").
...
* [**v4 message API entrypoints**](/broken/pages/JtB1yzQf2RaCYB6XPvUZ#step-2-entrypoints)**:** Access the Gateway and/or consume various message-based backend resources via **HTTP GET**, **HTTP POST**, **Server-sent Events**, **Webhook**, and/or **WebSocket**
* [**v4 message API endpoints**](/broken/pages/JtB1yzQf2RaCYB6XPvUZ#introspect-messages-from-event-driven-backend-endpoints)**:**
...
* [**Confluent Schema Registry resource**](resources.md#confluent-schema-registry)**:** Define Confluent Schema Registry as a resource for serialization and deserialization policies.
...
* [**Datadog reporter**](/broken/pages/e7CXLwLiHNNBhQoO3sjI#datadog-reporter): Push API metrics to your Datadog instance and dashboards.
* [**TCP reporter**](/broken/pages/cXvBWB8M7LPZfCm8egOi#tcp-reporter): Report Gateway events to a TCP listening server.
