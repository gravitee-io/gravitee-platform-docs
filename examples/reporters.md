...
{% hint style="warning" %}
Configuration details for the Elasticsearch reporter are available in the [Elasticsearch Repository](/broken/pages/YSFqhHIHEeX2XMLjUPDF#elasticsearch) documentation.
{% endhint %}
...
{% hint style="warning" %}
To learn more about Gravitee [Enterprise Edition](enterprise-edition.md) and what's included in various enterprise packages, please:
...
{% hint style="info" %}
If you wish to use a reporter not included in the default distribution, you must first add the reporter as a plugin. Refer to the [Plugins](/broken/pages/fYllC9QYOn4OH7uXT4vB) guide to learn more.
{% endhint %}
