...
When creating Gateway APIs in Gravitee, you need to define the "type" or method of exposing your backend resources: [**Proxy upstream protocol**](gravitee-api-definitions.md#proxy-upstream-protocol) or [**Introspect messages from event-driven backend**](gravitee-api-definitions.md#introspect-messages). The architecture that you choose impacts which entrypoints and endpoints are available:
